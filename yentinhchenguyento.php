			...
			<div class="tab_login">
				...
				<div class="website_login" id="login-now" style="display: block;">
					...
					<form action="https://onplaza.vn/index.php?module=users" name="login_form" class="login_form"
						...
						<div class="clear"></div>
						<input type="hidden" name="return" value="L3llbi10aW5oLWNoZQ==">
			...
			<div class="background_all" alt="Thế giới dinh dưỡng"
				...
				<div class="main_wrapper  main_wrapper_nohome  ">
					...
					<div class="main-area main-area-1col main-area-full">
								...
								<div class="breadcrumbs_wrapper" itemscope="" itemtype="http://schema.org/WebPage">
									<ul class="breadcrumb" itemscope="itemscope"
										...
										<li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope"
											...
											<a title="Yến tinh chế nguyên tổ" href="yentinhchenguyento.php"
												itemprop="item">
												<span itemprop="name">Yến tinh chế nguyên tổ</span>
						...
						<input type="hidden" name="name_cat" id="name_cat" value="Yến tinh chế nguyên tổ">
								...
								<section class="products-cat-frame">
									<div class="field_title">
										...
										<select class="order-select" name="order-select">
											...
											<option value="yentinhchenguyento.php/sap-xep-ban-chay-nhat">Bán
												chạy nhất</option>
											<option value="yentinhchenguyento.php/sap-xep-khuyen-mai">Khuyễn
												mãi</option>
											<option value="yentinhchenguyento.php/sap-xep-gia-thap-nhat">Giá từ
												thấp tới cao</option>
											<option value="yentinhchenguyento.php/sap-xep-gia-cao-nhat">Giá từ
												cao tới thấp</option>
											<option value="yentinhchenguyento.php/sap-xep-moi-nhat">Mới nhất
											</option>
											<option value="yentinhchenguyento.php/sap-xep-xem-nhieu">Xem nhiều
											</option>
											...
											<div class="frame_inner">
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Tổ yến tinh chế Khánh Hòa hộp quà tặng 100g Y017"
															class="name">
															Tổ yến tinh chế Khánh Hòa hộp quà tặng 100g Y017 </a> </h3>
											...
											<div class="frame_inner">
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Yến sào tinh chế Khánh Hòa hộp 50g Y013"
															class="name">
															Yến sào tinh chế Khánh Hòa hộp 50g Y013 </a> </h3>
											...
											<div class="frame_inner">
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Yến trắng tinh chế cao cấp loại 1 Nhà Yến (100g/hộp) - Y062"
															class="name">
															Yến trắng tinh chế cao cấp loại 1 Nhà Yến (100g/hộp) - Y062
														</a> </h3>
											...
											<div class="frame_inner">
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Yến tinh chế Khánh Hòa hộp quà tặng 50g Y018 (H015G)"
															class="name">
															Yến tinh chế Khánh Hòa hộp quà tặng 50g Y018 (H015G) </a>
													</h3>
										...
										<div class="item ">
											<div class="frame_inner">
												<figure class="product_image ">
													...
													<a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-3g-dung-thu-y016/"
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Tổ yến sào tinh chế Khánh Hòa hộp 3g - dùng thử Y016"
															class="name">
															Tổ yến sào tinh chế Khánh Hòa hộp 3g - dùng thử Y016 </a>
													</h3>
												...
												<div class="price_arae">
													<span class="price_current" style="color:#FFE2B8">215.000₫</span>
													<span class="price_old" style="color:#FFE2B8">
										...
										<div class="item ">
											<div class="frame_inner">
												<figure class="product_image ">
													...
													<a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-5g-y015/"
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Tổ yến trắng tinh chế Khánh Hòa hộp 5g - Y015"
															class="name">
															Tổ yến trắng tinh chế Khánh Hòa hộp 5g - Y015 </a> </h3>


												</div>

												<div class="price_arae">
													<span class="price_current" style="color:#FFE2B8">350.000₫</span>
													<span class="price_old" style="color:#FFE2B8">
														<span class="item_old">470.000₫ </span>
													</span>
												</div>
										...
										<div class="item ">
											<div class="frame_inner">
												<figure class="product_image ">
													...
													<a href="https://onplaza.vn/noi-chung-yen-dien-tu-homepro-y039/"
														title="Nồi Chưng Yến Điện tử HomePro-Y039">
														<img class="lazy after-lazy"
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Nồi Chưng Yến Điện tử HomePro-Y039" class="name">
															Nồi Chưng Yến Điện tử HomePro-Y039 </a> </h3>
												...
												<div class="price_arae">
													...
													<span class="price_old" style="color:#FFE2B8">
														<span class="item_old">714.286₫ </span>
													</span>
												</div>
												...
												<div class="buy_nows">
													<a href="https://onplaza.vn/noi-chung-yen-dien-tu-homepro-y039/"
														title="Mua sản phẩm Nồi Chưng Yến Điện tử HomePro-Y039">
														Mua sản phẩm
													</a>
												</div>
										...
										<div class="item ">
											<div class="frame_inner">
												<figure class="product_image ">
													...
													<a href="https://onplaza.vn/yen-trang-tinh-che-nha-yen-cao-cap-thuong-hang-2-loai-50g-y143/"
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="Tổ yến trắng tinh chế Nhà Yến cao cấp 2 hộp 50g - Y143"
															class="name">
															Tổ yến trắng tinh chế Nhà Yến cao cấp 2 hộp 50g - Y143 </a>
													</h3>
												...
												<div class="price_arae">
													...
													<span class="price_old" style="color:#FFE2B8">
														<span class="item_old">3.142.857₫ </span>
													</span>
												</div>
							...
							<div class="container">
								...
								<div class="cat_description description cls" id="box_conten_linfo">
									...
									<p style="text-align:justify">Tổ yến tinh chế là là loại <a
										...
										được loại bỏ. <strong><a href="toyentho.php"><span
													style="color:#e74c3c">Tổ yến thô</span></a></strong>&nbsp;sau khi
										thu hoạch từ những vách đá hoặc trong nhà nuôi yến&nbsp;sẽ&nbsp;được ngâm nước
										để cho các sợi yến tách rời nhau ra từ đó làm sạch hết những sợi lông chim, tạp
										chất. Sau đó dùng khuôn để định hình lại tổ&nbsp;nguyên vẹn, giống với hình dáng
									...
									<p style="text-align:justify">Trên thị trường có nhiều loại yến tinh chế khác nhau:
										...
										4.000.000 - 5.000.000 đồng/100gr, còn <a
											href="yensaokhanhhoa.php">giá tổ yến Khánh Hòa</a> (yến
										đảo)&nbsp;trong khoảng&nbsp;từ 6.000.000&nbsp; - 7.000.000 đồng&nbsp;hộp
										100gr.&nbsp;</p>
									...
									<ol>
										...
										<li style="text-align:justify">&nbsp;Cơ sở 2: 327 Trường Chinh, Q. Đống Đa, Hà
											Nội<br>
											Hotline: 02436.555.777 - 02432.333.666 - 024.66.849.833</li>
										<li style="text-align:justify">Cơ sở 3: Số 19 – 21 Cách Mạng Tháng 8 – Phường
											...
											diện sân khấu kịch Trống Đồng )<br>
											Hotline: 0283.50.60.888 – 02862.838.999 – 09.68.60.61.69</li>
									</ol>
	...
	L90.547,145.583z"></path>
					...
					<div class="footer_im cls">
						...
						<div class="image_wrapper">
							<a href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=yentinhchenguyento.php"
							...
							<a href="http://online.gov.vn/Home/WebDetails/18258?refurl=yentinhchenguyento.php"
