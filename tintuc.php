			...
			C360.128,120.716,317.92,143.692,295.776,143.692z"></path>
					...
					<div class="dcjq-mega-menu cls">
						...
						<ul id="megamenu" class="menu mypopup">
							...
							<li class="cat_level_0 level_0 sort activated  menu_level_0" id=" level_883"> <a
									href="tintuc.php" id="menu_item_883" class="menu_item_a" title="Tin tức">
								...
								<ul class="highlight1 container">
									<li class="sub-menu sub-menu-level1  ">
										<div class="images-sub-menu1">
											<a href="duoclieu.php" class="level_0 sort activated  sub-menu-item"
												id="menu_item_961" title="Dược liệu">
												Dược liệu </a>
										</div>
									</li>
									<li class="sub-menu sub-menu-level1  ">
										<div class="images-sub-menu1">
											<a href="suckhoe.php" class="level_0 sort activated  sub-menu-item"
												id="menu_item_907" title="Sức khỏe">
												Sức khỏe </a>
										</div>
									</li>
									<li class="sub-menu sub-menu-level1  ">
										<div class="images-sub-menu1">
											<a href="benhhoc.php" class="level_0 sort activated  sub-menu-item"
												id="menu_item_1020" title="Bệnh học">
												Bệnh học </a>
										</div>
									</li>
									<li class="sub-menu sub-menu-level1  ">
										<div class="images-sub-menu1">
											<a href="tintucyensao.php" class="level_0 sort activated  sub-menu-item"
												id="menu_item_1017" title="Tin Tức Yến Sào">
												Tin Tức Yến Sào </a>
										</div>
									</li>
									<li class="sub-menu sub-menu-level1  ">
										<div class="images-sub-menu1">
											<a href="tintucdongtrung.php" class="level_0 sort activated  sub-menu-item"
												id="menu_item_1018" title="Tin tức Đông Trùng">
									...
									<li class="sub-menu sub-menu-level1  ">
										<div class="images-sub-menu1">
											<a href="tinnhansam.php" class="level_0 sort activated  sub-menu-item"
												id="menu_item_962" title="Tin Nhân sâm">
												Tin Nhân sâm </a>
										</div>
									</li>
				...
				c123.488,0,224-81.824,224-182.4S347.506,0.015,224.018,0.015z"></path>
					...
					C512.306,487.855,507.25,481.071,499.858,479.279z"></path>
							...
							<div class="default_cat">
								...
								<div class="cat_item_store cat_news_store">
									<div class="title_cat">
										<a href="tintucdongtrung.php" title="Tin tức Đông Trùng Hạ Thảo">Tin tức Đông
											Trùng Hạ Thảo</a>
									</div>
									<div class="news_home_slideshow owl-carousel owl-theme owl-responsive--1 owl-loaded"
