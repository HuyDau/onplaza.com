										...
										<div class="shopcart_product">
												...
												<div class="table-wrap">
													...
													?>
															<div class="row-table">
																<div class="col-td">
																	<a class="img_cart" href="sanpham.php?id=<?= $row['id_product'] ?>">
																		<img width="120px" src="uploads/products/<?= $row['image_product'] ?>" alt="<?= $row['name_product'] ?>">
																	...
																	<div class="price_product">
																		...
																		<span class="price"><?= number_format($row['price1'], 0, "", ".") ?>₫</span>
																		<span class="price_old"><?= number_format($row['price'], 0, "", ".") ?>₫</span>

																		<a href="giohang.php?action=delete&id=<?= $row["id_product"] ?>" title="Xóa" class="del-item">
																			Xoá
																		</a>
																...
																<div class="col-td col-td-number">
																	<div class="price">
																		...
																		<?= number_format($_SESSION["cart"][$row["id_product"]] * $row['price1'], 0, "", ".") ?>₫
																	</div>
																	<div class="btn_pluss">

																		<span class="btn-minus" onclick="load_ajax_cart('195_0','minus')">-</span>
																		<input class="numbers-pro  " type="text" min="0" step="1" max="1000" value="<?= $_SESSION["cart"][$row["id_product"]] ?>" name="quantity[<?= $row["id_product"] ?>]" size="8px" id="quantity_195_0">
