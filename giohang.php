...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
	...
	<title>Thanh toán đơn hàng - Onplaza Việt Pháp</title>
	...
	<meta name="dc.title" content="Thanh toán đơn hàng - Onplaza Việt Pháp">
	<meta name="dc.keywords" content="">
	<meta name="dc.subject" content="Thanh toán đơn hàng - Onplaza Việt Pháp">
	...
	<meta property="og:title" content="Thanh toán đơn hàng - Onplaza Việt Pháp">
	<meta property="og:url" content="giohang.php">
	...
	<link rel="canonical" href="giohang.php">
	...
	<style amp-custom="">
		...
		.info-customer-gh input[type="text"] {
			height: 30px;
			padding: 2px 5px;
			border-radius: 4px;
		...
		#products-cart .frame-large-body {
			margin-bottom: 40px
		}

		#products-cart .tab-info-oder {
			margin-bottom: 10px;
			font-size: 14px
		}

		#products-cart .tab-info-oder span {
			font-weight: bold
		}

		#products-cart .frame-large-body table {
			border-collapse: collapse;
			margin-bottom: 10px
		}

		.frame-large-body table,
		.frame-large-body td,
		.frame-large-body th {
			border: 1px solid #f1f1f1
		}

		#products-cart .frame-large-body th,
		.table-product-pack th {
			background: #f9f9f9;
			color: #333;
			text-align: center;
			text-transform: uppercase
		...
		#products-cart .frame-large-body td {
			color: #333;
			padding: 15px
		}

		@media only screen and (max-width: 600px) {
			.table-product-pack .name-product img {
				display: none
			}
		}

		#products-cart .frame-large-body .title-img {
			float: left;
			padding-right: 15px;
			width: 100px
		}

		#products-cart .frame-large-body .title-name {
			float: left;
			padding-top: 18px;
			width: calc(100% - 120px)
		}

		#products-cart .frame-large-body .title-name .name {
			color: #af2a4a;
			margin-bottom: 8px;
			font-weight: normal
		}

		#products-cart .frame-large-body .title-name p {
			color: #666;
			margin-bottom: 5px
		}

		#products-cart .frame-large-body .title-name span {
			color: #333
		}

		#products-cart .frame-large-body td input {
			width: 50px;
			padding: 5px
		}

		#products-cart .frame-large-body td a.delete {
			background: url("https://onplaza.vn/modules/products/assets/images/icon-delete.png") no-repeat;
			width: 20px;
			height: 20px;
			display: block
		}

		#products-cart .frame-large-body td a.delete:hover {
			background: url("https://onplaza.vn/modules/products/assets/images/icon-delete-hover.png") no-repeat;
			width: 20px;
			height: 20px;
			display: block
		}

		#products-cart .frame-large-body .bottom {
			float: right
		}

		#products-cart .frame-large-body .bottom a {
			background: #e4e4e4;
			color: #333;
			font-size: 16px;
			padding: 7px 15px;
		...
		#products-cart .frame-large-body .bottom a.bottom-up {
			background: #af2a4a;
			color: #fff
		}

		#products-cart .frame-large-body .bottom a:hover {
			background: #4db0eb;
			color: #fff;
		...
		#products-cart .frame-large-body .bottom p {
			color: #333;
			font-size: 16px;
			text-align: left;
			display: table;
		...
		#products-cart .frame-large-body .bottom span {
			display: table-cell;
			font-size: 16px
		}

		#products-cart .frame-large-body .bottom span:first-child {
			width: 100px;
			text-align: left
		}

		#products-cart .frame-large-body .bottom span:last-child {
			color: #ED1C24
		}

		#products-cart .frame-large-body .bottom p:last-child span:last-child {
			font-weight: bold
		}
		...
		#products-cart .products-cart-info .title {
			color: #af2a4a;
			font-size: 20px;
			font-weight: normal;
			margin-bottom: 13px;
		...
		#products-cart .products-cart-info .form-item {
			width: 30%
		}

		#products-cart .products-cart-info .form-item-pay {
			margin-left: 5%;
			display: none
		}

		#products-cart .products-cart-info .form-item-order {
			margin-left: 5%;
			display: none
		}

		#products-cart .products-cart-info .title-steps {
			color: #333;
			font-weight: normal;
			text-transform: uppercase;
			margin-bottom: 15px;
		...
		#products-cart .products-cart-info .tabl-info-customer .customer-item {
			margin-bottom: 10px
		}

		#products-cart .products-cart-info .tabl-info-customer .lable,
		#products-cart .products-cart-info .tabl-info-customer .value {
			width: 50%;
			float: left;
			color: #555
		}

		#products-cart .form-item-customer input,
		#products-cart .form-item-customer select {
			background: #f8f8f8;
			width: 96%;
			padding: 8px 2%;
			border: 1px solid #d3d3d3;
			box-shadow: 1px 1px 3px 0px #e1e1e1 inset;
			color: #777;
			margin-bottom: 12px
		}

		#products-cart .shopping_buyer_saller select {
			width: 18%;
			float: left;
			padding: 7px 3px
		}

		#products-cart .shopping_buyer_saller #sender_name {
			width: 73%;
			float: right
		}

		#products-cart .products-cart-info .form-item-pay span {
			color: #333;
			font-family: "Myriad";
			font-size: 14px
		}

		#products-cart .form-item-pay .item-pay {
			margin-bottom: 10px
		}

		#products-cart .products-cart-info .form-item-pay p {
			color: #555;
			font-family: "Roboto";
			font-size: 13px;
			padding-left: 19px
		...
		#products-cart .form-item-pay input {
			margin-right: 5px;
			float: left;
			margin-top: 4px
		}

		#products-cart .form-item-pay .item-pay-img {
			padding-left: 19px;
			margin-top: 4px
		}

		#products-cart .form-item-order p {
			color: #555;
			font-family: "Roboto";
			font-size: 13px
		}

		#products-cart .form-item-order .botton-order {
			background: #af2a4a;
			color: #fff;
		...
		#products-cart .form-item-order .botton-order:hover {
			background: #4db0eb;
			-webkit-transition-duration: 300ms;
			-moz-transition-duration: 300ms
		}

		#products-cart .frame-large-body-mobile {
			display: none
		}

		#products-cart .frame-large-body-mobile .list-product-oder {
			border: 1px solid #cfcfcf;
			margin-bottom: 5px
		}

		#products-cart .frame-large-body-mobile .title-img {
			padding: 10px
		}

		#products-cart .frame-large-body-mobile .title-name {
			float: left;
			padding-top: 10px
		}
		...
		.total_shopcart_gifts {
			box-sizing: border-box;
			padding: 0 15px;
			position: relative
		}

		.total_shopcart_gifts .gift {
			float: left;
			text-align: center
		}

		.total_shopcart_gifts .gift .gift_inner {
			max-width: 170px;
			margin: 10px auto;
			position: relative;
			cursor: pointer
		...
		.total_shopcart_gifts .gift h2 {
			font-size: 15px;
			font-weight: normal
		}

		.total_shopcart_gifts .gift .img-responsive {
			width: 150px;
			display: initial
		}

		.select_gift_icon {
			background: url(https://onplaza.vn/modules/products/assets/images/select_gift.png) center center no-repeat rgba(6, 132, 206, 0.4);
			width: 85px;
			height: 85px;
			position: absolute;
			top: 51px;
		...
		.gift_inner:hover .select_gift_icon,
		.gift.selected .select_gift_icon {
			display: block
		}

		.info-customer-gh tr td {
			position: relative
		}
		...
		@media screen and (max-width: 668px) {
			...
			#products-cart .frame-large-body-mobile .title-name span.price {
				color: #af2a4a
			}
		}
		...
		.all-button-cart input:last-child {
			margin-right: 0
		}
		...
		.shopcart_product .detail_order .total-price {
			background: #321000;
			color: #fff;
			padding: 15px
		}

		.shopcart_product .detail_order .total-price span {
			color: #fff
		}

		.shopcart_product .detail_order .total-price-inner {
			padding: 10px 0px
		}

		.shopcart_product .detail_order .total-price-inner .font {
			float: left
		}

		.shopcart_product .detail_order .total-price-inner div {
			float: right;
			font-size: 16px
		}

		.shopcart_product .detail_order .total-price-inner .price {
			display: block;
			text-align: center;
			color: #f20200;
			font-size: 25px;
		...
		.shopcart_product .detail_order .total-price-inner .vat {
			display: block;
			text-align: center;
			margin-top: 5px
		}
		...
		@media all and (max-width: 600px) {
			#product_cart_load_ajax {
				width: 100%
			}
		}

		#product_cart_load_ajax a {
			display: inline-block
		}

		#product_cart_load_ajax .img_cart {
			float: left;
			margin-right: 15px
		}

		#product_cart_load_ajax .table-wrap .row-table {
			display: flex;
			flex-wrap: wrap
		}
		...
		#product_cart_load_ajax .table-wrap .row-table .col-td {
			width: 37%;
			padding: 16px 20px;
			-webkit-box-sizing: border-box;
			-moz-box-sizing: border-box;
		...
		#product_cart_load_ajax .table-wrap .row-table .col-td:nth-child(1) img {
			width: 90px;
			border: 1px solid #eee
		}

		#product_cart_load_ajax .table-wrap .row-table .col-td:nth-child(1) {
			width: 63%;
			position: relative
		}
		...
		#product_cart_load_ajax .table-wrap .row-table .col-td:nth-child(2) {
			width: 37%;
			text-align: right;
			padding: 16px 10px
		}
		...
		#product_cart_load_ajax .table-wrap .row-table .col-td:last-child {
			border-right: none
		}

		#product_cart_load_ajax .table-wrap .row-table .col-td .name-item {
			display: block;
			color: #fff;
			margin-bottom: 10px
		}

		#product_cart_load_ajax .table-wrap .row-table .col-td .del-item {
			color: #ffb26f;
			margin-top: 5px;
			font-size: 16px;
			text-decoration: underline;
		...
		#product_cart_load_ajax .table-wrap .row-table .col-td-number .btn-minus,
		#product_cart_load_ajax .table-wrap .row-table .col-td-number .btn-plus {
			width: 30px;
			height: 30px;
			display: block;
		...
		#product_cart_load_ajax .table-wrap .row-table .col-td-number .numbers-pro {
			text-align: center;
			width: 70px;
			height: 30px;
			padding: 2px 10px;
		...
		.total-card-code .card_code .text {
			margin-bottom: 23px
		}
		...
		.buyer_info .purchase-provisions .title {
			text-transform: uppercase;
			background: #fff;
			padding: 10px;
			border: 1px solid #eee;
		...
		.buyer_info .purchase-provisions .content {
			overflow-y: scroll;
			width: 100%;
			max-height: 200px;
			margin-bottom: 10px;
		...
		.buyer_info .purchase-provisions .checkbox {
			font-style: italic;
			font-size: 15px;
			line-height: 22px;
			margin-bottom: 10px;
		...
		.buyer_info .purchase-provisions ::-webkit-scrollbar {
			width: 10px
		}

		.buyer_info .purchase-provisions ::-webkit-scrollbar-track {
			-webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);
			border-radius: 10px
		}

		.buyer_info .purchase-provisions ::-webkit-scrollbar-thumb {
			background: #ddd;
			border-radius: 10px;
			transition: 0.2s;
			cursor: pointer
		...
		.buyer_info .purchase-provisions ::-webkit-scrollbar-thumb:hover {
			background: #eee
		}
		...
		.address_order .title_ao {
			text-transform: uppercase;
			font-size: 16px
		}

		.address_order .address_receipt {
			margin-top: 10px;
			line-height: 22px;
			padding-left: 24px;
			box-sizing: border-box;
		...
		.address_order .address_receipt .form-group .form_name {
			font-weight: bold;
			float: left
		}

		.address_order .address_receipt .form-group select {
			margin-left: 15px;
		...
		.address_order .address_receipt .form-group select:focus {
			background-position: calc(100% - 15px) calc(1em + -6px), calc(100% - 20px) calc(1em + -6px), 100% 0
		}

		.address_order .address_receipt input {
			border: 1px solid #dedede;
			padding: 2px 5px;
			border-radius: 2px;
			margin-bottom: 2px
		...
		.address_order .address_receipt .edit_info {
			position: absolute;
			right: 0px;
			top: 0px;
		...
		.address_order .address_receipt .apply_info {
			position: absolute;
			right: 0px;
			top: 0px;
			color: red
		...
		.address_order .address_receipt svg {
			width: 18px;
			height: 18px;
			position: absolute;
			left: 0px;
		...
		.method_receiver .itemmethod_receiver {
			position: relative;
			margin-right: 10px;
			display: inline-block;
			float: left;
		...
		.method_receiver input {
			opacity: 0
		}

		.method_receiver .radio-fake {
			position: absolute;
			top: -1px;
			left: 0;
			height: 20px;
		...
		.method_receiver .radio-fake:after {
			left: 7px;
			top: 2px;
			width: 5px;
			height: 10px;
		...
		.method_receiver input:checked~.radio-fake {
			background: var(--extra-color);
			border: 1px solid var(--extra-color)
		}

		.method_receiver input:checked~.radio-fake:after {
			display: block
		}
		...
		.fieldset_item_row .value .item-iner {
			display: flex;
			align-items: center;
			float: left;
			position: relative;
		...
		.fieldset_item_row .value .item-iner input {
			opacity: 0;
			display: none
		}

		.fieldset_item_row .value .item-iner .radio-fake {
			height: 20px;
			display: inline-block;
			width: 20px;
			margin-right: 15px;
		...
		.fieldset_item_row .value .item-iner .radio-fake:before {
			position: absolute;
			top: 50%;
			left: 50%;
			transform: translate(-50%, -50%);
		...
		.fieldset_item_row .value input:checked~.radio-fake:before {
			background-color: #000
		}

		.fieldset_item_row .value .type_address1 {
			margin-right: 20px
		}

		.fieldset_item_row .value select {
			width: 100%;
			line-height: 36px;
			border-radius: 5px;
			border: 1px solid #d6d6d6;
		...
		#next_three .item .radio_box .content {
			margin-left: 30px;
			line-height: 22px;
			margin-bottom: 10px
		}

		#next_three .item .radio_box .content p {
			color: #fff
		}

		#next_three .item .radio_box .title {
			font-size: 18px;
			color: var(--main-color);
			margin-bottom: 5px;
			display: inline-block
		...
		#next_three .item .radio_box .radio .type_radio {
			display: flex;
			align-items: center;
			position: relative;
			color: #fff;
		...
		#next_three .item .radio_box .radio .type_radio label {
			cursor: pointer
		}

		#next_three .item .radio_box .radio input {
			opacity: 0;
			position: inherit;
			z-index: 99;
			position: absolute
		...
		#next_three .item .radio_box .radio input:checked~.radio-fake:before {
			background-color: #000
		}

		#next_three .item .radio_box .radio .radio-fake {
			height: 15px;
			display: inline-block;
			width: 15px;
			margin-right: 15px;
		...
		#next_three .item .radio_box .radio .radio-fake:before {
			position: absolute;
			top: 50%;
			left: 50%;
			transform: translate(-50%, -50%);
		...
		#next_three .right_item {
			background: #321000;
			box-sizing: border-box
		}

		#next_three .right_item .top_item {
		...
		#next_three .right_item .top_one {
			padding-top: 20px
		}

		#next_three .right_item .left_iner {
			float: left;
			width: 60%;
			line-height: 22px;
			margin-bottom: 18px
		...
		#next_three .right_item .left_iner #address_buyer {
			color: #fff
		}

		#next_three .right_item .left_iner .b {
			font-weight: bold
		}

		#next_three .right_item .radio_box {
			border-bottom: 1px solid #5b1e02
		}

		#next_three .right_item .radio_box2 {
			padding-bottom: 5px;
			border-bottom: 0px;
			margin-bottom: 0px
		}

		#next_three .right_item .radio_box3 {
			padding-bottom: 0px
		}

		#next_three .right_item .price_product a {
			color: #fff
		}

		#next_three .right_item .right_iner {
			float: right;
			width: 20%
		}
		...
		#next_three .right_item .right_iner .price {
			font-size: 16px;
			color: #fff;
			font-weight: normal
		}

		#next_three .right_item .right_iner a {
			color: #000;
			display: inline-block;
			padding: 5px 30px;
			text-transform: uppercase;
		...
		#next_three .right_item .right_iner a:hover {
			background-color: var(--extra-color);
			color: #fff
		}

		#next_three .content_box {
			margin-bottom: 20px
		}

		#next_three .content_box .title_text {
			font-size: 18px;
			font-size: 18px;
			color: var(--main-color);
			margin-bottom: 10px
		...
		#next_three .card_code {
			position: relative
		}

		#next_three .card_code button {
			position: absolute;
			right: 0px;
			background: var(--main-color);
			line-height: 36px;
		...
		#next_three .right_item .right_price {
			width: 40%;
			text-align: right
		}
		...
		#next_three .right_item .right_price .price {
			color: #f20200
		}

		#next_three .right_item .right_price .vat {
			color: #fff;
			margin-top: 5px
		}

		.total-price-inner .total_text {
			color: var(--main-color);
			font-size: 18px;
			font-weight: 700
		}

		#next_three .right_item #total_after {
			padding: 15px 20px;
			box-sizing: border-box;
			background: #471500;
			display: flex;
		...
		#next_three .right_item #total_after .total_text {
			margin-bottom: 0px
		}

		#next_three .right_item #price_before {
			margin-bottom: 0;
			border: 0
		}

		#next_three .right_item #price_before .left_iner {
			margin-bottom: 10px
		}

		#price_sale_up .code_sale {
			color: #fff
		}
		...
		.radio_book .content p {
			color: #fff
		}

		.radio_book .left_book {
			width: 75%;
			float: left
		}
		...
		.radio_book .right_book .__btn_buy,
		.radio_book .right_book #next_cart {
			margin-top: 0px
		}
		...
		.radio_book .radio .type_radio label {
			cursor: pointer
		}
		...
		.radio_book .radio .address {
			margin-bottom: 5px;
			display: inline-block
		}

		.radio_book .radio .color {
			font-style: italic;
			color: var(--main-color)
		}

		.radio_book .radio input {
			opacity: 0;
			position: inherit;
			z-index: 99;
			position: absolute
		...
		.radio_book .radio input:checked~.radio-fake:before {
			background-color: #000
		}

		.radio_book .radio .radio-fake {
			height: 15px;
			display: inline-block;
			width: 15px;
			margin-right: 15px;
		...
		.radio_book .radio .radio-fake:before {
			position: absolute;
			top: 50%;
			left: 50%;
			transform: translate(-50%, -50%);
	...
	<script type="text/javascript" async=""
		src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/578172086/?random=1688487048997&amp;cv=11&amp;fst=1688487048997&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45He36s0&amp;u_w=1366&amp;u_h=768&amp;url=https%3A%2F%2Fonplaza.vn%2Fgio-hang.html&amp;ref=https%3A%2F%2Fonplaza.vn%2Fnam-linh-chi-do-han-quoc-l002%2F&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=Thanh%20to%C3%A1n%20%C4%91%C6%A1n%20h%C3%A0ng%20-%20Onplaza%20Vi%E1%BB%87t%20Ph%C3%A1p&amp;auid=568503462.1688460212&amp;data=Event%3D%3BItems%3D%3BValue%3D&amp;rfmt=3&amp;fmt=4"></script>
			...
			<div class="tab_login">
				...
				<div class="website_login" id="login-now" style="display: block;">
					...
					<form action="https://onplaza.vn/index.php?module=users" name="login_form" class="login_form"
						...
						<div class="clear"></div>
						<input type="hidden" name="return" value="L2dpby1oYW5nLmh0bWw=">
									...
									<div class="g-recaptcha" data-sitekey="6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci">
										<div style="width: 304px; height: 78px;">
											<div><iframe title="reCAPTCHA"
													src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci&amp;co=aHR0cHM6Ly9vbnBsYXphLnZuOjQ0Mw..&amp;hl=vi&amp;v=khH7Ei3klcvfRI74FvDcfuOo&amp;size=normal&amp;cb=4azi51b9bhd1"
													width="304" height="78" role="presentation" name="a-po5us3fjs3ip"
						...
						<div class="product_cart mt20 cls">
							<div class="detail_inner">
								...
								<div id="product_cart_load_ajax">
											...
											<div class="table-wrap">
													...
													<div class="col-td">
														...
														<div class="price_product">
															<a class="name-item"
																...
																600 con (D600-100V1) </a>




															<span class="price">83.000.000₫</span>
															<span class="price_old">83.000.000₫</span>

															<a href="https://onplaza.vn/index.php?module=products&amp;view=cart&amp;task=edel&amp;id=195&amp;sid=MTk1XzA=&amp;id_combo=&amp;parent_product=&amp;Itemid=65"
																title="Xóa" class="del-item">
																Xoá
															</a>
													...
													<div class="col-td col-td-number">
														...
														<div class="btn_pluss">
															...
															<span class="btn-minus"
																onclick="load_ajax_cart('195_0','minus')">-</span>
															<input onkeyup="onchange_number('195_0')"
																class="numbers-pro  " type="text" min="0" max="1000"
																value="2" name="quantity_195_0" size="8px"
																id="quantity_195_0">
															<span class="btn-plus"
																onclick="load_ajax_cart('195_0','plus')">+</span>
														</div>
													</div>
												...
												<div class="row-table">
													<div class="col-td">
														...
														<div class="price_product">
															<a class="name-item" title="Nấm linh chi đỏ Hàn Quốc L002"
																href="namlinhchido.php-han-quoc-l002/">
															...
															<a href="https://onplaza.vn/index.php?module=products&amp;view=cart&amp;task=edel&amp;id=128&amp;sid=MTI4XzA=&amp;id_combo=&amp;parent_product=128&amp;Itemid=65"
																title="Xóa" class="del-item">
																Xoá
															</a>
													...
													<div class="col-td col-td-number">
														...
														<div class="btn_pluss">
															...
															<span class="btn-minus"
																onclick="load_ajax_cart('128_0','minus')">-</span>
															<input onkeyup="onchange_number('128_0')"
																class="numbers-pro  " type="text" min="0" max="1000"
																value="1" name="quantity_128_0" size="8px"
																id="quantity_128_0">
															<span class="btn-plus"
																onclick="load_ajax_cart('128_0','plus')">+</span>
														</div>
													</div>
									...
									<input class="button-cart" type="button" name="next_step" id="sub-next-buy" onclick="javascript:window.location = 'namlinhchido.php'" value="Tiếp tục mua hàng"/>
								<input class="button-cart" type="button" name="remove"  value="Xóa tất cả" onclick="javascript:window.location = 'https://onplaza.vn/index.php?module=products&view=cart&task=del_all&Itemid=65'"/>
			</div>  -->
											<div class="detail_order">
												<!-- <div class="title">Thông tin đơn hàng</div> -->
												<div class="total-price" id="total-price">
													<div class="total-price-inner cls">
														<span class="font">Tạm tính </span>
														<div>167.000.000₫</div>
													</div>
													<div class="clear"></div>
													<div class="total-price-inner cls">
												...
												<div class="_btn_mb">
													...
													<a class="button-cart" href="javascript:void(0)"
														onclick="buy_login()" id="buy_login"
														title="Đăng nhập và mua">Mua ngay</a>
													<div class="login_buy">
														<a href="javascript:void(0)" id="login_pop"
															onclick="OpenLoginPopup()" title="Đăng nhập và mua">Đăng
															nhập và mua</a>
													</div>
												</div>
											</div>
											...
											<input type="hidden" value="167000000" id="price_total">
...
<div class="payment-type">
	...
	<label class="container-rd">Thanh toán bằng chuyển khoản
	  <input type="radio" name="radio"  value="2">
	  <span class="checkmark"></span>
	</label>
	<label class="container-rd">Thanh toán bằng ZaloPay <a href="" title="Chi tiết">Chi tiết</a>
	...
	<div class="card_code cls">
		...
		<input type="text" name="card_code" id="card_code" value="" class="input_text" size="30"  />
					<button type="button" onclick="myFunction_manhcode();" class="resubmit_form">Áp dụng</button>
			</div>

	<div class="ship-total" >
		<div class="total-mn">
			<font>Thành tiền: </font>
			<span class="price_tongcong">167.000.000₫</span>
			<input type="hidden" id="price_tongcong" value="167000000">
		</div>
		
		<div class="ship-mn">
			<font>Phí vân chuyển cố định: </font>
			<span class="price_ship">0₫</span>

			<input type="hidden" id="price_ship" value="">
		</div>
		

		<div class="total-price-inner cls">
			<font>Tổng cộng: </font>
			<span class="price_thanhtoan">167.000.000₫</span>
		</div>
									...
									<form action="#" name="eshopcart_info" method="post" id="eshopcart_info">
										<div class="input_check" id="next_two">
											...
											<div class="wrapper_next">
												...
												<div class="item cls">
														...
														<div class="form-group">
															...
															<div class="value">
																<input placeholder="Họ tên (*)" type="text"
																	name="sender_name" id="name_user" value=""
													...
													<div class="fieldset_item_row cls">
														<div class="form-group">
															...
															<div class="value">
																<input placeholder="Điện thoại (*)" type="text"
																	name="sender_telephone" id="telephone_user" value=""
																	class="input_text" size="30">
															</div>
														</div>
													</div>
													<div class="fieldset_item_row cls fieldset_item_adresss">
														<div class="form-group">
															...
															<div class="value">
																<select data-placeholder="Tỉnh Thành"
																	class="form-control " name="city_id" id="city_id">
													...
													<div class="fieldset_item_row cls fieldset_item_adresss">
														<div class="form-group">
															...
															<div class="value">
																<select data-placeholder="Quận huyện"
												...
												<div class="item  cls">
													<div class="fieldset_item_row cls fieldset_item_adresss">
														<div class="form-group">
															...
															<div class="value">
																<select data-placeholder="Xã phường"
																	class="form-control " name="ward_id" id="ward_id">
														...
														<div class="form-group">
															...
															<div class="value">
																<textarea placeholder="Địa chỉ (*)"
																	name="sender_address" id="address_user"></textarea>
															</div>
														</div>
													</div>
													<div class="fieldset_item_row cls">
															...
															<div class="value">
																...
																<label class="type_address1 item-iner">
																	<input type="radio" class="address_type"
																		id="home_address" checked="" name="type_address"
																		value="1">
																	<span class="radio-fake"></span>
																...
																<label class="type_address2 item-iner">
																	<input type="radio" class="address_type"
																		id="company_address" name="type_address"
																		value="2">
																	<span class="radio-fake"></span>
												...
												<div class="__btn_buy">
													<a class="button-submit" href="javascript:void(0);" title=""
														id="next_cart"> Giao tới địa chỉ này </a>
												</div>
											</div>
										</div>
										<div class="clear"></div>
											...
											<div class="item">
												<div class="item-iner">
													<div class="radio_box">
														...
														<div class="radio" id="radio_receive">
															<span class="type_radio" onclick="check_radio(6)">
																<input type="radio" id="receive_6" checked="checked"
																	name="receive" value="6">
																<span class="radio-fake"></span>
														...
														<div class="radio" id="radio_receive">
															<span class="type_radio" onclick="check_radio(7)">
																<input type="radio" id="receive_7" name="receive"
																	value="7">
																<span class="radio-fake"></span>
													...
													<div class="radio_box">
														...
														<div class="radio " id="radio_receive2">
															<span class="type_radio" onclick="check_radio2(1)">
																<input type="radio" id="receive_1" checked="checked"
																	name="name_payment_method" value="1">
																<span class="radio-fake"></span>
														...
														<div class="radio " id="radio_receive2">
															<span class="type_radio" onclick="check_radio2(2)">
																<input type="radio" id="receive_2"
																	name="name_payment_method" value="2">
																<span class="radio-fake"></span>
														...
														<div class="radio " id="radio_receive2">
															<span class="type_radio" onclick="check_radio2(3)">
																<input type="radio" id="receive_3"
																	name="name_payment_method" value="3">
																<span class="radio-fake"></span>
														...
														<div class="radio " id="radio_receive2">
															<span class="type_radio" onclick="check_radio2(4)">
																<input type="radio" id="receive_4"
																	name="name_payment_method" value="4">
																<span class="radio-fake"></span>
																<label for="receive_4">Thanh toán bằng MOMO <a
																		class="link_detail" href="/thanh-toan-momo.html"
																		title="Thanh toán bằng MOMO"> - Chi tiết </a>
																</label>
															</span>
														...
														<div class="radio " id="radio_receive2">
															<span class="type_radio" onclick="check_radio2(5)">
																<input type="radio" id="receive_5"
																	name="name_payment_method" value="5">
																<span class="radio-fake"></span>
																<label for="receive_5">Thanh toán bằng ZaloPay <a
																		class="link_detail"
																		href="/thanh-toan-zalopay.html"
																		title="Thanh toán bằng ZaloPay"> - Chi tiết </a>
																</label>
															</span>
													...
													<div class="content_box">
														...
														<textarea placeholder="Ghi chú" name="sender_comments"
													...
													<div class="content_box card_code">
														...
														<input type="text" name="card_code" id="card_code"
															placeholder="Nhập mã giảm giá" value="" class="input_text"
															size="30">
														<button type="button" onclick="myFunction_code();"
															class="resubmit_form">Áp dụng</button>
													</div>


													<div class="a_pay">
														<a class="button-step button-cart" href="javascript:void(0);"
															onclick="javascript:submitForm();" title=""> Đặt mua </a>
										...
										$.ajax({
											...
											success: function (data) {
												if (data.error == false && data.type_down) {
													...
													if (result2) {
														$('#price_sale_up .right_iner .price').html("-" + result2);
													}
													...
													$('#price_sale_up .right_iner .price').html("");
	...
	L90.547,145.583z"></path>
					...
					<div class="footer_im cls">
						...
						<div class="image_wrapper">
							<a href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=giohang.php"
							...
							<a href="http://online.gov.vn/Home/WebDetails/18258?refurl=giohang.php"
...
//]]></script>
		...
		<div class="benmarch noc">0.33600 sec| 1939.781 kb</div>
		<script async="async" language="javascript" type="text/javascript"
			src="https://onplaza.vn/cache/js/bc23eda7cbfac59f4192ac07b0a3bec7.js?20230704231048"></script>
	</div>
	<script type="text/javascript"
	...
	<div
		...
		<div style="z-index: 2000000000; position: relative;"><iframe
				...
				name="c-po5us3fjs3ip" frameborder="0" scrolling="no"
