									...
									<div class="shopcart_product">
										<form action="#" method="post" name="shopcart">
											<div class="table-wrap">
												...
												<div class="row-table">
													<div class="col-td">
														<a class="img_cart" href="namlinhchido.php-han-quoc-l002/">
															<img width="120px"
									...
									function myFunction_code() {
										...
										$.ajax({
											...
											url: "/index.php?module=products&view=cart&task=check_code&raw=1&code_input=" + code_input +
												"&total_noshipping=" + total_noshipping,
											data: {
											...
											success: function(data) {
												if (data.error == false && data.type_down) {
													...
													if (text_price_chietkhau) {
														$('.price_chietkhau').html('<span class="code_sale">Giảm giá: </span>' +
															'Mã giảm giá ' + text_price_chietkhau);
													}
