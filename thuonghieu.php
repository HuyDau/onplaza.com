...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
	...
	<meta name="description" content="Với mức sống nâng cao, các sản phẩm chăm sóc sức khỏe có thương hiệu hiện được nhiều người tìm đến với mục đích bổ sung dinh dưỡng hỗ trợ giảm thiểu bệnh tật,Sản phẩm thương hiệu,">
	...
	<meta name="dc.description" content="Với mức sống nâng cao, các sản phẩm chăm sóc sức khỏe có thương hiệu hiện được nhiều người tìm đến với mục đích bổ sung dinh dưỡng hỗ trợ giảm thiểu bệnh tật,Sản phẩm thương hiệu,">
	<!-- Google Tag Manager -->
	...
	<meta property="og:description" content="Với mức sống nâng cao, các sản phẩm chăm sóc sức khỏe có thương hiệu hiện được nhiều người tìm đến với mục đích bổ sung dinh dưỡng hỗ trợ giảm thiểu bệnh tật,Sản phẩm thương hiệu,">
					...
					<div class="box-register">
						<form action="https://onplaza.vn/index.php?module=users" name="register_form" class="register_form" method="post" onsubmit="javascript: return checkFormsubmit();">
							...
							<div class="form-login">
								...
								<div class="clear"></div>
							</div> <input type="hidden" name="return" value="L3RodW9uZy1oaWV1">
							<input type="hidden" name="module" value="users">
							<input type="hidden" name="view" value="users">
							<input type="hidden" name="Itemid" value="9">
	...
	<div class="header_wraper cls">
		<div class="home_index no-home">
			...
			C469.27,15.147,470.166,10.581,468.523,6.592z"></path>
											...
											<!--	LEVEL 1			-->
											<div class="sub-menu sub-menu-level1   "> <a href="thuonghieu.php" class="level_0 sort activated  sub-menu-item" data-menu_tags="910" id="menu_item_910" title="Sản phẩm thương hiệu">
			...
			<div class="background_all" alt="Thế giới dinh dưỡng" style="background-image: url(https://onplaza.vn/images/background/compress/trang_tintuc_1591873805.jpg.webp); display: block;background-color:#140600;background-position:unset" nhansamhanquoc.php> <!-- Content -->
				<div class="main_wrapper  main_wrapper_nohome  ">
					<div class="main-area main-area-1col main-area-full">
							...
							<div class="container">
								<div class="breadcrumbs_wrapper" itemscope="" itemtype="http://schema.org/WebPage">
									<ul class="breadcrumb" itemscope="itemscope" itemtype="https://schema.org/BreadcrumbList">
										...
										<li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
											<a title="Sản phẩm thương hiệu" href="thuonghieu.php" itemprop="item">
						...
						</div> <input type="hidden" name="name_cat" id="name_cat" value="Sản phẩm thương hiệu">
							...
							<div class="container">
								<article class="cat_summary cls">
									<div class="summary_content summary_content_detail">
										<p style="text-align:center"><strong><span style="font-size:11pt"><span><span style="font-family:Calibri,sans-serif"><span style="font-size:12.0pt"><span><span>On plaza - thương
						...
						<div class="description_start bg_white" style="background-color:#39231A">
							<div class="container">
								<div class="cat_description description cls" id="box_conten_linfo">
									<p style="text-align:center"><strong><span style="font-size:11pt"><span><span style="font-family:Calibri,sans-serif">Người tiêu dùng ngày càng
									...
									<p><strong><span style="font-size:11pt"><span><span style="font-family:Calibri,sans-serif">Những bí quyết nhận biết
	...
	L90.547,145.583z"></path>
					...
					<div class="footer_im cls">
						<div class="image_wrapper">
							<a href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=thuonghieu.php" title="DMCA.com Protection Status" class="dmca-badge"> <img src="https://images.dmca.com/Badges/dmca-badge-w100-5x1-03.png?ID=18892078-af65-4c9d-8b82-addf29b3e619" alt="DMCA.com Protection Status"></a>
							<script src="https://images.dmca.com/Badges/DMCABadgeHelper.min.js"> </script>
							<a href="http://online.gov.vn/Home/WebDetails/18258?refurl=thuonghieu.php" title="Bộ công thương" class="dmca-badge">
		...
		<script async="async" language="javascript" type="text/javascript" src="https://onplaza.vn/cache/js/5b6f50aec6587c88a6149b5d7f41239a.js?20230704182920"></script>
	</div>
