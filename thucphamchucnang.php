												...
												?><div class="item item2">
													<div class="frame_inner">
														<figure class="product_image "> <a
																...
																title="<?=$item_khoangchat['name_product']?>">
																<img class="lazy after-lazy"
																	alt="<?=$item_khoangchat['name_product']?>"
														...
														<div class="price_arae">
															<span class="price_current"
																style="color:#FFE2B8"><?=number_format($item_khoangchat['price'],0,"",".")?>₫</span>
															<span class="price_old" style="color:#FFE2B8">
																<span
																	class="item_old"><?=number_format($item_khoangchat['price'],0,"",".")?>₫
																</span>
															</span>
														</div>
														<div class="buy_nows">
															<a href="https://onplaza.vn/nuoc-diep-luc-cao-cap-klink-liquid-chlorophy-ii-k004/"
																title="Mua sản phẩm <?=$item_khoangchat['name_product']?>">
																Mua sản phẩm
															</a>
														</div>
													</div> <!-- end .frame_inner -->
									...
									<div class="container">
										<div class="cat_description description cls" id="box_conten_linfo">
											...
											<p style="text-align:center"><img class="lazy2" alt="Thực phẩm chức năng"
													...
													src="uploads/khoangchat/thuc pham chuc nang -1.png">
											</p>
											...
											<p style="text-align:center"><img class="lazy2" alt="Tahitian Juice"
													...
													src="uploads/khoangchat/Noni Tahitian Juice.png">
											</p>
											<p>&nbsp;</p>
											...
											<p style="text-align:center"><img class="lazy2"
													...
													src="uploads/khoangchat/Herbalife.png"></p>
											...
											<p style="text-align:center"><img class="lazy2" alt="Tảo xoắn Spirulina"
													height="667" width="998" src="uploads/khoangchat/spirulina.png"></p>
											...
											<p style="text-align:center"><img class="lazy2" alt="Vien Nhung Huou"
													...
													src="uploads/khoangchat/Viên nhung huơu.png">
											</p>
											...
											<p style="text-align:center"><img class="lazy2" alt="serious mass"
													height="677" width="800" src="uploads/khoangchat/Serious Mass.png">
											</p>
											...
											<p style="text-align:center"><img class="lazy2" alt="bifina" height="700"
													width="700" src="uploads/khoangchat/bifina.png"></p>
											...
											<p style="text-align:center"><img class="lazy2" alt="diệp lục Klink"
													...
													src="uploads/khoangchat/diep luc k link.png">
											</p>
											...
											<p style="text-align:center"><img class="lazy2" alt="jex max" height="522"
													width="700" src="uploads/khoangchat/jex max vien khop.png">
											</p>
