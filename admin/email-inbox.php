...
$sql_contact = mysqli_query($conn, "SELECT * FROM contact");
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="card-box">
                                ...
                                <div class="inbox-leftbar">
                                    ...
                                    <div class="mail-list mt-4">
                                        <a href="#" class="list-group-item border-0 text-danger font-weight-bold"><i
                                                class="mdi mdi-inbox font-18 align-middle mr-2"></i>Inbox<span
                                                class="badge badge-danger float-right ml-2 mt-1"><?php $count_contact = mysqli_num_rows($sql_contact);echo $count_contact; ?></span></a>
                                ...
                                <div class="inbox-rightbar">
                                    ...
                                    <div class="mt-3">
                                        <ul class="message-list">
                                            <?php
                                            while ($row_contact = mysqli_fetch_array($sql_contact)) {
                                                ?>
                                                <li class="unread">
                                                    <div class="col-mail col-mail-1">
                                                        ...
                                                        <a href="email-read.php?id=<?= $row_contact['id_contact'] ?>" class="title">
                                                            <?= $row_contact['name'] ?> (
                                                            <?= $row_contact['email'] ?>)
                                                        </a>
                                                    </div>
                                                    <div class="col-mail col-mail-2">
                                                        <a href="email-read.php?id=<?= $row_contact['id_contact'] ?>" class="subject">
                                                            <?= $row_contact['title'] ?> &nbsp;&ndash;&nbsp;
                                                            <span class="teaser">
                                                                <?= $row_contact['content'] ?>.
                                                            </span>
                                                        </a>
                                                        <div class="date">
                                                            <?php $date_now = strtotime($row_contact['date']);
                                    ...
                                    <div class="row">
                                        <div class="col-7 mt-1">
                                            Showing 1 - 20 of <?php $count_contact = mysqli_num_rows($sql_contact);echo $count_contact; ?>
                                        </div> <!-- end col-->
                                        <div class="col-5">
