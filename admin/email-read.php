...
<head>
    <meta charset="utf-8">
    <title>Onplaza - Detail Contact</title>
                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <div class="inbox-rightbar">
                                    ...
                                    <div class="mt-4">
                                        <h5 class="font-18"><?php if(isset($_GET['id'])){ echo  $info_contact['title'];}?></h5>
                                        ...
                                        <div class="media mb-4 mt-1">
                                            ...
                                            <div class="media-body">
                                                <span class="float-right"><?php if(isset($_GET['id'])){$date_now = strtotime($info_contact['date']);
                                                            echo date("M  d,  Y", $date_now);} 
                                                            ?></span>
                                                <h6 class="m-0 font-14"><?php if(isset($_GET['id'])){ echo  $info_contact['name'];}?></h6>
                                                <small class="text-muted">From: <?php if(isset($_GET['id'])){ echo  $info_contact['email'];}?></small>
                                            </div>
                                        </div>

                                        <p><?php if(isset($_GET['id'])){ echo  $info_contact['content'];}?></p>
                                    ...
                                    <div class="text-right">
                                        <button type="button" class="btn btn-primary btn-rounded width-sm"><a style="color: white;" href="email-compose.php?id=<?=$id?>">Send</a></button>
                                    </div>
