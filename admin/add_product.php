...
if (isset($_POST['add_product'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM product WHERE ma_product = '$prod_code' ");
   

    if (mysqli_num_rows($result) > 0) {
        echo "<script>window.alert('Product already exists !');</script>";
    } else {
        $add_product = "INSERT INTO `product`(`id_product`, `id_portfolio`,`ma_product`, `name_product`, `price`,`price1`,`origin`,`specifications`,`img` ,`image_product`, `des1`, `description`) 
        VALUES ('','$portfolio','$prod_code','$prod_name','$price','$price1','$origin','$specifications','$img','$image','$dess','$des')";
        //echo $add_product;
        $query_add_product = mysqli_query($conn, $add_product);
        if ($query_add_product) {
            echo "<script>window.alert('Thêm sản phẩm thành công!');window.location.href = 'product.php'</script>";
        }
    }
...
<head>
    <meta charset="utf-8">
    <title>Onplaza - Thêm sản phẩm</title>
                        ...
                        <div class="col-9" style="margin: auto;">
                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-white" placeholder="Nhập tên mã sản phẩm ..." type="text"
                                        name="prod-code">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Tên sản phẩm: </label>
                                    <input class="form-control form-white" placeholder="Nhập tên sản phẩm ..." type="text"
                                        name="prod-name">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="portfolio">
                                        ...
                                        while ($row_cat = mysqli_fetch_assoc($sql_cat)) { ?>
                                            <option value="<?php echo $row_cat['id_portfolio']; ?>"><?php echo $row_cat['name_portfolio']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="">Giá: </label>
                                    <input type="text" placeholder="Nhập giá sản phẩm ..." name="price" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Giá khuyến mãi: </label>
                                    <input type="text" placeholder="Nhập giá sản phẩm ..." name="price1" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Nhập quy cách ..." name="specifications" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="text-right pt-2">
                                    <button type="button" class="btn btn-light " data-dismiss="modal"><a
                                            style="color: white;" href="product.php">Trở về</a></button>
                                    <button class="btn btn-primary" name="add_product">Thêm sản phẩm</button>
                                </div>
                            </form>
                        </div><!-- end col-->
                    </div>
