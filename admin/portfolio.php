...
if (isset($_POST['sbm']) && !empty($_POST['search'])) {
    $search = $_POST['search'];
    $sql_portfolio = mysqli_query($conn, "SELECT * FROM portfolio WHERE name_portfolio LIKE '%$search%' ");
    $total_prd = mysqli_num_rows($sql_portfolio);
} else {
    $sql_portfolio = mysqli_query($conn, "SELECT * FROM portfolio");
}
...
<head>
    <meta charset="utf-8">
    <title>Onplaza - Danh mục sản phẩm</title>
                                ...
                                <div class="modal-body p-3">
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <select name="portfolio-category" id="">
                                            <?php
                                            $i = 1;
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Mã Danh mục sản phẩm: </label>
                                            <input class="form-control form-white" placeholder="Nhập mã Danh mục sản phẩm ..." type="text" name="portfolio-code" value="<?php if (isset($var['ma_portfolio'])) {
                                                                                                                                                            echo $var['ma_portfolio'];
                                                                                                                                                        } ?>">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            while ($row = mysqli_fetch_assoc($sql_portfolio)) {
                                            ?>
                                                <tr>
                                                    <td>
                                                        <?= $i++ ?>
                                                    ...
                                                    <td>
                                                        <?php  
                                                            ...
                                                            $sql_name_cat = mysqli_query($conn,"SELECT * FROM categories WHERE id_category = $id_cat");
                                                            $name_cat =  mysqli_fetch_assoc($sql_name_cat);
                                                            echo $name_cat['name_category'];
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?= $row['ma_portfolio'] ?>
                                                    ...
                                                    <td><a href="edit_portfolio.php?id=<?php echo $row['id_portfolio']; ?>" name="edit" class="edit"><i class="icon-edit la la-edit"></i></a></td>
                                                    <td><a onclick="return Del1('<?php echo $row['name_portfolio']; ?>')" class="delete" href="delete_portfolio.php?id=<?php echo $row['id_portfolio']; ?>"><i class="icon-delete la la-trash-o"></i></a></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
