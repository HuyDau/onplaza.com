...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $info = "SELECT * FROM portfolio WHERE id_portfolio = $id";
...
<head>
    <meta charset="utf-8">
    <title>Onplaza - Sửa danh mục sản phẩm</title>
                            ...
                            <form method="POST" action="">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-white" placeholder="Nhập mã danh mục ... " type="text" name="portfolio-code" value="<?php if (isset($row_info['ma_portfolio'])) {
                                                                                                                                                                echo $row_info['ma_portfolio'];
                                                                                                                                                            } ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="text-right pt-2">
                                        ...
                                        <button class="btn btn-primary" name="edit_portfolio">Lưu</button>
                                    </div>
                            </form>
                        </div><!-- end col-->
                    </div>
