...
if (isset($_POST['sbm']) && !empty($_POST['search'])) {
    $search = $_POST['search'];
    $sql_customer = mysqli_query($conn, "SELECT * FROM users WHERE name_product LIKE '%$search%' AND permission = 2");
    $total_prd = mysqli_num_rows($sql_product);
} else {
    $sql_customer = mysqli_query($conn, "SELECT * FROM users WHERE permission = 2");
}
...
<head>
    <meta charset="utf-8">
    <title>Onplaza - Khách hàng</title>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <a href="export_customer.php" class="btn btn-lg font-16 btn-success btn-block  ">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="edit_customer.php?id=<?php echo $row['id']; ?>" name="edit" class="edit"><i class="icon-edit la la-edit"></i></a></td>
                                                    <td><a onclick="return Del1('<?php echo $row['username']; ?>')" class="delete" href="delete_customer.php?id=<?php echo $row['id']; ?>"><i class="icon-delete la la-trash-o"></i></a></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
