			...
			<div class="tab_login">
				...
				<div class="website_login" id="login-now" style="display: block;">
					...
					<form action="https://onplaza.vn/index.php?module=users" name="login_form" class="login_form"
						...
						<div class="clear"></div>
						<input type="hidden" name="return" value="L2FuLWN1bmctbmd1dS1ob2FuZy1ob2FuLWdpYS1iYW8tbmhpZXU=">
					...
					<div class="box-register">
						<form action="https://onplaza.vn/index.php?module=users" name="register_form"
							...
							<input type="hidden" name="return"
								value="L2FuLWN1bmctbmd1dS1ob2FuZy1ob2FuLWdpYS1iYW8tbmhpZXU=">
							<input type="hidden" name="module" value="users">
							<input type="hidden" name="view" value="users">
							<input type="hidden" name="Itemid" value="9">
			...
			<div class="background_all" alt="Thế giới dinh dưỡng"
				...
				<div class="main_wrapper  main_wrapper_nohome  ">
					...
					<div class="main-area main-area-1col main-area-full">
						...
						<div class="clear"></div>
						<input type="hidden" name="name_cat" id="name_cat" value="Bảng giá an cung ngưu">
										...
										<div class="cat-title-main" id="cat-san-pham-duoc-lieu">
											...
											<div class="kk-star-ratings hidden" data-id="49">
												...
												<div class="kksr-legend">
													<div>
														<div class="kksr-title hidden">Bảng giá an cung ngưu</div>
								...
								<div class="wapper-content-page product_home_content">
									...
									<div class="cat_item_store menu_sticky sticky_1 cls">
										...
										<div class="banner_left">
											<img class="lazy after-lazy" alt="An cung ngưu hoàng hoàn hàn quốc"
														...
														<div class="frame_inner">
															...
															<div class="name">
																<h3><a style="color:#fff"
																		...
																		title="Ngưu hoàng Thanh Tâm Hàn Quốc hộp gỗ đỏ A034"
																		class="name">
																		Ngưu hoàng Thanh Tâm Hàn Quốc hộp gỗ đỏ A034
																	</a> </h3>
									...
									<div class="cat_item_store menu_sticky sticky_2 cls">
										...
										<div class="clear"></div>
										<div class="banner_left">
											<img class="lazy after-lazy" alt="An cung ngưu hoàng hoàn trung quốc"
														...
														<div class="frame_inner">
															...
															<div class="name">
																<h3><a style="color:#fff"
																		...
																		title="An cung ngưu hoàng hoàn hộp nhung cao cấp 1 viên - A014"
																		class="name">
																		An cung ngưu hoàng hoàn hộp nhung cao cấp 1 viên
																		- A014 </a> </h3>
										...
										<div class="cat_description description cls" id="box_conten_linfo">
											<p style="text-align:justify">Trên thị trường, cùng một sản phẩm nhưng <a
													href="ancungnguu.php"><span
														style="color:#e74c3c">giá thuốc an cung ngưu hoàng
														hoàn</span></a>&nbsp;được các cửa hàng bán với các mức&nbsp;khác
												nhau, dao động trong khoảng từ 700.000 - 6 triệu VNĐ. Nhiều người tiêu
												dùng sẽ chọn mua ở những địa chỉ bán an cung ngưu với mức giá rẻ nhất,
												tuy nhiên hãy cẩn thận với những sản phẩm an cung ngưu giá rẻ bởi rất có
												thể đó là hàng giả, hàng nhái, hàng kém chất lượng, sử dụng vừa không có
												hiệu quả mà lại rước họa vào thân.</p>
											...
											<p style="text-align:justify"><br>
												Trong các sản phẩm <a href="ancungnguutrungquoc.php"><span
														style="color:#e74c3c">an cung ngưu Trung Quốc</span></a> nổi
												tiếng nhất là các sản phẩm của thương hiệu Đồng Nhân Đường. Đây là nhà
												sản xuất an cung&nbsp;có lịch sử lâu đời nhất với bài thuốc chuẩn của
												danh y Ngô Đường, và các sản phẩm của Đồng Nhân Đường&nbsp;được sử dụng
												phổ biến nhất hiện nay. Một số sản phẩm an cung ngưu Đồng Nhân Đường nổi
												tiếng như: ACN hộp thiếc đỏ, ACN đai vàng, ACN hộp xanh, ngưu hoàng
												thanh tâm.... Ngoài ra, dòng an cung Trung Quốc còn có một số sản phẩm
												cũng được sử dụng rất nhiều&nbsp;ở Việt Nam như: an cung Rùa Vàng, Đông
												Á,...</p>
											...
											<p style="text-align:justify"><br>
												<em><strong>Lưu ý</strong>:</em> Một số sản phẩm giống nhau nhưng đóng
												hộp 1 viên, 2 viên, 3 viên hoặc 10 viên nên có giá khác nhau. Nếu nhu
												cầu sử dụng nhiều nên lựa chọn sản phẩm hộp nhiều viên để giảm chi phí.
											</p>
											...
											<p style="text-align:justify"><br>
												An cung ngưu hoàng hoàn Hàn Quốc có giá dao động từ 1 triệu – 7 triệu
												đồng/ hộp. Tùy vào thương hiệu sản xuất, số lượng viên/ hộp. Các sản
												phẩm an cung Hàn Quốc chủ yếu được nhập từ công ty sản xuất Kwang Dong,
												Iksu,.... Xem chi tiết các sản phẩm &gt;&gt;&gt; <a
													href="ancungnguuhanquoc.php"><span
											...
											<p style="text-align:justify"><br>
												*** <strong>Lưu ý</strong>: Giá an cung ngưu hoàng hoàn Hàn Quốc có thể
												thay đổi vào từng thời điểm. Phụ thuộc vào nhà sản xuất, giá nguyên
												liệu, tình hình thị trường. Nếu có nhu cầu quý vị có thể xem các thông
												tin chi tiết về tưng sản phẩm an cung Hàn Quốc tại bài:&nbsp;</p>
											...
											<ul>
												<li style="text-align:justify">Cơ sở 1: 76 Hai Bà Trưng, Q.Hoàn Kiếm, Hà
													Nội<br>
													Tel: 02435.66.88.99 -02436.555.888 -02439.99.77.55</li>
												<li style="text-align:justify">Cơ sở 2: 327 Trường Chinh, Q. Đống Đa, Hà
													Nội<br>
													Tel: 02436.555.777 - 02432.333.666 - 024.66.849.833</li>
												<li style="text-align:justify">Cơ sở 3: 19 - 21 Cách Mạng Tháng 8,
													phường Bến Thành, Quận 1, HCM&nbsp;<br>
													Tel: 0283.50.60.888 - 02862 838 999 - 0968.60.61.69</li>
											</ul>
										</div>
								...
								<ul>
									<li class="item">
										<a href="javascript:void(0)" id="sticky_1"
											title="An cung ngưu hoàng hoàn hàn quốc">
											<span class="icon"></span>
											<span class="text_hide">An cung ngưu hoàng hoàn hàn quốc</span>
										</a>
									</li>
									<li class="item">
										<a href="javascript:void(0)" id="sticky_2"
											title="An cung ngưu hoàng hoàn trung quốc">
											<span class="icon"></span>
											<span class="text_hide">An cung ngưu hoàng hoàn trung quốc</span>
										</a>
									</li>
								</ul>
							</div>
	...
	L90.547,145.583z"></path>
						...
						<div class="footer_im cls">
							...
							<div class="image_wrapper">
								<a href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=ancungnguu.php"
								...
								<a href="http://online.gov.vn/Home/WebDetails/18258?refurl=ancungnguu.php"
