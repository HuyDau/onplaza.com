...
if (isset($_POST['order'])) {
    ...
    $note = $_POST['note'];
    $products = mysqli_query($conn, "SELECT * FROM product WHERE id_product IN (" . implode(",", array_keys($_POST['quantity'])) . ")");
    $total = 0;
    $orderProduct = array();
    ...
    $add_order = mysqli_query($conn, "INSERT INTO `cart_detail` (`id_detail`, `id_cart`, `id_product`, `quantity`, `price`) VALUES " . $insertString . ";");
...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
    ...
    <script type="text/javascript" async="" src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/578172086/?random=1688487048997&amp;cv=11&amp;fst=1688487048997&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45He36s0&amp;u_w=1366&amp;u_h=768&amp;url=https%3A%2F%2Fonplaza.vn%2Fgio-hang.html&amp;ref=https%3A%2F%2Fonplaza.vn%2Fnam-linh-chi-do-han-quoc-l002%2F&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=Thanh%20to%C3%A1n%20%C4%91%C6%A1n%20h%C3%A0ng%20-%20Onplaza%20Vi%E1%BB%87t%20Ph%C3%A1p&amp;auid=568503462.1688460212&amp;data=Event%3D%3BItems%3D%3BValue%3D&amp;rfmt=3&amp;fmt=4">
    </script>
...
<body style="">
    ...
    <div class="header_wraper cls">
        ...
        <div class="home_index no-home">
            ...
            <div class="background_all" alt="Thế giới dinh dưỡng" style="background-image: url(assets/img/background/bg6.png); display: block;background-color:#140600;background-position:unset" nhansamhanquoc.php>
                    ...
                    <div class="breadcrumbs_wrapper" itemscope="" itemtype="http://schema.org/WebPage">
                        <ul class="breadcrumb" itemscope="itemscope" itemtype="https://schema.org/BreadcrumbList">
                            ...
                            <li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                                <a title="Onplaza Việt Pháp - Thế Giới dinh dưỡng" href="index.php" itemprop="item">
                ...
                <div class="container-fluid">
                    <div class="container">
                        <?php
                            if(!empty($success)){
                                ?>
                                    <p style="margin-top: 30px;text-align: center;color: #f4e0af;font-size: 25px;">
                                        <?= $success ?>
                                    </p>
                                    <img style="width: 250px;display: flex;margin: auto;" src="assets/img/logo/cart_success.png" alt="">
                                <?php
                            }
                        ?>
                    </div>
                ...
                ?>
                    <h3 style="margin-top: 20px;font-size: 20px;text-align: center;color: #f4e0af;">Giỏ hàng của bạn đang trồng <i class="las la-hand-point-right"></i> <a class="continue-buy" style="text-decoration: none;color: #f4e0af;" href="index.php">Tiếp tục mua hàng.</a> </h3>
                <?php
                } else {
                ?>
                                ...
                                <div class="detail_inner">
                                    ...
                                    <form action="thanhtoan.php" method="POST">
                                        <div class="row">
                                                    ...
                                                    <div class="item cls">
                                                        <div class="fieldset_item_row cls">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="value">
                                                                    <input placeholder="Họ tên (*)" type="text" name="name" id="name_user" value="" class="input_text" size="30">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="fieldset_item_row cls">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="value">
                                                                    <input placeholder="Điện thoại (*)" type="text" name="sdt" id="telephone_user" value="" class="input_text" size="30">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="item  cls">
                                                        <div class="fieldset_item_row cls fieldset_item_adresss">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="value">
                                                                    <select style="" id="ward" name="ward">
                                                        ...
                                                        <div class="fieldset_item_row cls">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="value">
                                                                    <textarea placeholder="Địa chỉ (*)" name="detail_address" id="address_user"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="fieldset_item_row cls">
                                                            <div class="form-group">
                                                                <div class="form_name">Ghi chú đơn hàng: </div>
                                                                <div class="value">
                                                                    <textarea placeholder="Ghi chú (*)" name="note" id="address_user"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="fieldset_item_row cls">
                                            ...
                                            <div class="col-md-6">
                                                <div class="title_info-">Đơn hàng</div>
                                                <div class="item right_item">
                                                    ...
                                                    <div id="card_product">
                                                        ...
                                                        <div class="top_item">
                                                            <div class="radio_box cls radio_box3">
                                                                ...
                                                                if (!empty($_SESSION["cart"])) {
                                                                    $prod_cart = mysqli_query($conn, "SELECT * FROM product WHERE id_product IN (" . implode(",", array_keys($_SESSION['cart'])) . ") ");
                                                                    while ($row = mysqli_fetch_array($prod_cart)) {
                                                                ?>
                                                                        <div class="row">
                                                                            <div class="col-md-7 iner_item left_iner _left_1">

                                                                                <div class="price_product">
                                                                                    <a class="name-item" title="<?= $row['name_product'] ?>" href="sanpham.php?id=<?= $row['id_product'] ?>">
                                                                                        <?= $row['name_product'] ?> X </a> <input style="background: none;width: 30px;border: none;" class="quantity" type="number" step="1" min="0" value="<?= $_SESSION["cart"][$row["id_product"]] ?>" name="quantity[<?= $row["id_product"] ?>]">

                                                                                </div>

                                                                            </div>

                                                                            <div class="col-md-5 iner_item right_iner">
                                                                                <div class="price">
                                                                                    <?= number_format($row['price1'], 0, "", ".") ?>₫
                                                                                </div>
                                                                ...
                                                                <?php
                                                                        ...
                                                                        $total += $row['price1'] * $_SESSION["cart"][$row["id_product"]];
                                                                    }
                                                                }
                                                                ?>
                                                            </div>
                                                            ...
                                                            <div class="radio_box" id="price_before">
                                                                <div class="total-price" id="total-price">
                                                                    <div class="total-price-inner border-top cls">
                                                        ...
                                                        <div class="clear"></div>
                                                        <div class="total-price-inner border-top cls" id="total_after">
                                                            <div class="iner_item left_iner total_text">
                                                                Tổng cộng: </div>
                                                            <div class="iner_item right_iner right_price">

                                                                <span class="price1"><?= number_format($total, 0, "", ".") ?>₫</span>
                                                        ...
                                                        <button class="btn-order" type="submit" name="order" id="" title="Đăng nhập và mua">Mua ngay</button>
                                                    </div>
                                ...
                                <div class="yt share_item">
                                    <a class="youtube-icon" href="" title="Link youtube" rel="nofollow" target="_blank">
                                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 215.094 215.094" style="enable-background:new 0 0 215.094 215.094;" xml:space="preserve">
                                            <path d="M28.302,32.547C12.673,32.547,0,45.22,0,60.849v93.396c0,15.629,12.673,28.302,28.302,28.302h158.491 c15.629,0,28.301-12.673,28.301-28.302V60.849c0-15.629-12.672-28.302-28.301-28.302H28.302z M90.547,145.583V69.511l50,38.036 L90.547,145.583z">
                                            </path>
    ...
    <script async="async" language="javascript" type="text/javascript" src="https://onplaza.vn/cache/js/bc23eda7cbfac59f4192ac07b0a3bec7.js?20230704231048"></script>
    </div>
