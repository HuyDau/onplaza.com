...
<body style="">
            ...
            <div class="tab_login">
                ...
                <div class="website_login" id="login-now" style="display: block;">
                    <form action="https://onplaza.vn/index.php?module=users" name="login_form" class="login_form"
                        ...
                        <div class="clear"></div> <input type="hidden" name="return" value="L2xpZW4taGUuaHRtbA==">
                    ...
                    <div class="box-register">
                        <form action="https://onplaza.vn/index.php?module=users" name="register_form"
                            ...
                            <div class="form-login">
                                    ...
                                    <div class="g-recaptcha" data-sitekey="6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci">
                                        <div style="width: 304px; height: 78px;">
                                            <div><iframe title="reCAPTCHA"
                                                    src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci&amp;co=aHR0cHM6Ly9vbnBsYXphLnZuOjQ0Mw..&amp;hl=vi&amp;v=khH7Ei3klcvfRI74FvDcfuOo&amp;size=normal&amp;cb=ugu2h9kftf48"
                                                    width="304" height="78" role="presentation" name="a-8hyiu5nox4jq"
                                ...
                                <div class="clear"></div>
                            </div> <input type="hidden" name="return" value="L2xpZW4taGUuaHRtbA=="> <input type="hidden"
                                name="module" value="users"> <input type="hidden" name="view" value="users"> <input
                                type="hidden" name="Itemid" value="43"> <input type="hidden" name="task"
                                value="register_save">
                        </form>
                    </div>
    ...
    <div class="header_wraper cls">
                ...
                <div class="wrapper_menupc">
                    ...
                    <div class="dcjq-mega-menu cls">
                        ...
                        <ul id="megamenu" class="menu mypopup">
                            ...
                            <li class="cat_level_0 level_0 sort activated  menu_level_0" id=" level_884"> <a
                                    href="lienhe.php" id="menu_item_884" class="menu_item_a" title="Liên hệ"> Liên hệ
                                </a> <!--	LEVEL 1			-->
                                <!--	end LEVEL 1			-->
                            </li> <!--	CHILDREN				-->
                        </ul>
            ...
            <div id="menu_mb">
                <div class="dcjq-mega-menu-mobile cls">
                    <ul id="megamenu3" class="menu mypopup">
                        ...
                        <li class="level_0 sort activated  " id="level_884"> <a href="lienhe.php" id="menu_item_884"
                ...
                <div class="breadcrumbs container cls">
                    <div class="breadcrumbs_wrapper" itemscope="" itemtype="http://schema.org/WebPage">
                        <ul class="breadcrumb" itemscope="itemscope" itemtype="https://schema.org/BreadcrumbList">
                            ...
                            <li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope"
                                itemtype="http://schema.org/ListItem"> <span itemprop="name">Liên hệ</span> </li>
                        </ul>
                    </div>
                </div> <!-- Content -->
                    ...
                    <div class="main-area main-area-1col main-area-full">
                        <div class="contact">
                            <div class="frame_head clearfix">
                                <h1 class="cat-title-main cat_main_cmt" id="tab-title-label"> <span
                                        class="title_main"><span class="des">Liên hệ với chúng tôi</span></span> </h1>
                            </div>
                            <div class="row ">
                                <div class="col-right col-lg-6 col-md-6 mt20">
                                    <form method="post" action="#" name="contact" class="form">
                                        <p class="note_form_contact">Quý khách vui lòng nhập đủ nội dung liên hệ vào
                                            from dưới đây, chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất!</p>
                                        <table cellpadding="5" class="contact_table" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" class="form_name"> <input type="text"
                                                            maxlength="255" value="" name="contact_title"
                                                            id="contact_title" title="Tiêu đề" class="form_control"
                                                            placeholder="Tiêu đề (*)"> </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="form_name form_message"> <textarea rows="5"
                                                            name="message" id="message"
                                                            placeholder="Nội dung (*)"></textarea> </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="form_name"> <input type="text"
                                                            maxlength="255" value="" name="contact_name"
                                                            id="contact_name" title="Họ và tên" class="form_control"
                                                            placeholder="Họ và tên (*)"> </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="form_name"> <input type="text"
                                                            maxlength="255" value="" name="contact_email"
                                                            id="contact_email" title="Email" class="form_control"
                                                            placeholder="Email"> </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" class="form_name"> <input type="text"
                                                            maxlength="255" value="" name="contact_phone"
                                                            id="contact_phone" title="Điện thoại" class="form_control"
                                                            placeholder="Điện thoại (*)"> </td>
                                                </tr>
                                                <tr>
                                                    <td class="td-capcha"> <input type="text" id="txtCaptcha1" value=""
                                                            name="txtCaptcha" maxlength="10" size="23"
                                                            placeholder="Mã xác nhận (*)"> <img id="imgCaptcha"
                                                        ...
                                                        <a href="javascript:changeCaptcha();"
                                                            ...
                                                            class="code-view">&nbsp;</a> </td>
                                                    <td class="form_text button-contact button-contact-dk"> <a
                                                            class="button" href="javascript: void(0)" id="submitbt">
                                                            <span>Gửi liên hệ</span> </a> </td>
                                                </tr>
                                            </tbody>
                                        </table> <input type="hidden" name="module" value="contact"> <input
                                            type="hidden" name="task" value="save"> <input type="hidden" name="view"
                                            value="contact">
                                    </form>
                                    <div class="text_left">
                                        <h2>LK: 76 Hai Bà Trưng</h2>
                                        <div class="address">Địa chỉ : 76 Hai Bà Trưng, Hoàn Kiếm, Hà Nội <br> (Cách
                                            Bệnh Biện K 50m - Cách Tòa Tháp Đôi Hà Nội 60m) <span class="link_map">
                                                <span class="dot">-</span> <a
                                                    href="https://g.page/congtyonplazavietphap?gm"
                                                    title="Xem bản đồ">Xem bản đồ <svg version="1.1" id="Capa_1"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        width="898.3px" height="898.3px" viewBox="0 0 898.3 898.3"
                                        ...
                                        <div class="phone">Điện thoại: 024.35.66.88.99 - 024.36.555.888 - 024
                                            39.99.77.55 - 09.66.60.61.69 </div>
                                        <h2>LK: 327 Trường Chinh</h2>
                                        <div class="address">Địa chỉ : 327 Trường Chinh, Ngã Tư Sở, Hà Nội <br> (Cách
                                            Ngã Tư Sở Khoảng 200m) <span class="link_map"> <span class="dot">-</span> <a
                                                    href="https://goo.gl/maps/VDdWz4fgP1Erz26Z9" title="Xem bản đồ">Xem
                                                    bản đồ <svg version="1.1" id="Capa_1"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        width="898.3px" height="898.3px" viewBox="0 0 898.3 898.3"
                                                        style="enable-background:new 0 0 898.3 898.3;"
                                        ...
                                        <div class="phone">Điện thoại: 024.36.555.777 - 024.32.333.666 - 024.66.849.833
                                            - 09.65.69.63.64 </div>
                                        <h2>LK: Hồ Chí Minh</h2>
                                        <div class="address">Địa chỉ : Số 19 – 21 Cách Mạng Tháng 8 – Phường Bến Thành –
                                            Quận 1 – TP.HCM <br> (Cách Ngã Sáu Phù Đổng Thiên Vương 10m – Đối diện sân
                                            khấu kịch Trống Đồng ) <span class="link_map"> <span class="dot">-</span> <a
                                                    href="https://g.page/onplazavietphaphcm?share"
                                                    title="Xem bản đồ">Xem bản đồ <svg version="1.1" id="Capa_1"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        width="898.3px" height="898.3px" viewBox="0 0 898.3 898.3"
                                        ...
                                        <div class="phone">Điện thoại: 028.35.060.888 - 028.62.838.999 - 09.68.60.61.69
                                        </div>
        ...
        <script async="async" language="javascript" type="text/javascript"
            src="https://onplaza.vn/cache/js/b03f8b5073ff7d9064a7f90f8b573d21.js?20230704182453"></script>
    </div>
