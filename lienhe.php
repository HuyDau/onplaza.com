...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
	...
	<style amp-custom="">
		...
		.contact .code-view {
			background: url("https://onplaza.vn/modules/contact/assets/images/change_captcha.png") no-repeat scroll center center;
			display: inline-block;
			padding: 8px 12px
		}
		...
		.contact #submitbt:hover,
		.contact #resetbt:hover {
			background: var(--extra-color);
			color: #fff;
			text-decoration: none
		}
			...
			<div class="tab_login">
				...
				<div class="website_login" id="login-now" style="display: block;">
					...
					<form action="https://onplaza.vn/index.php?module=users" name="login_form" class="login_form"
						...
						<div class="clear"></div>
						<input type="hidden" name="return" value="L2xpZW4taGUuaHRtbA==">
			...
			C360.128,120.716,317.92,143.692,295.776,143.692z"></path>
					...
					<div class="dcjq-mega-menu cls">
						...
						<ul id="megamenu" class="menu mypopup">
							...
							<li class="cat_level_0 level_0 sort activated  menu_level_0" id=" level_884">
			...
			<div id="menu_mb">
				<div class="dcjq-mega-menu-mobile cls">
					...
					<ul id="megamenu3" class="menu mypopup">
						...
						<li class="level_0 sort activated  " id="level_884">
							<a href="lienhe.php" id="menu_item_884" class="menu_item_a"
								title="Liên hệ">
								Liên hệ </a>
					...
					<div class="main-area main-area-1col main-area-full">
						...
						<div class="contact">
							...
							<div class="frame_head clearfix">
								...
								<h1 class="cat-title-main cat_main_cmt" id="tab-title-label">
									<span class="title_main"><span class="des">Liên hệ với chúng tôi</span></span>
								...
								<div class="col-right col-lg-6 col-md-6 mt20">
									<form method="post" action="#" name="contact" class="form">
										...
										<table cellpadding="5" class="contact_table" width="100%">
											<tbody>
												<tr>
													<td colspan="2" class="form_name">
														<input type="text" maxlength="255" value="" name="contact_title"
												...
												<tr>
													<td colspan="2" class="form_name form_message">
												...
												<tr>
													<td colspan="2" class="form_name">
														<input type="text" maxlength="255" value="" name="contact_name"
												...
												<tr>
													<td colspan="2" class="form_name">
														<input type="text" maxlength="255" value="" name="contact_email"
												...
												<tr>
													<td colspan="2" class="form_name">
														<input type="text" maxlength="255" value="" name="contact_phone"
												...
												<tr>
													<td class="td-capcha">
														<input type="text" id="txtCaptcha1" value="" name="txtCaptcha"
															maxlength="10" size="23" placeholder="Mã xác nhận (*)">
														<img id="imgCaptcha"
															src="https://onplaza.vn/libraries/jquery/ajax_captcha/create_image.php">
													...
													<td class="form_text button-contact button-contact-dk">
									...
									<div class="text_left">
										...
										<div class="address">Địa chỉ : 76 Hai Bà Trưng, Hoàn Kiếm, Hà Nội <br> (Cách
											Bệnh Biện K 50m - Cách Tòa Tháp Đôi Hà Nội 60m)
											<span class="link_map"> <span class="dot">-</span> <a
													href="https://g.page/congtyonplazavietphap?gm"
													title="Xem bản đồ">Xem bản đồ
													<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
														xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	L90.547,145.583z"></path>
					...
					<div class="footer_im cls">
						...
						<div class="image_wrapper">
							<a href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=lienhe.php"
							...
							<a href="http://online.gov.vn/Home/WebDetails/18258?refurl=lienhe.php"
		...
		<input type="hidden" id="Itid" name="Itid" value="43">
