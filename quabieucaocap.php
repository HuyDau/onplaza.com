	...
	<script type="application/ld+json">
		{
			...
			"mainEntity": [{
				...
				"acceptedAnswer": {
					...
					2. Quà biếu cao cấp: bình rươu sâm,
					sâm tươi Hàn Quốc
					3. Đồng hồ,
					mỹ phẩm,
					nước hoa 4. Bộ quà tặng phong thủy "
				}
			}, {
				"@type": "Question",
				...
				"acceptedAnswer": {
					...
					2. Tặng bố mẹ một chuyến du lịch,
					nghỉ dưỡng
								...
								<div class="breadcrumbs_wrapper" itemscope="" itemtype="http://schema.org/WebPage">
									<ul class="breadcrumb" itemscope="itemscope"
										...
										<li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope"
											...
											<a title="Quà biếu cao cấp" href="quabieucaocap.php" itemprop="item">
							...
							<div class="container">
								<article class="cat_summary cls">
									...
									<div class="summary_content summary_content_detail">
										<p style="text-align:justify"><a href="quabieucaocap.php"><strong>Quà biếu
											...
											<div class="frame_inner">
												<figure class="product_image ">
													...
													<a href="nuochongsam.php-tu-nhien-khong-duong-deasan-han-quoc-ns933/"
														title="<?=$item_quabieu['name_product']?>">
														<img class="lazy after-lazy"
															alt="<?=$item_quabieu['name_product']?>"
												...
												<div class="name">
													<h3><a style="color:#fff"
															...
															title="<?=$item_quabieu['name_product']?>" class="name">
												...
												<div class="price_arae">
													<span class="price_current"
														style="color:#FFE2B8"><?=number_format($item_quabieu['price'],0,"",".")?>₫</span>
													<span class="price_old" style="color:#FFE2B8">
														<span
															class="item_old"><?=number_format($item_quabieu['price1'],0,"",".")?>₫
														</span>
													</span>
												</div>
												...
												<div class="buy_nows">
													<a href="nuochongsam.php-tu-nhien-khong-duong-deasan-han-quoc-ns933/"
														title="Mua sản phẩm <?=$item_quabieu['name_product']?>">
														Mua sản phẩm
													</a>
												</div>
							...
							<div class="container">
								...
								<div class="cat_description description cls" id="box_conten_linfo">
									...
									<h2 id="Ý+nghĩa+quà+tặng+sức+khỏe+cho+từng+đối+tượng" style="text-align:justify">
										<strong>Ý nghĩa quà tặng sức khỏe cho từng đối tượng</strong>
									</h2>
									...
									<div style="text-align:center">
										<figure class="image" style="display:inline-block"><img class="lazy2"
												alt="Quà tặng sức khỏe" src="uploads/quabieu/qua-tang-suc-khoe.png">
									...
									<h3 id="1.+Sâm+Ngọc+Linh+-+Món+quà+biếu+độc,+lạ" style="text-align:justify">
										<strong>1. Sâm Ngọc Linh - Món quà biếu độc, lạ</strong>
									</h3>
									...
									<div style="text-align:center">
										<figure class="image" style="display:inline-block"><img class="lazy2"
												alt="Quà tặng bình rượu" src="uploads/quabieu/qua-tang-binh-ruou.png">
									...
									<h3 id="2.+Quà+tặng+cao+cấp+Đông+trùng+hạ+thảo+Tây+Tạng" style="text-align:justify">
										<strong>2. Quà tặng cao cấp Đông trùng hạ thảo Tây Tạng</strong>
									</h3>

									<p style="text-align:justify"><br>
										Đứng ngang hàng cùng sâm Ngọc Linh là <a href="dongtrungtaytang.php">con đông
											trùng hạ thảo
									...
									<div style="text-align:center">
										<figure class="image" style="display:inline-block"><img class="lazy2"
												...
												src="uploads/quabieu/qua-tang-dong-trung-ha-thao.png">
									...
									<h3 id="3.+Quà+biếu+sức+khỏe+Yến+sào+Khánh+Hòa" style="text-align:justify">
										<strong>3. Quà biếu sức khỏe Yến sào Khánh Hòa</strong>
									</h3>
									...
									<p style="text-align:justify">Hiện nay, <a href="yensaokhanhhoa.php">yến&nbsp;Khánh
											Hòa </a>trở thành
									...
									<div style="text-align:center">
										<figure class="image" style="display:inline-block"><img class="lazy2"
												...
												src="uploads/quabieu/qua-bieu-yen-khanh-hoa.png">
									...
									<p style="text-align:center"><img class="lazy2"
											...
											src="uploads/quabieu/nhan-sam-thao-duoc-quy-cho-suc-khoe.png">
									</p>
									...
									<p style="text-align:center"><img class="lazy2" alt="nấm linh chi"
											src="uploads/quabieu/nam-linh-chi.png">
									</p>
									...
									<p style="text-align:justify">Một cặp <a href="nhunghuoutuoi.php">nhung hươu
											tươi</a> hoặc hộp nhung
