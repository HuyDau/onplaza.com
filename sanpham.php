...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
	...
	<meta name="keywords"
		content="đông trùng tây tạng,đông trùng hạ thảo hộp 100g,giá 1 lạng đông trùng hạ thảo,đông trùng hạ thảo nguyên con">
	...
	<meta name="dc.title" content="Đông trùng hạ thảo Tây Tạng hộp 100gr loại 500 – 600 con cao cấp">
	<meta name="dc.keywords"
		content="đông trùng tây tạng,đông trùng hạ thảo hộp 100g,giá 1 lạng đông trùng hạ thảo,đông trùng hạ thảo nguyên con">
	<meta name="dc.subject" content="Đông trùng hạ thảo Tây Tạng hộp 100gr loại 500 – 600 con cao cấp">
	...
	<meta property="og:title" content="Đông trùng hạ thảo Tây Tạng hộp 100gr loại 500 – 600 con cao cấp">
	<meta property="og:url" content="dongtrungtaytang.php-cao-cap-hop-100gr/">
	...
	<link rel="canonical" href="dongtrungtaytang.php-cao-cap-hop-100gr/">
	...
	<style amp-custom="">
		...
		.all_des_other_product .item {
			margin-bottom: 10px
		}

		.all_des_other_product .item:last-child {
			margin-bottom: 0px
		}

		.all_des_other_product .item .top-tt {
			font-weight: 700;
			line-height: 22px;
			color: #565656
		}

		.all_des_other_product .item .bot_des {
			line-height: 22px;
			color: #565656
		}
		...
		.advantage .hotline-detail {
			margin-bottom: 5px
		}

		.advantage .hotline-detail span {
			font-weight: bold;
			color: var(--main-color)
		}

		.advantage .address-detail span {
			color: blue
		}
		...
		.product .product_base .price .price_current .text_price {
			font-size: 20px;
			width: 140px;
			display: inline-block;
			color: #000
		...
		@media only screen and (max-width: 670px) and (max-width: 414px) {
			.product .frame_center {
		...
		.all_ground_extend .ground_extend_item .item_extend_name .item:hover .extend_name {
			color: #000
		}
		...
		.all_ground_extend .ground_extend_item .item_extend_name .active .extend_name {
			color: #000
		}
		...
		.all_ground_extend .ground_extend_item .item_extend_name .active:before {
			display: block
		}
		...
		.product_compatables .tab-title span {
			font-weight: bold
		}
		...
		.product_compatables .item .price_arae {
			padding: 5px 0px 3px;
			float: left
		}

		.product_compatables .item .price_arae .price_current {
			margin-right: 2px;
			font-size: 20px;
			display: block
		}
		...
		.product_compatables .item .price_arae .price_discount {
			float: left;
			margin-right: 5px;
			font-size: 14px
		}
		...
		@media screen and (max-width: 600px) {
			...
			.product_compatables .item .name_compatable a {
				text-overflow: ellipsis;
				-webkit-line-clamp: 2;
				display: -webkit-box;
				overflow: hidden;
		...
		.product_compatables .item .product_image img {
		...
		.product_compatables .product_compatables_item_mb .frame_inner {
			padding-left: 0px;
			position: relative
		}
		...
		.product_compatables .product_compatables_item_mb .frame_inner:before {
			content: '+';
			font-size: 30px;
			line-height: 30px;
			color: var(--main-color);
		...
		.product_compatables .product_compatables_item_mb .chose_other_compatables {
			margin-top: 10px
		}
		...
		.product_compatables .product_compatables_item_mb .chose_other_compatables a {
			color: var(--main-color)
		}

		.product_compatables .product_compatables_item .chose_other_compatables a:hover,
		.product_compatables .product_compatables_item_mb .chose_other_compatables a:hover {
			color: var(--main-color)
		}
		...
		.popup_chose_other_compatables .other_title {
			color: #fff;
			font-size: 20px
		}
		...
		.popup_chose_other_compatables .popup_chose_other_compatables_inner .name_compatable a {
			color: var(--main-color)
		}
		...
		.product_compatables .product_image .check {
			position: absolute;
			left: 5px;
			top: 5px
		}

		.product_compatables .product_image .check input {
			width: 18px;
			height: 18px
		}

		.product_compatables .product_image .checkbox {
			width: 100%;
			position: relative;
			display: block
		}

		.product_compatables .product_image .checkbox .geekmark {
			position: relative;
			display: block;
			width: 18px;
			height: 18px;
		...
		.product_compatables .product_image .checkbox .geekmark:before {
			content: '';
			position: absolute;
			left: 0;
			top: 0;
		...
		.product_compatables .product_image .checkbox .geekmark:after {
			content: '';
			display: block;
			width: 8px;
			height: 8px;
		...
		.product_compatables .product_image .checkbox input[type="checkbox"] {
			width: auto;
			opacity: 0.00000001;
			position: absolute;
			z-index: 9
		...
		.product_compatables .product_image .checkbox input[type="checkbox"]:checked~.geekmark:before {
			border: 2px solid var(--main-color)
		}

		.product_compatables .product_image .checkbox input[type="checkbox"]:checked~.geekmark:after {
			opacity: 1
		}

		.product_compatables .product_image .checkbox input[type="checkbox"]:focus+.geekmark::before {
			outline: 0
		}

		.product_tab_content .tab-title {
			display: flex;
			flex-wrap: wrap;
			margin-bottom: 0px
		}

		.product_tab_content .tab-title li {
			width: 20%;
			background: #5b0000;
			text-align: center;
		...
		@media screen and (max-width: 768px) {
			...
			.product_tab_content .tab-title li:nth-child(3),
			.product_tab_content .tab-title li:nth-child(4) {
				width: 15%
			}

			.product_tab_content .tab-title li:nth-child(5) {
				width: 25%
			}
		}

		.product_tab_content .tab-title li a {
			padding: 12px 0px;
			overflow: unset;
			display: block;
		...
		.product_tab_content .tab-title .active {
			background: #f4e0af;
			border: 1px solid transparent
		}

		.product_tab_content .tab-title .active a {
			color: #230d03
		}
		...
		.tab_content_right .tab-title,
		#prodetails_tab50 .tab-title {
			text-align: left;
			margin-top: 0px
		}

		.tab_content_right .tab-title span,
		#prodetails_tab50 .tab-title span {
			font-size: 25px;
			font-weight: bold;
			padding: 0px;
			text-transform: unset
		...
		.cat-title-main .title_main::before {
			width: calc(100% - 25px);
			position: absolute;
			top: 0;
			content: '';
		...
		#prodetails_tabnews .cat-title-main {
			margin-bottom: 25px
		}

		#prodetails_tabnews #characteristic-label {
			text-transform: uppercase;
			font-size: 34px;
			color: #ffb26f;
			text-align: center;
		...
		#prodetails_tabnews .news_related_vertical {
			margin: 0 -10px;
			display: flex;
			flex-wrap: wrap
		}
		...
		#prodetails_tabnews .news_related_vertical .item-related {
			width: calc(25% - 20px);
			float: left;
			margin: 0 10px 20px;
			position: relative
		...
		#prodetails_tabnews .news_related_vertical .item-related .title-item-related {
			text-align: left;
			position: absolute;
			bottom: 0px;
			padding: 10px;
		...
		#prodetails_tabnews .news_related_vertical .item-related .title-item-related a {
			display: inline-block;
			line-height: 20px;
		...
		#Zoomer .play-video svg,
		#sync2 .play-video svg {
			z-index: 99;
			width: 65px;
			height: 65px;
			fill: #cdcdcd
		...
		#Zoomer:hover .play-video svg,
		#sync2:hover .play-video svg {
			fill: #ff0000
		}
		...
		@media screen and (max-width: 768px) {
			...
			.product_tab_mee .tab-title,
			.top-info-detail .tab-title {
				width: 815px
			}

			.product_tab_mee .compare_table,
			.top-info-detail .compare_table {
				width: 500px
			}

			.product_tab_mee .cat-title-main,
			.top-info-detail .cat-title-main {
				margin-bottom: 10px
			}
		}
 ...
 */
		...
		.list_video_below .owl-controls .owl-nav div {
			display: inline-block;
			zoom: 1;
			position: absolute;
			padding: 3px 0 0;
		...
		.list_video_below .owl-controls .owl-prev {
			right: 40px
		}

		.list_video_below .owl-controls .owl-next {
			right: 0px
		}
		...
		.list_video_below>.item {
			margin: 0px 20px;
			width: calc(100% / 3 - 40px)
		}

		.all_video_reale .owl-dots {
			bottom: -30px
		}

		.all_video_reale .owl-dots .owl-dot {
			width: 13px;
			height: 13px;
		...
		.all_video_reale .owl-dots .active {
			background: #ffb26f
		}
		...
		#one_video_play_area .video-name-inner {
			text-overflow: ellipsis;
			-webkit-line-clamp: 2;
			display: -webkit-box;
			overflow: hidden;
		...
		.comments .wrap_submit .wrapper_imagevideo {
			text-align: left;
			width: calc(100% - 120px)
		}

		.comments .wrap_submit .wrapper_imagevideo .imagevideo {
			float: left;
			margin-right: 10px
		}

		.comments .wrap_submit .wrapper_imagevideo .imagevideo a {
			font-size: 14px;
			font-weight: 500;
			color: var(--main-color);
			display: inline-block;
		...
		.comments .wrap_submit .pull-right {
			float: right
		}
		...
		.comments ._contents ._level_0 p ._avatar svg {
			width: 22px;
			height: 22px;
			fill: var(--main-color)
		}
		...
		.comments ._contents ._level_0 ._wrap #ratings {
			display: block;
			margin-left: 26px;
			margin: 0px 0px 10px 26px
		}

		.comments ._contents ._level_0 ._wrap #ratings i {
			margin-right: 3px
		}
		...
		.comments ._contents ._level_0 ._wrap ._control a {
			margin-right: 20px
		}
		...
		.comments ._contents ._level_0 ._wrap ._control .wishlist2 svg {
			width: 14px;
			height: 14px;
			fill: var(--main-color);
			position: absolute;
		...
		.comments ._contents ._level_0 ._wrap ._control .wishlist2 a {
			padding-left: 19px;
			position: relative
		}

		.comments ._contents ._level_0 ._wrap ._control .wishlist2 span {
			color: var(--main-color)
		}
		...
		.rating_note::after {
			...
			border-color: transparent var(--extra-color) transparent transparent;
			position: absolute;
			top: 0;
			left: -12px
		}
		...
		.upload-media:focus+label,
		.upload-media+label:hover {
			background-color: red
		}
		...
		#multiFiles:focus+label,
		#multiFiles+label:hover {
			background-color: red
		}
		...
		#onetiFiles:focus+label,
		#onetiFiles+label:hover {
			background-color: red
		}
		...
		.cat_main_cmt .title_main::before {
			width: calc(100% - 25px);
			position: absolute;
			top: 0;
			content: '';
		...
		#feedsImageBase .image-area-single,
		.feedsImageBase .image-area-single {
			color: #fff
		}
		...
		#sortableimg_real li div {
			margin: 0px auto
		}

		#sortableimg_real span {
		...
		#sortableimg_real span:hover {
			text-decoration: underline
		}

		#sortableimg_real font {
			padding: 0px 2px;
			color: #000000
		}

		#sortableimg_real li .image-area-single .del {
			margin: 0;
			padding: 0;
			position: relative
		}

		#sortableimg_real li .image-area-single .del span {
			position: absolute;
			width: 16px;
			height: 16px;
			right: -21px
		...
		#sortableimg_real li .image-area-single {
			background-color: unset;
			background-color: unset;
			border-radius: 3px;
			float: left;
		...
		#sortableimg_real li .image-area-single .img {
			overflow: hidden
		}

		#sortableimg_real li .image-area-single .del img {
			opacity: 0.5
		}

		#sortableimg_real li .image-area-single .del img:hover {
			opacity: 1
		}
		...
		._list_media li .play-video svg {
			width: 35px;
			height: 35px
		}

		._list_media li .play-video svg:hover {
			fill: #ff0000
		}
		...
		._address_buy ._popup_view ._name2,
		._address_buy ._popup_view ._name3 {
			display: block;
			margin-bottom: 7px
		}
		...
		._address_buy ._popup_view ._name2 svg {
			fill: #ca0206;
			position: absolute;
			left: 5px;
			top: 50%;
		...
		._address_buy ._popup_view ._name2:last-child {
			margin-bottom: 0px
		}

		._address_buy ._popup_view .b {
			font-weight: 700
		}

		._address_buy ._popup_view time {
			color: #000
		}

		._address_buy ._popup_view:before,
		._address_buy ._popup_view:after {
			content: '';
			position: absolute;
			bottom: 100%;
			left: 80px;
		...
		._address_buy:hover ._popup_view {
			opacity: 1;
			visibility: visible
		}
		...
		.popup_addvideo .fileUpload input.upload {
			position: absolute;
			top: 0;
			right: 0;
			margin: 0;
		...
		.popup_addvideo .fileUpload {
			position: relative;
			overflow: hidden;
			margin: 10px
		}

		.popup_addvideo .btn-primary {
			display: inline-block;
			padding: 6px 12px;
			margin-bottom: 0;
			font-size: 14px;
		...
		.popup_addvideo .close_form {
			position: absolute;
			top: 5px;
			right: 15px
		}

		.popup_addvideo .close_form svg {
			width: 25px;
			height: 25px;
			fill: #ff0000
		}

		.popup_addvideo .align_item {
			text-align: center
		}

		.popup_addvideo .align_item #send_videos {
			padding: 8px 25px;
			border: 1px solid #fff;
			font-size: 16px;
			border-radius: 5px;
		...
		#fileSuccessBaseVideo {
			margin-top: 10px;
			color: #fff
		}

		#fileSuccessBaseVideo .del {
			color: #fff
		}

		#fileSuccessBaseVideo .del span {
			cursor: pointer
		}
		...
		.image-area-single .del {
			color: #fff
		}

		.image-area-single .del span {
			cursor: pointer
		}
	 ...
	 This is visible during transitions. */
		...
		.product_related_title {
			background: url(https://onplaza.vn/modules/products/assets/images/bg_nav_description.png) repeat scroll 0 0;
			font-size: 12px;
			font-weight: 700;
			padding: 6px 10px;
			text-transform: uppercase
		...
		.product .product_related .item img {
			margin: 0 auto
		}
		...
		.product .product_related .name a {
			font-weight: 700;
			font-family: semibold
		}

		.product .product_related .price_relate {
			color: red;
			font-family: semibold;
			font-size: 16px;
			font-weight: 700;
		...
		.product .product_related .price_relate_old {
			color: #868686;
			line-height: 24px;
			text-decoration: line-through;
			margin-left: 12px
		...
		.product #Carousel_relate {
			padding: 10px
		}

		.product #Carousel_relate .carousel-control.right {
			background: url(https://onplaza.vn/modules/products/assets/images/icon_next_2.png) no-repeat;
			height: 18px;
			opacity: 1;
			right: 10px;
			top: -24px;
		...
		.product #Carousel_relate .carousel-control.left {
			background: url(https://onplaza.vn/modules/products/assets/images/icon_prev_2.png) no-repeat;
			height: 18px;
			left: auto;
			opacity: 1;
			right: 35px;
	...
	<script type="text/javascript" async=""
		src="https://googleads.g.doubleclick.net/pagead/viewthroughconversion/578172086/?random=1688486994498&amp;cv=11&amp;fst=1688486994498&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45He36s0&amp;u_w=1366&amp;u_h=768&amp;url=https%3A%2F%2Fonplaza.vn%2Fdong-trung-ha-thao-tay-tang-cao-cap-hop-100gr%2F&amp;ref=https%3A%2F%2Fonplaza.vn%2F&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=%C4%90%C3%B4ng%20tr%C3%B9ng%20h%E1%BA%A1%20th%E1%BA%A3o%20T%C3%A2y%20T%E1%BA%A1ng%20h%E1%BB%99p%20100gr%20lo%E1%BA%A1i%20500%20%E2%80%93%20600%20con%20cao%20c%E1%BA%A5p&amp;auid=568503462.1688460212&amp;uaa=x86&amp;uab=64&amp;uafvl=Not.A%252FBrand%3B8.0.0.0%7CChromium%3B114.0.5735.199%7CGoogle%2520Chrome%3B114.0.5735.199&amp;uamb=0&amp;uap=Windows&amp;uapv=10.0.0&amp;uaw=0&amp;data=Event%3D%3BItems%3D%3BValue%3D&amp;rfmt=3&amp;fmt=4"></script>
	<meta http-equiv="origin-trial"
		content="">
	<meta http-equiv="origin-trial"
	...
	<script attributionsrc="" type="text/javascript" async=""
		src="https://www.googleadservices.com/pagead/conversion/588843954/?random=1688486995795&amp;cv=11&amp;fst=1688486995795&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45He36s0&amp;u_w=1366&amp;u_h=768&amp;url=https%3A%2F%2Fonplaza.vn%2Fdong-trung-ha-thao-tay-tang-cao-cap-hop-100gr%2F&amp;ref=https%3A%2F%2Fonplaza.vn%2F&amp;label=Z5hbCPfGo_MBELKX5JgC&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=%C4%90%C3%B4ng%20tr%C3%B9ng%20h%E1%BA%A1%20th%E1%BA%A3o%20T%C3%A2y%20T%E1%BA%A1ng%20h%E1%BB%99p%20100gr%20lo%E1%BA%A1i%20500%20%E2%80%93%20600%20con%20cao%20c%E1%BA%A5p&amp;value=0&amp;bttype=purchase&amp;auid=568503462.1688460212&amp;uaa=x86&amp;uab=64&amp;uafvl=Not.A%252FBrand%3B8.0.0.0%7CChromium%3B114.0.5735.199%7CGoogle%2520Chrome%3B114.0.5735.199&amp;uamb=0&amp;uap=Windows&amp;uapv=10.0.0&amp;uaw=0&amp;rfmt=3&amp;fmt=4"></script>
	<script attributionsrc="" type="text/javascript" async=""
		src="https://www.googleadservices.com/pagead/conversion/581761986/?random=1688486995803&amp;cv=11&amp;fst=1688486995803&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45He36s0&amp;u_w=1366&amp;u_h=768&amp;url=https%3A%2F%2Fonplaza.vn%2Fdong-trung-ha-thao-tay-tang-cao-cap-hop-100gr%2F&amp;ref=https%3A%2F%2Fonplaza.vn%2F&amp;label=r5GSCL6UpPMBEML3s5UC&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=%C4%90%C3%B4ng%20tr%C3%B9ng%20h%E1%BA%A1%20th%E1%BA%A3o%20T%C3%A2y%20T%E1%BA%A1ng%20h%E1%BB%99p%20100gr%20lo%E1%BA%A1i%20500%20%E2%80%93%20600%20con%20cao%20c%E1%BA%A5p&amp;value=0&amp;bttype=purchase&amp;auid=568503462.1688460212&amp;uaa=x86&amp;uab=64&amp;uafvl=Not.A%252FBrand%3B8.0.0.0%7CChromium%3B114.0.5735.199%7CGoogle%2520Chrome%3B114.0.5735.199&amp;uamb=0&amp;uap=Windows&amp;uapv=10.0.0&amp;uaw=0&amp;rfmt=3&amp;fmt=4"></script>
	<script attributionsrc="" type="text/javascript" async=""
		src="https://www.googleadservices.com/pagead/conversion/586465778/?random=1688486995807&amp;cv=11&amp;fst=1688486995807&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45He36s0&amp;u_w=1366&amp;u_h=768&amp;url=https%3A%2F%2Fonplaza.vn%2Fdong-trung-ha-thao-tay-tang-cao-cap-hop-100gr%2F&amp;ref=https%3A%2F%2Fonplaza.vn%2F&amp;label=3QpbCI6dpPMBEPKD05cC&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=%C4%90%C3%B4ng%20tr%C3%B9ng%20h%E1%BA%A1%20th%E1%BA%A3o%20T%C3%A2y%20T%E1%BA%A1ng%20h%E1%BB%99p%20100gr%20lo%E1%BA%A1i%20500%20%E2%80%93%20600%20con%20cao%20c%E1%BA%A5p&amp;value=0&amp;bttype=purchase&amp;auid=568503462.1688460212&amp;uaa=x86&amp;uab=64&amp;uafvl=Not.A%252FBrand%3B8.0.0.0%7CChromium%3B114.0.5735.199%7CGoogle%2520Chrome%3B114.0.5735.199&amp;uamb=0&amp;uap=Windows&amp;uapv=10.0.0&amp;uaw=0&amp;rfmt=3&amp;fmt=4"></script>
				...
				<div class="website_login" id="login-now" style="display: block;">
					...
					<form action="https://onplaza.vn/index.php?module=users" name="login_form" class="login_form"
						...
						<input type="hidden" name="return"
							value="L2RvbmctdHJ1bmctaGEtdGhhby10YXktdGFuZy1jYW8tY2FwLWhvcC0xMDBnci8=">
									...
									<div class="g-recaptcha" data-sitekey="6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci">
										<div style="width: 304px; height: 78px;">
											<div><iframe title="reCAPTCHA"
													src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci&amp;co=aHR0cHM6Ly9vbnBsYXphLnZuOjQ0Mw..&amp;hl=vi&amp;v=khH7Ei3klcvfRI74FvDcfuOo&amp;size=normal&amp;cb=f2zqw2s9fc9r"
													width="304" height="78" role="presentation" name="a-3jequqth0g6j"
				...
				<div class="main_wrapper  main_wrapper_nohome">
					...
					<div class="main-area main-area-1col main-area-full">
						...
						<div class="product" itemscope="" itemtype="https://schema.org/Product">
							<meta itemprop="url"
								content="dongtrungtaytang.php-cao-cap-hop-100gr/">

							<div class="default_product background-sample" alt="Giá đông trùng hạ thảo"
								style="background-image: url(https://onplaza.vn/images/products/cat/compress/nen_1591789358.jpg.webp); display: block;background-color:#3F1300;background-position:unset"
								nhansamhanquoc.php>
								<div class="container">

									<div class="breadcrumbs  cls">

										<div class="breadcrumbs_wrapper" itemscope=""
											...
											<ul class="breadcrumb" itemscope="itemscope"
												...
												<li class="breadcrumb__item" itemprop="itemListElement"
													...
													<a title="Dược liệu cao cấp"
														href="sanphamduoclieu.php" itemprop="item">
											...
											<div class="thumbs">
												<div id="sync2" class="owl-carousel owl-theme owl-loaded">
													...
													<div class="owl-stage-outer">
														<div class="owl-stage"
															style="width: 95.8px; transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s;">
										...
										<div class="frame_center">
											<div class="product_name">
												...
												<div id="rate_fixed">
													<span class="rate rate_head" itemprop="aggregateRating" itemscope=""
														...
														<a href="javascript:void(0)" title="Đánh giá sản phẩm này"
															class="rate_count"
															onclick="$('html, body').animate({ scrollTop: $('#prodetails_tab3').offset().top }, 500);">
															(<span itemprop="ratingCount">1</span> đánh giá)</a>
											...
											<div class="product_base">
												...
												<form action="#" name="buy_simple_form" method="post">
													...
													<div class="price cls" itemprop="offers" itemscope=""
													...
													<div class="_color">
														<input type="hidden" value="" id="color_curent_id"
															name="color_curent_id">
													</div>
												...
												<div class="buy_fast hide">
													<form action="" name="buy_fast_form" id="buy_fast_form"
														method="post"
														onsubmit="javascript: return submit_form_buy_fast();">
														<label>Đặt hàng nhanh</label>
														<div class="sub_title">Để lại số điện thoại, chúng tôi sẽ gọi
															lại ngay</div>
														<div class="cls">
															<input type="text" value="" placeholder="Nhập số điện thoại"
																id="telephone_buy_fast" name="telephone_buy_fast"
																class="keyword input-text">
															<button type="submit"
																class="button-buy-fast button">Gửi</button>
												...
												<input type="hidden" name="record_alias" id="record_alias"
													value="dong-trung-ha-thao-tay-tang-cao-cap-hop-100gr">
												<input type="hidden" name="record_id" id="record_id" value="195">
												<input type="hidden" name="table_name" id="table_name"
													value="dtht_nguyen_con_tay_tang">
							...
							<div class="frame_b_l background-sample" style="background-color:#220A00">
								<div class="container">
									...
									<div class="product_tab_content product_tab_mee" id="tabs">
										<ul class="tab-title cls">
											<li class="cat-title-main active cat_mainn" id="scrollToBox2"><a
													href="#tab_war">Thông tin sản phẩm</a></li>
											<li class="cat-title-main cat_mainn" id="scrollToBox0"><a
													href="#prodetails_tab1">Mô tả sản phẩm</a></li>

											<li class="cat-title-main cat_mainn" id="scrollToBox5"><a
													href="#prodetails_tab60">Ảnh chi tiết</a></li>
											<li class="cat-title-main cat_mainn" id="scrollToBox3"><a
													href="#prodetails_tab30"> Bình luận</a></li>
											<li class="cat-title-main cat_mainn" id="scrollToBox4"><a
													href="#prodetails_tab50">Sản phẩm liên quan</a></li>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													...
													<div class="modal-title"><span>Đặt hàng ngay - thông tin đặt
															hàng</span></div>
												</div>
												<div class="modal-body">
													<form action="" name="eshopcart_info" method="post"
														id="eshopcart_info">
														<div class="row cls">
																...
																<div class="media-box">
																	...
																	<div class="media-body">
																		...
																		<div>
																			...
																			<input class="quantity_modal" type="text"
															...
															<div class=" col-modal-r">
																<div class="input_text_wrap">
																	<input type="text" name="sender_name"
																		id="sender_name" placeholder="Họ và tên"
																		value="" class="input_text">
																</div>
																<div class="input_text_wrap">
																	<input type="text" name="sender_telephone"
																		id="sender_telephone" placeholder="Điện thoại"
																		value="" class="input_text">
																</div>
																<div class="input_text_wrap">
																	<input type="text" name="sender_address"
																		id="sender_address" placeholder="Địa chỉ"
																		value="" class="input_text">
																</div>

																<select class="input_text" name="city_receiver">
																	<option value="0" data-price="0"
																		data-type="species">Tỉnh/TP nhận hàng</option>
																...
																<select class="input_text" name="method_receiver">
																	<option value="0" data-price="0"
																		data-type="species">Hình thức nhận hàng</option>
																	<option value="shop">Thanh toán trực tiếp tại cửa
																		hàng</option>
																...
																<div class="btn_area">
																	<a rel="nofollow" class="btn btn-default"
																		href="javascript: void(0)" id="submitbt">
																		<span>Đặt hàng</span>
																	</a>
																	<a rel="nofollow" class="btn reset-default"
																		href="javascript: void(0)" id="resetbt">
																		<span>Nhập lại</span>
																	</a>
																</div>

																<input type="hidden" name="id" value="195">
																<input type="hidden" name="price" value="83000000">
																<input type="hidden" name="price_old" value="83000000">
																<input type="hidden" name="module" value="products">
																<input type="hidden" name="view" value="cart">
																<input type="hidden" name="task" value="eshopcart2_save"
																	id="task">
															</div>
															<div class="clear"></div>
															<div class="other_info">
																<div class="check-square mt10">Nhận giao hàng trong
																	<strong>60 phút</strong> tại <strong>TP.Hà Nội và
																		TP.HCM</strong> </div>
																<div class="check-square mt10">Giao hàng <strong>tận
																		nơi</strong>, hài lòng thanh toán</div>
																<div class="check-square mt10">Bảo hành
																	<strong></strong></div>
																<div class="mt10">Mọi thắc mắc xin vui lòng liên hệ theo
																	số máy <strong style="color: #E31010;">
																		0966606169</strong> để biết thêm chi tiết.</div>
															</div>
														</div>
									...
									<input type="hidden" value="83000000" id="basic_price">
									<input type="hidden" value="195" name="product_id" id="product_id">
								</div>
							</div>
							<div class="clear"></div>
							...
							<div class="frame_b_l background-sample" id="prodetails_tab1"
								style="background-color:#220A00">
								<div class="container">
									<div class="cat-title-main"><span class="title_main"><span class="des">Mô tả sản
												phẩm</span></span></div>
									<div class="tab_content_right">
										...
										<div class="description boxdesc" id="boxdesc">
											<div id="box_conten_linfo">
												<div class="box_conten_linfo_inner" itemprop="description">
													...
													<p style="text-align:justify">Một số hình ảnh sản phẩm chi tiết của
														sản phẩm <a
															href="dongtrungtaytang.php-cao-cap-hop-100gr/">Đông
											...
											<div class="readmore " id="readmore_desc"><span class="closed">Xem
													thêm</span></div>
											<div class="readmore hide" id="readany_desc"><span class="closed">Ẩn bớt
												</span></div>
								...
								<div class="container">
									...
									<div id="prodetails_tab30" class="prodetails_tab">
										<div class="tab_content_right">
											...
											<div class="cat-title-main cat_main_cmt" id="tab-title-label">
												<span class="title_main"><span class="des">Đánh giá - Bình
														luận</span></span>
											...
											<div class="comments">
												...
												<form method="post" class="comment_keyword_wrapper"
													...
													<input type="text" id="comment_keyword" name="comment_keyword"
														placeholder="Tìm theo nội dung, người gửi...">
													<button type="submit" class="button-search button">
														<svg aria-hidden="true" data-prefix="far" data-icon="search"
															role="img" xmlns="http://www.w3.org/2000/svg"
															viewBox="0 0 512 512"
													...
													<div class="_contents">
														<div class="_item -1 _level_0 _sub_0">
															<article itemprop="review" itemscope=""
																...
																<p class="clearfix cls _name_popup" itemprop="author"
																	itemtype="http://schema.org/Person"><span
																		class="_avatar"><svg width="15px" height="15px"
																		...
																		</svg></span><span class="_name"
																		itemprop="name">Quản trị viên</span><span
																		class="_level">Quản trị viên</span></p>
																<div class="_wrap">
																	<p class="_content " itemprop="description"> Xin
																		chào quý khách. Quý khách hãy để lại bình luận,
																		chúng tôi sẽ phản hồi sớm</p>
																	<div class="_control "><time
																			itemprop="datePublished"
																			content="2020-06-19 07:15"
																			datetime="2020-06-19 07:15"
																			title="2020-06-19 07:15">3 năm trước</time>
																	</div>
																	<div class="reply_area hide">
																		<form action="javascript:void(0);" method="post"
																			name="comment_reply_form_-1"
																			id="comment_reply_form_-1"
																			class="form_comment cls"
																			onsubmit="javascript: submit_reply(-1);return false;">
																			<div class="_textarea"><textarea
																					texid="txt_content_-1"
																					id="cmt_content_-1"
																					class="cmt_content" name="content"
																			...
																			<div class="wrap_r cls">
																				...
																				<div id="feedsImageBase_-1"
																					class="feedsImageBase"></div>
																				<div class="wrap_submit mbl">
																					<div class="wrapper_imagevideo">
																						<div class="imagevideo">
																							<input type="file"
																								class="upload-media"
																								onchange="UploadMedia(-1)"
																								id="multiFiles_-1"
																								name="files_cmt[]"
																								multiple="multiple">
																							<label for="multiFiles_-1"
																								id="label_up_cmt">Chèn
																								ảnh</label>
																							<div
																								id="fileQueueImageBase_-1">
																							</div>
																						</div>
																						<div class="imagevideo">

																							<a href="javascript:void(0)"
																								onclick="showOn(-1)">Chèn
																								video</a>
																							<div
																								id="fileSuccessBaseVideo_-1">
																							</div>
																						</div>
																					</div>
																					<div class="pull-right clearfix">
																						<input type="submit"
																							class="_btn_comment"
																							value="Gửi bình luận"></div>
																				</div>
																			</div><!-- .wrap_r -->
																			<div class="popup_addvideo hide"
																				id="popup_addvideo_-1">
																				<div class="row">
																					<div class="main_rows">
																						...
																						<div id="fileQueueVideoBase_-1">
																						</div>
																						<div class="align_item">
																							<a href="javascript:void(0)"
																								class="item"
																								id="send_videos"
																								onclick="return fileUploadVideo(-1)">
																								Gửi đi
																							</a>
																			...
																			</div><input type="hidden" value="products"
																				name="module" id="_cmt_module_-1"><input
																				type="hidden" value="product"
																				name="view" id="_cmt_view_-1"><input
																				type="hidden" value="products"
																				name="type" id="_cmt_type_-1"><input
																				type="hidden" value="save_reply"
																				name="task"><input type="hidden"
																				value="-1" name="parent_id"
																				id="parent_id_-1"><input type="hidden"
																				value="" name="record_id"
																				id="_cmt_record_id_-1"><input
																				type="hidden" value="" name="return"
																				id="_cmt_return_-1"><input type="hidden"
																				value="/index.php?module=comments&amp;view=comments&amp;type=products&amp;task=save_reply&amp;raw=1"
																				name="return" id="link_reply_form_-1">
																		</form>
																	</div>
																</div>
															</article>
												...
												<form action="javascript:void(0);" method="post" name="comment_add_form"
													id="comment_add_form" class="form_comment cls"
													onsubmit="javascript: submit_comment();return false;"
													...
													<div class="rating_area cls">
														<span id="ratings" class="cls">
															...
															<input type="hidden" name="rating_disable"
																id="rating_disable" value="0">
													...
													<div class="_textarea cls" id="key_up_one">
														<textarea name="content" id="cmt_content"
															placeholder="Viết bình luận của bạn(Tối thiểu 50 ký tự)"
															onkeyup="countTxtRating(0)"></textarea>
													...
													<div class="wrap_r cls" id="load_cmtt">
														...
														<div class="wrap_loginpost">
															<aside class="_right">
																<div>
																	<input class="txt_input" required="" name="name"
																		type="text" placeholder="Họ tên (*)"
																		id="cmt_name" autocomplete="off" value="">
																</div>
																<div>
																	<input class="txt_input" required="" name="phone"
																		type="text" placeholder="Số điện thoại (*)"
																		id="cmt_phone" autocomplete="off" value="">
																</div>
																<div>
																	<input class="txt_input" name="email" type="email"
																		placeholder="Email" id="cmt_email" value="">
																</div>
														...
														<div class="wrap_submit mbl">
															...
															<div class="wrapper_imagevideo">
																<div class="imagevideo">
																	...
																	<label for="multiFiles" id="label_up_cmt">Chèn
																		ảnh</label>
																	<div id="fileQueueImageBase"></div>
																</div>
																<div class="imagevideo">

																	<a href="javascript:void(0)" onclick="showUp()">Chèn
																		video</a>
															...
															<div class="pull-right clearfix">
																<input type="submit" class="_btn_comment"
																	value="Gửi bình luận" id="submit_bbt">
															</div>
														</div>
													</div>
													...
													<div class="popup_addvideo hide">
														<div class="row">
															<div class="main_rows">
																<div class="close_form">
																	<a href="javascript:void(0)" class="close-off"
																		onclick="closeUp()">
																...
																<div class="form-group">
																	...
																	<div class="col-md-10 col-xs-12">
																		<input type="text" class="form-control"
																			name="title" id="title_upvideo" value=""
																			size="60" placeholder="Tiêu đề (*)">
																	</div>
																</div>
																<div class="form-group">
													...
													<input type="hidden" value="195" name="record_id" id="record_id">
													<input type="hidden" value="products" name="_cmt_module"
														id="_cmt_module">
													<input type="hidden" value="product" name="_cmt_view"
														id="_cmt_view">
													<input type="hidden" value="save_comment" name="task">
													<input type="hidden" value="195" name="record_id"
														id="_cmt_record_id">
													<input type="hidden"
														value="YWRkfHIxbGZncGt2Nzh0cW00azFhbjZodTJkZmNl"
														id="_session_upload">
													<input type="hidden" name="linkurlall" id="linkurlall"
														value="dongtrungtaytang.php-cao-cap-hop-100gr/">
													<input type="hidden" value="" name="return" id="_cmt_return">
													<input type="hidden"
														value="/index.php?module=comments&amp;view=comments&amp;type=products&amp;task=save_comment&amp;raw=1"
											...
											<div class="fb-comments"
												data-href="http://onplaza.vn/dong-trung-ha-thao-tay-tang-cao-cap-hop-100gr/"
												data-numposts="5" data-width="100%" data-colorscheme="light"
												data-order-by="reverse_time"></div>
											<input type="hidden" value="195" name="data_id" id="data_id">
											<input type="hidden"
												value="aHR0cDovL29ucGxhemEudm4vZG9uZy10cnVuZy1oYS10aGFvLXRheS10YW5nLWNhby1jYXAtaG9wLTEwMGdyLw=="
												name="data_url" id="data_url">
										</div>
									</div>
									<div id="prodetails_tab300" class="prodetails_tab">


										<div class="cat-title-main"><span class="title_main"><span class="des">Sản phẩm
													đã xem</span></span></div>
										<div class="product_related_mb clearfix">
											<div class="product_grid product_grid_cat cls">

												<div class="item  field_area_0">
										...
										<div class="readmore " id="readmore_desc3" style="display: none;"><span
									...
									<div id="prodetails_tab50" class="prodetails_tab">
										...
										<div class="products-list-related">
											<div class="cat-title-main"><span class="title_main"><span class="des">Sản
														phẩm liên quan</span></span></div>
											...
											<div class="product_grid product_grid_cat">
													...
													<div class="frame_inner">
														...
														<div class="name">
															...
															<a style="color:#fff"
																...
																title="Đông trùng hạ thảo Tây Tạng hộp 5g - D001 (D400-5V1)"
																class="name">
																Đông trùng hạ thảo Tây Tạng hộp 5g - D001 (D400-5V1)
															</a>
														</div>
													...
													<div class="frame_inner">
														...
														<div class="name">
															...
															<a style="color:#fff"
																...
																title="Đông trùng hạ thảo Tây Tạng nguyên con đặc biệt 5g/hộp D004 (D300-5V1)"
																class="name">
																Đông trùng hạ thảo Tây Tạng nguyên con đặc biệt 5g/hộp
																D004 (D300-5V1) </a>
														</div>
													...
													<div class="frame_inner">
														...
														<div class="name">
															...
															<a style="color:#fff"
																...
																title="Đông trùng hạ thảo Tây Tạng nguyên con cao cấp hộp 1gr"
																class="name">
																Đông trùng hạ thảo Tây Tạng nguyên con cao cấp hộp 1gr
															</a>
														</div>
												...
												<div class="item">
													<div class="frame_inner">
														...
														<div class="price_arae">
															<span class="price_current"
																style="color:#FFE2B8">29.000.000₫</span>
														</div>
													...
													<div class="frame_inner">
														...
														<div class="name">
															...
															<a style="color:#fff"
																...
																title="Đông trùng hạ thảo khô nguyên con đặc biệt loại 10g/hộp D005 (D300-10V1)"
																class="name">
																Đông trùng hạ thảo khô nguyên con đặc biệt loại 10g/hộp
																D005 (D300-10V1) </a>
														</div>

														<div class="price_arae">
															<span class="price_current"
																style="color:#FFE2B8">16.000.000₫</span>
														</div>
												...
												<div class="item">
													<div class="frame_inner">
														...
														<div class="price_arae">
															<span class="price_current"
																style="color:#FFE2B8">11.500.000₫</span>
														</div>
										...
										<div class="item-related cls">
											<a class="img_a" target="_blank"
												...
												<img class="lazy after-lazy"
													...
													srcset="https://onplaza.vn/images/news/2020/11/20/resized/dong-trung-ha-thao_1605856786.jpg.webp"
										...
										<div class="item-related cls">
											<a class="img_a" target="_blank"
												...
												<img class="lazy after-lazy"
													...
													srcset="https://onplaza.vn/images/news/2020/11/24/resized/phan-biet-dong-trung-ha-thao-that-gia_1606208746.jpg.webp"
													style="display: inline;"> </a>
										...
										<div class="item-related cls">
											<a class="img_a" target="_blank"
												...
												<img class="lazy after-lazy"
													...
													srcset="https://onplaza.vn/images/news/2020/12/03/resized/dong-trung-ha-thao-trung-quoc_1606985887.jpg.webp"
													style="display: inline;"> </a>

											<div class="title-item-related"><a
													href="https://onplaza.vn/tin-tuc-dong-trung/dong-trung-ha-thao-trung-quoc-n63.html"
													title="Đông trùng hạ thảo Trung Quốc: Phân loại và tác dụng"
													target="_blank">Đông trùng hạ thảo Trung Quốc: Phân loại và tác
													dụng</a></div>
										</div>
										<div class="item-related cls">
											<a class="img_a" target="_blank"
												...
												<img class="lazy after-lazy"
													...
													srcset="https://onplaza.vn/images/news/2020/11/20/resized/cach-dung-dong-trung-ha-thao_1605864308.jpg.webp"
													style="display: inline;"> </a>
	...
	L90.547,145.583z"></path>
					...
					<div class="footer_im cls">
						...
						<div class="image_wrapper">
							<a href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=dongtrungtaytang.php-cao-cap-hop-100gr/"
							...
							<a href="http://online.gov.vn/Home/WebDetails/18258?refurl=dongtrungtaytang.php-cao-cap-hop-100gr/"
...
//]]></script>
		...
		<div class="benmarch noc">0.31201 sec| 1933.789 kb</div>
		<script async="async" language="javascript" type="text/javascript"
			src="https://onplaza.vn/cache/js/2c660b165256a1ddac9a234c68ea498d.js?20230704230953"></script>
	</div>
	<script type="text/javascript"
	...
	<div
		...
		<div style="z-index: 2000000000; position: relative;"><iframe
				...
				name="c-3jequqth0g6j" frameborder="0" scrolling="no"
