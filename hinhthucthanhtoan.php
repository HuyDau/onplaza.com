...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
	...
	<meta name="description"
		content="Hình thức thanh toán trực tiếp bằng tiền mặt được áp dụng đối với những khách hàng thực hiện mua hàng trực tiếp tại các cửa hàng thuộc hệ thông của công ty Onplaza Việt Pháp,">
...
<body style="">
				...
				<div class="website_login" id="login-now" style="display: block;">
					<form action="https://onplaza.vn/index.php?module=users" name="login_form" class="login_form"
						...
						<div class="clear"></div> <input type="hidden" name="return"
							value="L2N0LWhpbmgtdGh1Yy10aGFuaC10b2FuLmh0bWw="> <input type="hidden" name="module"
							value="users"> <input type="hidden" name="view" value="users"> <input type="hidden"
							name="task" value="login_save"> <input type="hidden" name="Itemid" value="8">
					</form>
					...
					<div class="box-register">
						<form action="https://onplaza.vn/index.php?module=users" name="register_form"
							...
							<div class="form-login">
								...
								<div class="clear"></div>
							</div> <input type="hidden" name="return" value="L2N0LWhpbmgtdGh1Yy10aGFuaC10b2FuLmh0bWw=">
							<input type="hidden" name="module" value="users"> <input type="hidden" name="view"
								value="users"> <input type="hidden" name="Itemid" value="8"> <input type="hidden"
		...
		<div class="tab_reset_pass hide">
			...
			<div class="divforget">
				<form action="https://onplaza.vn/index.php?module=users" name="forget_form" class="forget_form"
					...
					</div> <input type="hidden" name="return" value="L2N0LWhpbmgtdGh1Yy10aGFuaC10b2FuLmh0bWw="> <input
	...
	<div class="header_wraper cls">
						...
						<ul class="breadcrumb" itemscope="itemscope" itemtype="https://schema.org/BreadcrumbList">
							<li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope"
								itemtype="http://schema.org/ListItem"> <a
									title="Onplaza Việt Pháp - Thế Giới dinh dưỡng" href="https://onplaza.vn/"
									itemprop="item"> <span itemprop="name">Home</span>
									<meta content="1" itemprop="position">
								</a> </li>
							<li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope"
								itemtype="http://schema.org/ListItem"> <a title="Hình thức thanh toán"
									href="https://onplaza.vn/ct-hinh-thuc-thanh-toan.html" itemprop="item"> <span
										itemprop="name">Hình thức thanh toán</span>
					...
					<div class="main-area main-area-1col main-area-full">
						<div class="menu_content cls">
							<ul>
								...
								<li class=" item"> <a href="https://onplaza.vn/ct-dieu-khoan-mua-hang.html"
										title="Điều khoản mua hàng">Điều khoản mua hàng</a> </li>
								<li class=" item"> <a href="https://onplaza.vn/ct-hinh-thuc-van-chuyen.html"
										title="Hình thức vận chuyển">Hình thức vận chuyển</a> </li>
								<li class=" item"> <a href="chinhsachbaomat.php" title="Chính sách bảo mật">Chính sách
										bảo mật</a> </li>
								<li class="actived item"> <a href="https://onplaza.vn/ct-hinh-thuc-thanh-toan.html"
										title="Hình thức thanh toán">Hình thức thanh toán</a> </li>
								<li class=" item"> <a href="https://onplaza.vn/ct-chinh-sach-doi-tra.html"
										title="Chính sách đổi trả">Chính sách đổi trả</a> </li>
							</ul>
						</div>
						<div class="content_detail">
							<div class="wapper-content-page">
								<h1 class="content_title"> <span>Hình thức thanh toán</span> </h1>
								<!-- end CONTENT NAME-->
								<!-- SUMMARY -->
								<div class="summary"></div>
								<div class="description">
									<p>Thanh toán đơn hàng là một trong những bước cần làm để việc đặt mua hàng được
										hoàn thành. Khách hàng thường thắc mắc công ty Onplaza Việt Pháp cung cấp những
										hình thức thanh toán nào. Trong bài viết dưới đây, chúng tôi xin giới thiệu tới
										quý khách hàng các hình thức thanh toán mà công ty áp dụng. Để khách hàng có
										được sự đa dạng, phong phú trong công việc thanh toán, công ty Onplaza Việt Pháp
										đưa ra các phương thức thanh toán dưới đây:</p>
									<h2><span style="font-size:20px"><strong>Hình thức thanh toán trực tiếp tại hệ thông
												cửa hàng của công ty.</strong></span></h2>
									<p>Hình thức thanh toán trực tiếp bằng tiền mặt được áp dụng đối với những khách
										hàng thực hiện mua hàng trực tiếp tại các cửa hàng thuộc hệ thông của công ty
										Onplaza Việt Pháp. Đây là hình thức thanh toán khá tiện lợi và nhanh chóng.
										Ngoài ra, khi mua hàng trực tiếp khách hàng có thể quẹt thẻ ATM nội địa hoặc thẻ
										tín dụng để thanh toán các sản phẩm đã chọn mua.</p>
									<h2><strong><span style="font-size:20px">Thanh toán khi nhận hàng (áp dụng với đơn
												hàng được đặt online qua website/email hoặc được đặt qua tổng
												đài).</span></strong></h2>
									<p>Đối với những đơn hàng được đặt qua mạng, khách hàng cung cấp cho chúng tôi đầy
										đủ các thông tin như địa chỉ email, số điện thoại, địa chỉ, quý danh,… để có thể
										nhận và thanh toán đơn hàng khi nhân viên vận chuyển giao hàng.</p>
									<p>Quý khách lưu ý, khi yêu cầu thanh toán tại các địa chỉ cho trước, quý khách vui
										lòng điền đầy đủ tất cả các thông tin cần thiết để đơn hàng được giao tới theo
										đúng như thời gian giao hẹn. Nếu như khách hàng phát ra bất cứ lỗi nào trong các
										thông tin này, quý khách vui lòng thông báo lại cho chúng tôi để được hỗ trợ kịp
										thời.</p>
									<h2><span style="font-size:20px"><strong>Chuyển khoản qua tài khoản ngân hàng để
												thanh toán đơn hàng.</strong></span></h2>
									<p>Những đơn hàng được yêu cầu đặt mua qua website, qua số điện thoại hoặc địa chỉ
										email của công ty Onplaza có thể thực hiện thanh toán qua tài khoản ngân
										hàng.&nbsp;</p>
									<p>Vui lòng gọi điện&nbsp;tel:0932.144.888 để nhận thông tin số tài khoản</p>
									<p>Đây là phương thức thanh toán nhanh gọn và thuận tiện, giúp khách hàng không phải
										mất thời gian đi lại. Sau khi nhận được khoản thanh toán, các nhân viên của công
										ty sẽ thông báo cho quý khách hàng về lịch trình vận chuyển đơn hàng để khách
										hàng có thể sắp xếp và nhận được hàng nhanh nhất có thể.</p>
									<p>Khách hàng có địa chỉ tại Hà Nội và thành phố Hồ Chí Minh có thể nhận được hàng
										trong ngày theo thời gian được yêu cầu. Ngoài ra, các khách hàng có địa chỉ tại
										các tỉnh thành khác trên toàn quốc có thể nhận hàng trong vòng từ 3 đến 4 ngày.
									</p>
								</div>
							</div>
						</div>
				...
				<footer>
					...
					<div class="footer_im cls">
						<div class="image_wrapper"> <a
								href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=https://onplaza.vn/ct-hinh-thuc-thanh-toan.html"
							...
							<script src="https://images.dmca.com/Badges/DMCABadgeHelper.min.js"> </script> <a
								href="http://online.gov.vn/Home/WebDetails/18258?refurl=https://onplaza.vn/ct-hinh-thuc-thanh-toan.html"
		...
		<script async="async" language="javascript" type="text/javascript"
			src="https://onplaza.vn/cache/js/55f142eedda62419413fb85343542881.js?20230704182341"></script>
	</div>
