            ...
            <div class="register right_item">
                ...
                <div class="share_fast1">
                    ...
                    <div class="fb share_item">
                        <a class="facebook-icon" href="https://www.facebook.com/congtyonplazavietphap"
                                    ...
                                    <div id="ivzm" class="cell"><img id="ipu9v" src="assets/img/img/danhmucsanpham.png">
                                        <div id="iwh99" class="row">
                                            ...
                                            <div id="inlj" class="cell card"><a href="namlinhchihanquoc.php" id="intmp"
                                                    title="Nấm linh chi"><img src="assets/img/cat/cat2.png"
                                                        id="ip7w2"></a></div>
                                            <div id="iwqnz" class="cell card"><a href="yensaokhanhhoa.php" id="iwwj7"
                                                    title="Yến xào"><img src="assets/img/cat/cat3.png" id="imc5f"></a>
                                            </div>
                                            <div id="is4k2" class="cell card"><a href="nhunghuou.php" id="iz6w7"
                                                    title="Nhung hươu"><img src="assets/img/cat/cat4.png"
                                                        id="idzd2"></a></div>
                                            <div id="i4icf" class="cell card card_none"><a href="ancungnguu.php"
                                                    id="ik4jc" title="An cung ngưu"><img src="assets/img/cat/cat5.png"
                                                        id="iyca3"></a></div>
                                        </div>
                                        <div id="i16j" class="row hide_mobile">
                                            ...
                                            <div id="il7rb" class="cell card2"><a title="" href="dongtrunghathao.php"
                                                    id="i5ecg"><img src="assets/img/cat/cat7.png" id="iea3t"></a></div>
                                            <div id="i9h4f" class="cell card2"><a title="" href="yensaokhanhhoa.php"
                                                    id="i1jpv"><img src="assets/img/cat/cat8.png" id="imi8i"></a></div>
                                            <div id="i9exn" class="cell card2"><a title="" href="samngoclinh.php"
                                                    id="ia0sl"><img src="assets/img/cat/cat9.png" id="iu7ib"></a></div>
                                            <div id="io5j3" class="cell card2"><a title="" href="nhunghuou.php"
                                                    id="i8w1r"><img src="assets/img/cat/cat10.png" id="ih2cr"></a></div>
                                            <div id="i641n" class="cell card2"><a title="" href="ancungnguu.php"
                                                    id="i3yka"><img src="assets/img/cat/cat11.png" id="iyh3z"></a></div>
                                            <div id="itaeg" class="cell card2"><a title="" href="matongnguyenchat.php"
                                                    id="itl27"><img src="assets/img/cat/cat12.png" id="ismk1"></a></div>
                                            <div id="ifo7g" class="cell card2"><a title="" href="namlinhchihanquoc.php"
                                                    id="i569z"><img src="assets/img/cat/cat13.png" id="iozwv"></a></div>
                                            <div id="i6pcx" class="cell card2"><a title="" href="ruousamngoclinh.php"
                                                    id="iclbk"><img src="assets/img/cat/cat14.png" id="if88k"></a></div>
                                            <div id="if50k" class="cell card2 card2_none"><a title=""
                                                    href="ancungnguu.php" id="in09x"><img src="assets/img/cat/cat15.png"
                                                        id="i2pyq"></a></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="wapper-content-page product_home_content" id="products-cat">
                            <div class="banner_home menu_sticky banner_39 sticky_1">
                                <a href="dongtrunghathao.php" title="Giá đông trùng hạ thảo">
                                    <img class="lazy after-lazy" alt="Giá đông trùng hạ thảo"
                                        src="assets/img/banner/banner2.png" srcset="assets/img/banner/banner2.png"
                                        style="display: inline;">
                                </a>
                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="product_ajj">
                                        <div class="products_home_slideshow" id="products_home_slideshow_39">
                                            ...
                                            <?php
                                            $dongtrung = mysqli_query($conn, "SELECT * FROM `product` INNER JOIN portfolio ON product.id_portfolio = portfolio.id_portfolio WHERE id_category = 2 LIMIT 6");
                            ...
                            <div class="banner_home menu_sticky banner_42 sticky_2">
                                <a href="nhansamhanquoc.php" title="Sâm Hàn Quốc">
                                    <img class="lazy after-lazy" alt="Sâm Hàn Quốc" src="assets/img/banner/banner3.png"
                                        srcset="assets/img/banner/banner3.png" style="display: inline;">
                                </a>
                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="product_ajj">
                                        <div class="products_home_slideshow" id="products_home_slideshow_42">
                                            <!--	EACH Product	Sâm Hàn Quốc			-->
                                            <?php
                                            $sam = mysqli_query($conn, "SELECT * FROM `product` INNER JOIN portfolio ON product.id_portfolio = portfolio.id_portfolio WHERE id_category = 1 LIMIT 6");
                                            foreach ($sam as $item_sam) {
                                            ?>
                                            <div class="item">
                                                <div class="frame_inner">
                                                    <figure class="product_image ">
                                                        ...
                                                        <a href="sanpham.php?id=<?=$item_sam['id_product']?>"
                                                            ...
                                                            <img class="lazy after-lazy"
                                                                alt="<?= $item_sam['name_product'] ?>"
                                                                src="uploads/products/<?= $item_sam['image_product'] ?>"
                                                                srcset="uploads/products/<?= $item_sam['image_product'] ?>"
                                                                style="display: inline;"> </a>
                                                    ...
                                                    <div class="price_arae">
                                                        ...
                                                        <span class="price_current"
                                                            style="color:#FFE1B8"><?= number_format($item_sam['price']) ?>₫</span>
                                                        <span class="price_old " style="color:#FFE1B8">
                                                            <span
                                                                class="item_old"><?= number_format($item_sam['price1'], 0, ",", ".") ?>₫
                                                            </span>
                                                        </span>
                            ...
                            <div class="banner_home menu_sticky banner_4 sticky_3">
                                <a href="yensaokhanhhoa.php" title="Yến sào Khánh Hoà">
                                    <img class="lazy after-lazy" alt="Yến sào Khánh Hoà"
                                        src="assets/img/banner/banner4.png" srcset="assets/img/banner/banner4.png"
                                        style="display: inline;">
                                </a>
                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="product_ajj">
                                        <div class="products_home_slideshow" id="products_home_slideshow_4">
                                            <!--	EACH Product	Yến sào Khánh Hòa			-->
                                            <?php
                                            $yen = mysqli_query($conn, "SELECT * FROM `product` INNER JOIN portfolio ON product.id_portfolio = portfolio.id_portfolio WHERE id_category = 4 LIMIT 6");
                                            foreach ($yen as $item_yen) {
                                            ?>
                                            <div class="item">
                                                <div class="frame_inner">
                                                    <figure class="product_image ">
                                                        ...
                                                        <a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-100g-y014/"
                                                            title="<?= $item_yen['name_product'] ?>">

                                                            <img class="lazy after-lazy"
                                                                alt="<?= $item_yen['name_product'] ?>"
                                                                src="uploads/products/<?= $item_yen['image_product'] ?>"
                                                                srcset="uploads/products/<?= $item_yen['image_product'] ?>"
                                                                style="display: inline;"> </a>
                                                    ...
                                                    <div class="name">
                                                        ...
                                                        <a style="color:#fff"
                                                            ...
                                                            title="<?= $item_yen['name_product'] ?>" class="name">
                                                            <?= $item_yen['name_product'] ?></a>
                                                    </div>

                                                    <div class="price_arae">

                                                        <span class="price_current"
                                                            style="color:#ffe1b8"><?= number_format($item_yen['price'], 0, ".", "") ?>₫</span>
                                                        <span class="price_old " style="color:#ffe1b8">
                                                            <span
                                                                class="item_old"><?= number_format($item_yen['price1'], 0, ".", "") ?>₫
                                                            </span>
                                                        </span>
                            ...
                            <div class="banner_home menu_sticky banner_36 sticky_4">
                                <a href="https://onplaza.vn/gia-nam-linh-chi" title="Giá nấm linh chi Hàn Quốc">
                                    <img class="lazy after-lazy" alt="Giá nấm linh chi Hàn Quốc"
                                        src="assets/img/banner/banner5.png" srcset="assets/img/banner/banner5.png"
                                        style="display: inline;">
                                </a>
                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="product_ajj">
                                        <div class="products_home_slideshow" id="products_home_slideshow_36">
                                            ...
                                            <?php
                                            $nam = mysqli_query($conn, "SELECT * FROM `product` INNER JOIN portfolio ON product.id_portfolio = portfolio.id_portfolio WHERE id_category = 3 LIMIT 6");
                                            foreach ($nam as $item_nam) {
                                            ?>
                                            <div class="item">
                                                <div class="frame_inner">
                                                    <figure class="product_image ">
                                                        ...
                                                        <a href="namlinhchivang.php-thuong-hang-dac-biet-dang-tui-l038/"
                                                            title="<?=$item_nam['name_product']?>">

                                                            <img class="lazy after-lazy"
                                                                alt="<?=$item_nam['name_product']?>"
                                                                src="uploads/products/<?=$item_nam['image_product']?>"
                                                                srcset="uploads/products/<?=$item_nam['image_product']?>"
                                                                style="display: inline;"> </a>
                                                    ...
                                                    <div class="name">
                                                        ...
                                                        <a style="color:#FFFFFF"
                                                            ...
                                                            title="<?=$item_nam['name_product']?>" class="name">
                                                            <?=$item_nam['name_product']?> </a>
                                                    </div>

                                                    <div class="price_arae">

                                                        <span class="price_current"
                                                            style="color:#FFE1B8"><?=number_format($item_nam['price'], 0, ".", "")?>₫</span>
                                                        <span class="price_old " style="color:#FFE1B8">
                                                            <span
                                                                class="item_old"><?=number_format($item_nam['price1'], 0, ".", "")?>₫
                                                            </span>
                                                        </span>
                            ...
                            <div class="banner_home menu_sticky banner_48 sticky_5">
                                <a href="nhunghuou.php" title="Giá nhung hươu">
                                    <img class="lazy after-lazy" alt="Giá nhung hươu"
                                        src="assets/img/banner/banner6.png" srcset="assets/img/banner/banner6.png"
                                        style="display: inline;">
                                </a>
                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="product_ajj">
                                        <div class="products_home_slideshow" id="products_home_slideshow_48">
                                            ...
                                            <?php
                                                $nhunghuou = mysqli_query($conn,"SELECT * FROM `product` INNER JOIN portfolio ON product.id_portfolio = portfolio.id_portfolio WHERE id_category = 5 LIMIT 6");
                                                foreach($nhunghuou as $item_nhunghuou){
                                                    ?>
                                            <div class="item">
                                                <div class="frame_inner">
                                                    <figure class="product_image ">
                                                        ...
                                                        <a href="nhunghuoutuoi.php-hoang-da-san-ban-nh009/"
                                                            title="<?=$item_nhunghuou['name_product']?>">

                                                            <img class="lazy after-lazy"
                                                                alt="<?=$item_nhunghuou['name_product']?>"
                                                                src="uploads/products/<?=$item_nhunghuou['image_product']?>"
                                                                srcset="uploads/products/<?=$item_nhunghuou['image_product']?>"
                                                                style="display: inline;"> </a>
                                                    ...
                                                    <div class="name">
                                                        ...
                                                        <a style="color:#FFFFFF"
                                                            ...
                                                            title="<?=$item_nhunghuou['name_product']?>" class="name">
                                                            <?=$item_nhunghuou['name_product']?> </a>
                                                    </div>

                                                    <div class="price_arae">

                                                        <span class="price_current"
                                                            style="color:#FFE1B8"><?= number_format($item_nhunghuou['price'],0,".","")?>₫</span>
                                                        <span class="price_old " style="color:#FFE1B8">
                                                            <span
                                                                class="item_old"><?= number_format($item_nhunghuou['price1'],0,".","")?>₫
                                                            </span>
                                                        </span>
                    ...
                    <div class="block_banners banners-_banner banners_2 block" id="block_id_143">
                        ...
                        <div class="container">
                            <div id="banner_sale"
                                ...
                                <div class="wrap_item">
                                    <div class="item">
                                        <a rel="nofollow" href="nhansamhanquoc.php" title="Nhân sâm" id="banner_item_93"
                                            class="banner_item">
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="nhunghuou.php" title="Nhung hươu" id="banner_item_99"
                                            class="banner_item">
                                            <span class="wrapper_ap">
                                ...
                                <div class="wrap_item">
                                    <div class="item">
                                        <a rel="nofollow" href="yensaokhanhhoa.php" title="Nước yến" id="banner_item_97"
                                            class="banner_item">
                                            <span class="wrapper_ap">
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="dongtrunghathao.php" title="Đông trùng hạ thảo"
                                            id="banner_item_95" class="banner_item">
                                            <span class="wrapper_ap">
                                ...
                                <div class="wrap_item">
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="ancungnguuhanquoc.php" title="An cung ngưu"
                                            id="banner_item_94" class="banner_item">
                                            <span class="wrapper_ap">
                    ...
                    <a href="javascript:void(0)" id="sticky_1" title="Giá đông trùng hạ thảo">
                        <span class="icon"><svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="83.000000pt"
                                ...
                                <g transform="translate(0.000000,84.000000) scale(0.100000,-0.100000)" stroke="none">
                                    <path d="M713 829 c-74 -21 -128 -129 -140 -279 -10 -129 -39 -151 -272 -210 -140 -35 -172 -49 -219 -94 -50 -46 -75 -102 -76 -164 -1 -42 3 -57 18 -68 28 -20 41 -18 79 15 30 27 34 28 44 13 9 -14 12 -15 27 -3 9 7 16 22 16 32 0 12 11 24 26 29 29 11 44 6 44 -16 0 -23 30 -16 39 10 15 38 65 50 74 16 7 -28 25 -25 40 7 6 16 16 31 22 35 17 13 45 9 45 -7 0 -28 30 -15 44 20 14 32 46 49 46 25 0 -5 9 -10 20 -10 13 0 22 9 26 28 3 15 14 43 24 62 33 65 52 150 45 206 -10 83 8 130 76 195 50 48 59 62 59 91 0 56 -46 84 -107 67z m65 -65 c2 -16 -10 -32 -42 -59 -76 -62 -91 -95 -92 -202 0 -51 -3 -95 -5 -98 -3 -2 -15 2 -27 11 -16 11 -20 20 -13 32 5 9 12 53 16 97 13 152 65 249 129 243 23 -2 32 -9 34 -24z m-179 -393 c23 -17 23 -21 11