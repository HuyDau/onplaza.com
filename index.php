...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
    ...
    <script type="text/javascript" async="" src="https://www.gstatic.com/recaptcha/releases/khH7Ei3klcvfRI74FvDcfuOo/recaptcha__vi.js" crossorigin="anonymous" integrity="sha384-UL4gpwnwxxxsV0iKJbujQODc2RZ+xFJZbe1zrnAFA+voyVvurFjSZH6kO9Nz+rpI">
    </script>
            ...
            <div class="register right_item">
                ...
                <div class="pc_shopcart">
                    ...
                    <div class="shopcart_simple block_content fl">
                        <div class="count">
                            <a class="buy_img" href="" title="Giỏ hàng thanh toán" rel="nofollow">
                        ...
                        <div id="search" class="search search-contain s_close ">
                            <div class="search-content">
                                <form action="" name="search_form" id="search_form2" method="get" onsubmit="javascript: submit_form_search22();return false;">
                                    ...
                                    <input type="hidden" name="module" id="link_search2" value="">
                                    ...
                                    <div class="highlight1 container cls">
                                        <div class="menu-child_list">
                                            ...
                                            <div class="sub-menu sub-menu-level1 has_child  ">
                                                ...
                                                <div class="wraper_item cls " alt="Dược liệu cao cấp" data-menu_tags="908" data-menu_idt="0" style="background-image: url(); display: block;">
                                                    ...
                                                    <div class="product_item cls">
                                                        ...
                                                        <div class="item cls cat_item2">
                                                            ...
                                                            <ul class="item_lv2">
                                                                ...
                                                                ?>
                                                                    <li><a href="danhsachsanpham.php?id=<?= $item['id_portfolio'] ?>" title="<?= $item['name_portfolio'] ?>">
                                                                            <?= $item['name_portfolio'] ?>
                                                                        </a></li>
                                                                <?php
                                                                }
                                                        ...
                                                        <div class="item cls cat_item2">
                                                            ...
                                                            <ul class="item_lv2">
                                                                <?php
                                                                foreach ($sql_portfolio_dongtrung as $item_dongtrung) {
                                                                ?>
                                                                    <li><a href="danhsachsanpham.php?id=<?=$item_dongtrung['id_portfolio']?>" title="<?=$item_dongtrung['name_portfolio']?>">
                                                                            <?= $item_dongtrung['name_portfolio'] ?>
                                                                        </a></li>
                                                                <?php
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="item cls cat_item2">
                                                            ...
                                                            <ul class="item_lv2">
                                                                <?php
                                                                foreach ($sql_portfolio_nam as $item_namlinhchi) {
                                                                ?>
                                                                    <li><a href="danhsachsanpham.php?id=<?=$item_namlinhchi['id_portfolio']?>" title="<?=$item_namlinhchi['name_portfolio']?>">
                                                                            <?= $item_namlinhchi['name_portfolio'] ?>
                                                                        </a></li>
                                                                <?php
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="item cls cat_item2">
                                                            ...
                                                            <ul class="item_lv2">
                                                                <?php
                                                                foreach ($sql_portfolio_yen as $item_yensao) {
                                                                ?>
                                                                    <li><a href="danhsachsanpham.php?id=<?=$item_yensao['id_portfolio']?>" title="<?= $item_yensao['name_portfolio'] ?>">
                                                                            <?= $item_yensao['name_portfolio'] ?>
                                                                        </a></li>
                                                                <?php
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="item cls cat_item2">
                                                            ...
                                                            <ul class="item_lv2">
                                                                <?php
                                                                foreach ($sql_portfolio_nhunghuou as $item_nhunghuou) {
                                                                ?>
                                                                    <li><a href="danhsachsanpham.php?id=<?=$item_nhunghuou['id_portfolio']?>" title="<?= $item_nhunghuou['name_portfolio'] ?>">
                                                                            <?= $item_nhunghuou['name_portfolio'] ?>
                                                                        </a></li>
                                                                <?php
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="item cls cat_item2">
                                                            ...
                                                            <ul class="item_lv2">
                                                                <?php
                                                                foreach ($sql_portfolio_ancungnguu as $item_ancungnguu) {
                                                                ?>
                                                                    <li><a href="danhsachsanpham.php?id=<?=$item_ancungnguu['id_portfolio']?>" title="<?= $item_ancungnguu['name_portfolio'] ?>">
                                                                            <?= $item_ancungnguu['name_portfolio'] ?>
                                                                        </a></li>
                                                                <?php
                                                                }
                                                                ?>
                    ...
                    <div id="search" class="search search-contain s_close ">
                        <div class="search-content">
                            <form action="" name="search_form" id="search_form_home" method="get" onsubmit="javascript: submit_form_search_home();return false;"> <input type="text" value="" placeholder="Nhập từ khoá tìm kiếm..." id="keyword_home" name="keyword" class="keyword input-text" autocomplete="off"> <button type="submit" class="button-search button_s"> <svg x="0px" y="0px" viewBox="0 0 485.213 485.213" style="enable-background:new 0 0 485.213 485.213;" xml:space="preserve">
                                    ...
                                    </svg> </button> <input type="hidden" name="module" value="news"> <input type="hidden" name="module" id="link_search_home" value=""> <input type="hidden" name="view" value="search"> <input type="hidden" name="Itemid" value="10"> </form>
                        </div>
            ...
            <div id="menu_mb">
                <div class="dcjq-mega-menu-mobile cls">
                    ...
                    <ul id="megamenu3" class="menu mypopup">
                        ...
                        <li class="level_0 sort home "><a class="menu_item_a" href="" title="Onplaza Việt Pháp - Thế Giới dinh dưỡng" rel="home">Trang chủ</a> </li>
                                ...
                                <div id="imce" class="row">
                                    <div id="ivzm" class="cell"><img id="ipu9v" src="assets/img/img/danhmucsanpham.png">
                                        <div id="iwh99" class="row">
                                            ...
                                            <div id="iwqnz" class="cell card"><a href="yensaokhanhhoa.php" id="iwwj7" title="Yến xào"><img src="assets/img/cat/cat3.png" id="imc5f"></a>
                                            </div>
                                                ...
                                                <div class="item">
                                                    <div class="frame_inner">
                                                        <figure class="product_image ">
                                                            ...
                                                            <a href="sanpham.php?id=<?= $item_dongtrung['id_product'] ?>" title="<?= $item_dongtrung['name_product'] ?>">
                                                                <img class="lazy after-lazy" alt="<?= $item_dongtrung['name_product'] ?>" src="uploads/products/<?= $item_dongtrung['image_product'] ?>" srcset="uploads/products/<?= $item_dongtrung['image_product'] ?>" style="display: inline;"> </a>
                                                        </figure>
                                                        <div class="name">

                                                            <a style="color:#FFFFFF" href="sanpham.php?id=<?= $item_dongtrung['id_product'] ?>" title="<?= $item_dongtrung['name_product'] ?>" class="name">
                                                        ...
                                                        <div class="buy_nows">
                                                            <a href="sanpham.php?id=<?= $item_dongtrung['id_product'] ?>" title="Mua sản phẩm <?= $item_dongtrung['name_product'] ?>">
                                                                Mua sản phẩm
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="item">
                                                    <div class="frame_inner">
                                                        <figure class="product_image ">
                                                            ...
                                                            <a href="sanpham.php?id=<?= $item_sam['id_product'] ?>" title="<?= $item_sam['name_product'] ?>">

                                                                <img class="lazy after-lazy" alt="<?= $item_sam['name_product'] ?>" src="uploads/products/<?= $item_sam['image_product'] ?>" srcset="uploads/products/<?= $item_sam['image_product'] ?>" style="display: inline;"> </a>

                                                        </figure>

                                                        <div class="name">

                                                            <a style="color:#FFFFFF" href="sanpham.php?id=<?= $item_sam['id_product'] ?>" title="Sâm tươi Hàn Quốc cao cấp loại 6 củ/kg NS004" class="name">
                                                        ...
                                                        <div class="buy_nows">
                                                            <a href="sanpham.php?id=<?= $item_sam['id_product'] ?>" title="Mua sản phẩm <?= $item_sam['name_product'] ?>">
                                                                Mua sản phẩm
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="item">
                                                    <div class="frame_inner">
                                                        <figure class="product_image ">
                                                            ...
                                                            <a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-100g-y014/" title="<?= $item_yen['name_product'] ?>">

                                                                <img class="lazy after-lazy" alt="<?= $item_yen['name_product'] ?>" src="uploads/products/<?= $item_yen['image_product'] ?>" srcset="uploads/products/<?= $item_yen['image_product'] ?>" style="display: inline;"> </a>

                                                        </figure>

                                                        <div class="name">

                                                            <a style="color:#fff" href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-100g-y014/" title="<?= $item_yen['name_product'] ?>" class="name">
                                                                <?= $item_yen['name_product'] ?></a>
                                                        </div>

                                                        <div class="price_arae">

                                                            <span class="price_current" style="color:#ffe1b8"><?= number_format($item_yen['price'], 0, ".", "") ?>₫</span>
                                                            <span class="price_old " style="color:#ffe1b8">
                                                                <span class="item_old"><?= number_format($item_yen['price1'], 0, ".", "") ?>₫
                                                                </span>
                                                            </span>
                                                ...
                                                <div class="item">
                                                    <div class="frame_inner">
                                                        <figure class="product_image ">
                                                            ...
                                                            <a href="namlinhchivang.php-thuong-hang-dac-biet-dang-tui-l038/" title="<?= $item_nam['name_product'] ?>">

                                                                <img class="lazy after-lazy" alt="<?= $item_nam['name_product'] ?>" src="uploads/products/<?= $item_nam['image_product'] ?>" srcset="uploads/products/<?= $item_nam['image_product'] ?>" style="display: inline;"> </a>

                                                        </figure>

                                                        <div class="name">

                                                            <a style="color:#FFFFFF" href="namlinhchivang.php-thuong-hang-dac-biet-dang-tui-l038/" title="<?= $item_nam['name_product'] ?>" class="name">
                                                                <?= $item_nam['name_product'] ?> </a>
                                                        </div>

                                                        <div class="price_arae">

                                                            <span class="price_current" style="color:#FFE1B8"><?= number_format($item_nam['price'], 0, ".", "") ?>₫</span>
                                                            <span class="price_old " style="color:#FFE1B8">
                                                                <span class="item_old"><?= number_format($item_nam['price1'], 0, ".", "") ?>₫
                                                                </span>
                                                            </span>
                                                ...
                                                <div class="item">
                                                    <div class="frame_inner">
                                                        <figure class="product_image ">
                                                            ...
                                                            <a href="nhunghuoutuoi.php-hoang-da-san-ban-nh009/" title="<?= $item_nhunghuou['name_product'] ?>">

                                                                <img class="lazy after-lazy" alt="<?= $item_nhunghuou['name_product'] ?>" src="uploads/products/<?= $item_nhunghuou['image_product'] ?>" srcset="uploads/products/<?= $item_nhunghuou['image_product'] ?>" style="display: inline;"> </a>

                                                        </figure>

                                                        <div class="name">

                                                            <a style="color:#FFFFFF" href="nhunghuoutuoi.php-hoang-da-san-ban-nh009/" title="<?= $item_nhunghuou['name_product'] ?>" class="name">
                                                                <?= $item_nhunghuou['name_product'] ?> </a>
                                                        </div>

                                                        <div class="price_arae">

                                                            <span class="price_current" style="color:#FFE1B8"><?= number_format($item_nhunghuou['price'], 0, ".", "") ?>₫</span>
                                                            <span class="price_old " style="color:#FFE1B8">
                                                                <span class="item_old"><?= number_format($item_nhunghuou['price1'], 0, ".", "") ?>₫
                                                                </span>
                                                            </span>
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="nhansamhanquoc.php" title="Nhân sâm" id="banner_item_93" class="banner_item">
                                            <span class="wrapper_ap">
                                                ...
                                                <img class="lazy after-lazy" alt="Nhân sâm" src="assets/img/promotion/promotion1.png" srcset="assets/img/promotion/promotion1.png" style="display: inline;">
                                                <!-- <span class="text_ab">
                                                            </span> -->
                                            </span>
                                        </a>
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="nhunghuou.php" title="Nhung hươu" id="banner_item_99" class="banner_item">
                                            <span class="wrapper_ap">
                                                ...
                                                <img class="lazy after-lazy" alt="Nhung hươu" src="assets/img/promotion/promotion2.png" srcset="assets/img/promotion/promotion2.png" style="display: inline;">
                                                <!-- <span class="text_ab">
                                                            </span> -->
                                            </span>
                                        </a>
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="yensaokhanhhoa.php" title="Nước yến" id="banner_item_97" class="banner_item">
                                            <span class="wrapper_ap">
                                                ...
                                                <img class="lazy after-lazy" alt="Nước yến" src="assets/img/promotion/promotion3.png" srcset="assets/img/promotion/promotion3.png" style="display: inline;">
                                                <!-- <span class="text_ab">
                                                            </span> -->
                                            </span>
                                        </a>
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="dongtrunghathao.php" title="Đông trùng hạ thảo" id="banner_item_95" class="banner_item">
                                            <span class="wrapper_ap">
                                                ...
                                                <img class="lazy after-lazy" alt="Đông trùng hạ thảo" src="assets/img/promotion/promotion4.png" srcset="assets/img/promotion/promotion4.png" style="display: inline;">
                                                <!-- <span class="text_ab">
                                                            </span> -->
                                            </span>
                                        </a>
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="https://onplaza.vn/gia-nam-linh-chi" title="Nấm linh chi" id="banner_item_98" class="banner_item">
                                            <span class="wrapper_ap">
                                                ...
                                                <img class="lazy after-lazy" alt="Nấm linh chi" src="assets/img/promotion/promotion5.png" srcset="assets/img/promotion/promotion5.png" style="display: inline;">
                                                <!-- <span class="text_ab">
                                                            </span> -->
                                            </span>
                                        </a>
                                    ...
                                    <div class="item">
                                        <a rel="nofollow" href="ancungnguuhanquoc.php" title="An cung ngưu" id="banner_item_94" class="banner_item">
                                            <span class="wrapper_ap">
                                                ...
                                                <img class="lazy after-lazy" alt="An cung ngưu" src="assets/img/promotion/promotion6.png" srcset="assets/img/promotion/promotion6.png" style="display: inline;">
                                                <!-- <span class="text_ab">
                                                            </span> -->
                                            </span>
                                        </a>
                ...
                <div class="wraper_block" style="background-color:#140600">
                    <div class="block_banners banners-_banner banners_0 block" id="block_id_145">
                        <div class="banners_wrapper cls banners-default_wrapper block_inner block_banner_banner">
                            <div class="item">
                                <a rel="nofollow" href="lienhe.php" title="Hệ thống cửa hàng" id="banner_item_100" class="banner_item">
                        ...
                        <div class="footer_top cls">
                            ...
                            <div class="footer_r cls">
                                ...
                                <div class="share_fast_small">
                                    ...
                                    <div class="fb share_item"><a class="facebook-icon" href="" title="Link Facebook" rel="nofollow" target="_blank">
                                    ...
                                    <div class="tw share_item">
                                        <a class="twitter-icon" href="" title="Link twitter" rel="nofollow" target="_blank">
                                    ...
                                    <div class="yt share_item">
                                        <a class="instagram-icon" href="" title="Link instagram" rel="nofollow" target="_blank">
                                    ...
                                    <div class="yt share_item">
                                        <a class="youtube-icon" href="" title="Link youtube" rel="nofollow" target="_blank">
