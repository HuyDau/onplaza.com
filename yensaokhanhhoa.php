...
<head id="Head1" prefix="og: http://ogp.me/ns# fb:http://ogp.me/ns/fb# article:http://ogp.me/ns/article#">
	...
	<meta name="description"
		content="onplaza.vn - địa chỉ cung cấp và phân phối các sản phẩm yến đảo thiên nhiên, tổ yến sào khánh hòa, nước yến, yến huyết.. từ công ty yến sào khánh hòa.,Yến sào Khánh Hoà,">
	<meta name="keywords"
		content="yến sào,tổ yến,yến sào khánh hòa,Giá 1 thùng nước yến sào Khánh Hòa,Yến sào Khánh Hòa 6 lọ,Yến sào Khánh Hòa tại TPHCM,Yến sào Khánh Hòa 100g">
	...
	<script type="text/javascript" async=""
		...
		integrity="sha384-UL4gpwnwxxxsV0iKJbujQODc2RZ+xFJZbe1zrnAFA+voyVvurFjSZH6kO9Nz+rpI"></script>
	...
	<meta property="og:image"
		content="https://onplaza.vn/images/products/2023/03/29/resized/y014--avatar_1680065112.jpg">
	...
	<script type="application/ld+json">
{
  ...
  "review": {
	...
	"author": {"@type": "Person", "name": "Vi Chiến Thắng"},
	"publisher": {"@type": "Organization", "name": "Vi Chiến Thắng"}
  }
}
</script>
	<script type="application/ld+json">
  ...
  "sameAs": "https://twitter.com/i/events/1396658411278721027"
	...
	<style amp-custom="">
		...
		.arcontactus-widget .messangers-block {
			background: center no-repeat #f4e0af;
		...
		select:focus {
			background-image: linear-gradient(45deg, #fff 50%, transparent 50%), linear-gradient(135deg, transparent 50%, #fff 50%), linear-gradient(to right, #27272700, #2a2a2a00);
		...
		.header_wraper #nav-mainmenu .header_left {
			background: -webkit-linear-gradient(bottom, #2f0a00 0%, #5d0f00 40%, #5d0f00 60%, #2f0a00 100%);
			background: -o-linear-gradient(bottom, #2f0a00 0%, #5d0f00 40%, #5d0f00 60%, #2f0a00 100%);
			background: linear-gradient(to top, #2f0a00 0%, #5d0f00 40%, #5d0f00 60%, #2f0a00 100%);
			width: calc(calc(100% - 1250px)/2)
		}

		.header_wraper #nav-mainmenu .header_right {
			width: calc(calc(100% - 1250px)/2)
		}

		.header_wraper #nav-mainmenu .logo_top {
			background: -webkit-linear-gradient(bottom, #2f0a00 0%, #5d0f00 40%, #5d0f00 60%, #2f0a00 100%);
			background: -o-linear-gradient(bottom, #2f0a00 0%, #5d0f00 40%, #5d0f00 60%, #2f0a00 100%);
			background: linear-gradient(to top, #2f0a00 0%, #5d0f00 40%, #5d0f00 60%, #2f0a00 100%);
			width: 14%;
		...
		.header_wraper #nav-mainmenu .logo_top .search_home {
			display: none
		}
		...
		.header_wraper .container {
			position: relative
		}

		.header_wraper .block_testimonials {
			padding: 50px 0px
		}
		...
		.header_wraper .block_testimonials .block_title {
			padding-bottom: 30px
		}

		.header_wraper .search_home,
		.header_wraper .search_home_mobile {
			float: left;
			text-align: center;
			display: flex;
			justify-content: center;
		...
		.header_wraper .search_home #search,
		.header_wraper .search_home_mobile #search {
			width: 300px
		}
		...
		.pagination .current {
			background: none repeat scroll 0 0 #ffaf70;
			color: #000;
		...
		.navigation_main_wrapper {
			...
			border-top: 1px solid #23232b0a;
			background-color: var(--main-color)
		}

		.navigation_main_wrapper .navigation_main {
			margin: 0 auto;
			max-width: 100%;
			width: 1170px
		}
		...
		.navigation_main_wrapper .search_home {
			position: relative;
			float: right
		}
		...
		.top1 {
			background-image: url("https://onplaza.vn/templates/onplaza/images/bg_top1.jpg");
		...
		.number1 font:after {
			content: '';
			height: 90px;
			background-image: url("https://onplaza.vn/templates/onplaza/images/bg1.png");
			width: 65px;
			position: absolute;
			top: -30px;
			left: 0px;
		...
		.bot1 {
			margin-top: 16px;
			background-image: url("https://onplaza.vn/templates/onplaza/images/bgkm.jpg");
			background-size: 100% 100%;
		...
		.alo-floating-zalo {
			bottom: 60px;
			padding-left: 45px;
			background: url(https://onplaza.vn/templates/onplaza/images/icon-zalo.png) 8px center no-repeat, #009dff;
		...
		@-webkit-keyframes quick-alo-circle-anim22 {
			0% {
				-webkit-transform: rotate(0) scale(0.5) skew(1deg);
				-webkit-opacity: .1
			}
		...
		@-webkit-keyframes quick-zoom {
			...
			50% {
				transform: rotateX(360deg) scale(0.6)
			}
		...
		.quick-alo-ph-img-circle {
			...
			left: 70px;
			position: absolute;
			background: rgba(30, 30, 30, 0.1) url("https://onplaza.vn/templates/onplaza/images/icon-phone.png") no-repeat center center;
			-webkit-border-radius: 100%;
			-moz-border-radius: 100%;
			border-radius: 100%;
			border: 2px solid transparent;
		...
		.banner-home-top {
			margin-top: 16px;
			background-image: url("https://onplaza.vn/templates/onplaza/images/bg_b2.jpg");
			background-size: cover
		}
		...
		.all-hotline-ft .address_content .title {
			margin-top: 20px;
			display: flex;
			align-items: center
		}
		...
		.all-hotline-ft .address_content .title svg {
			width: 20px;
			height: 20px;
			fill: var(--main-color);
			margin-right: 5px
		...
		.all-hotline-ft .address_content .item {
			margin-bottom: 20px
		}
		...
		@media screen and (min-width: 1140px) {
			.mainmenu_wrapper_mobile {
				display: none
			}
		}

		@media screen and (max-width: 1140px) {
			.mainmenu_wrapper_desktop {
				display: none !important
			}
		}
		...
		.menu_head .left_item ul li:before {
			position: absolute;
			left: 0px;
			top: 50%;
			width: 12px;
		...
		.menu_head .left_item ul li:first-child a:first-child {
			padding-right: 10px;
			margin-right: 5px;
		...
		.menu_head .left_item a {
			color: var(--main-color);
			font-weight: normal
		}

		.menu_head .right_item {
			float: right;
			padding: 5px 0px;
			display: flex;
			align-items: center;
		...
		#loading_image {
			width: 100%;
			height: 100%;
			background: url("https://onplaza.vn/templates/onplaza/images/giphy.gif") no-repeat center center;
		...
		.youtube_svg .icon_v1:after {
			background: url('data:image/svg+xml;utf8,<svg fill="rgb(177, 31, 143)" viewBox="-21 -117 682.66672 682"  xmlns="http://www.w3.org/2000/svg"><path d="m626.8125 64.035156c-7.375-27.417968-28.992188-49.03125-56.40625-56.414062-50.082031-13.703125-250.414062-13.703125-250.414062-13.703125s-200.324219 0-250.40625 13.183593c-26.886719 7.375-49.03125 29.519532-56.40625 56.933594-13.179688 50.078125-13.179688 153.933594-13.179688 153.933594s0 104.378906 13.179688 153.933594c7.382812 27.414062 28.992187 49.027344 56.410156 56.410156 50.605468 13.707031 250.410156 13.707031 250.410156 13.707031s200.324219 0 250.40625-13.183593c27.417969-7.378907 49.03125-28.992188 56.414062-56.40625 13.175782-50.082032 13.175782-153.933594 13.175782-153.933594s.527344-104.382813-13.183594-154.460938zm-370.601562 249.878906v-191.890624l166.585937 95.945312zm0 0"/></svg>');
			background-repeat: no-repeat;
			margin: 0px
		}

		.zalo_svg .icon_v1:after {
			background: url('data:image/svg+xml;utf8,<svg width="25px" height="25px" viewBox="0 0 25 9" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><path d="M12.6808693,2.52045104 L12.6808693,2.06398482 L14.048117,2.06398482 L14.048117,8.48239004 L13.2659151,8.48239004 C12.9439124,8.48239004 12.6825323,8.22236344 12.6808772,7.90080374 C12.6806605,7.90096172 12.6804438,7.90111968 12.6802271,7.90127761 C12.129539,8.30399226 11.448805,8.54305395 10.7134839,8.54305395 C8.87197018,8.54305395 7.37885092,7.05092395 7.37885092,5.21063028 C7.37885092,3.37033661 8.87197018,1.87820661 10.7134839,1.87820661 C11.448805,1.87820661 12.129539,2.1172683 12.6802271,2.51998295 C12.6804412,2.52013896 12.6806552,2.520295 12.6808693,2.52045106 Z M7.02456422,0 L7.02456422,0.20809598 C7.02456422,0.596210225 6.97270642,0.913087295 6.72048165,1.28483624 L6.68997706,1.31965261 C6.63490826,1.38206536 6.50566514,1.52871125 6.44417431,1.60829152 L2.05488532,7.11746011 L7.02456422,7.11746011 L7.02456422,7.89737882 C7.02456422,8.22051321 6.76238532,8.48235796 6.4390367,8.48235796 L0,8.48235796 L0,8.11462011 C0,7.66425356 0.11190367,7.46337756 0.253348624,7.25399803 L4.93243119,1.46244785 L0.195068807,1.46244785 L0.195068807,0 L7.02456422,0 Z M15.7064427,8.48239004 C15.4375206,8.48239004 15.2188509,8.2638652 15.2188509,7.9952818 L15.2188509,3.20888173e-05 L16.6824289,3.20888173e-05 L16.6824289,8.48239004 L15.7064427,8.48239004 Z M21.0096009,1.83801536 C22.8639587,1.83801536 24.366711,3.34137645 24.366711,5.19290121 C24.366711,7.04603041 22.8639587,8.54939149 21.0096009,8.54939149 C19.1552431,8.54939149 17.6524908,7.04603041 17.6524908,5.19290121 C17.6524908,3.34137645 19.1552431,1.83801536 21.0096009,1.83801536 Z M10.7134839,7.17125701 C11.7971995,7.17125701 12.6754106,6.29362786 12.6754106,5.21063028 C12.6754106,4.12923714 11.7971995,3.25160799 10.7134839,3.25160799 C9.62976835,3.25160799 8.75155734,4.12923714 8.75155734,5.21063028 C8.75155734,6.29362786 9.62976835,7.17125701 10.7134839,7.17125701 Z M21.0096009,7.16796791 C22.0997385,7.16796791 22.9843716,6.283921 22.9843716,5.19290121 C22.9843716,4.10348586 22.0997385,3.21959939 21.0096009,3.21959939 C19.9178578,3.21959939 19.0348303,4.10348586 19.0348303,5.19290121 C19.0348303,6.283921 19.9178578,7.16796791 21.0096009,7.16796791 Z" id="Combined-Shape" fill="rgb(177, 31, 143)"></path></g></svg>');
			background-repeat: no-repeat;
			margin: 0px
		}
		...
		.fixed_bottom .buy-now1 {
			width: 50%;
			background: var(--main-color);
			color: #fff
		}

		.fixed_bottom .buy-now1 .bold {
			text-transform: uppercase;
			font-size: 16px
		}

		.fixed_bottom .buy-now1 span {
			font-size: 13px
		}
		...
		#nav-mainmenu {
			background: -webkit-linear-gradient(bottom, #2f0a00 0%, #440b00 40%, #440b00 60%, #2f0a00 100%);
			background: -o-linear-gradient(bottom, #2f0a00 0%, #440b00 40%, #440b00 60%, #2f0a00 100%);
			background: linear-gradient(to top, #2f0a00 0%, #440b00 40%, #440b00 60%, #2f0a00 100%);
			display: flex;
			position: relative;
			border-top: 1px solid #7b0404;
			z-index: 99;
			width: 100%
		}
		...
		.homemenu_fixed .item svg {
			width: 20px;
			height: 20px;
			fill: var(--main-color)
		}

		.homemenu_fixed .item .text_hide {
			display: none;
			padding: 0px 10px 0px 15px
		}

		.homemenu_fixed .item a:hover {
			background: #ce0807;
			display: flex;
			align-items: center
		}

		.homemenu_fixed .item a:hover svg {
			fill: #ebc99d
		}

		.homemenu_fixed .item a:hover .text_hide {
			display: inline-block
		}

		.homemenu_fixed .active a {
			background: #ce0807
		}

		.homemenu_fixed .active a svg {
			fill: #ebc99d
		}

		.homemenu_fixed .active a .text_hide {
			color: #fff
		}
		...
		.admin_edit a {
			width: 20px;
			height: 20px;
			background-image: url("https://onplaza.vn/templates/onplaza/images/edit.png");
			display: inline-block
		}
		...
		.setting_admin {
			...
			width: 20px;
			height: 20px;
			background-image: url("https://onplaza.vn/templates/onplaza/images/setting.png");
			display: inline-block;
			cursor: pointer;
			overflow: hidden
		}
		...
		.admin_edit_detail a {
			width: 20px;
			height: 20px;
			background-image: url("https://onplaza.vn/templates/onplaza/images/edit_content.png");
			display: inline-block
		}
		...
		.product_grid .item .buy_nows {
			margin-top: 12px
		}

		.product_grid .item .buy_nows a {
			color: #fff;
			padding: 8px 20px;
			padding-right: 30px;
			display: inline-block;
		...
		.product_grid .item .buy_nows a:after {
			right: 20px;
			top: 13px;
		...
		.product_grid .item .new_icon {
			background: -webkit-linear-gradient(left, #aa1c9a 0%, #a019a9 50%, #9314bc 100%);
			background: -o-linear-gradient(left, #aa1c9a 0%, #a019a9 50%, #9314bc 100%);
			background: linear-gradient(to right, #aa1c9a 0%, #a019a9 50%, #9314bc 100%)
		}

		.product_grid .item .hot_icon {
			background: -webkit-linear-gradient(left, #ff2900 0%, #ff6f00 50%, #ff9200 100%);
			background: -o-linear-gradient(left, #ff2900 0%, #ff6f00 50%, #ff9200 100%);
			background: linear-gradient(to right, #ff2900 0%, #ff6f00 50%, #ff9200 100%)
		}
		...
		.product_grid .item .price_current span {
			color: #000;
			font-weight: normal
		}
		...
		.description_start .fl_l {
			float: left
		}

		.description_start .fl_r {
			float: right
		}

		.description_start .line_h {
			line-height: 28px
		}
		...
		.image_l .content .description_inner {
			max-height: 250px;
			overflow-y: auto;
			padding-right: 15px;
			text-align: justify
		...
		.image_l .content .description_inner::-webkit-scrollbar-track {
			border-radius: 5px;
			background-color: #ccc !important
		}

		.image_l .content .description_inner::-webkit-scrollbar-thumb {
			border: 0
		}
		...
		@media all and (max-width: 600px) {
			...
			.image_l .content .content_title,
			.image_r .content .content_title {
				margin-bottom: 5px
			}

			.image_l .content .content_inner,
			.image_r .content .content_inner {
		...
		@media all and (max-width: 600px) {
			...
			.text_inside .contents .content_inner {
				max-height: none !important;
				overflow-y: visible !important;
				padding-right: 0px !important
			}
		...
		.product_grid .item>span:nth-child(1) {
			top: 0;
			left: 0;
			width: 0;
			height: 1px
		...
		.product_grid .item>span:nth-child(2) {
			top: 0;
			left: 0;
			width: 1px;
			height: 0
		...
		.product_grid .item>span:nth-child(3) {
			bottom: 0;
			right: 0;
			width: 0;
			height: 1px
		...
		.product_grid .item>span:nth-child(4) {
			bottom: 0;
			right: 0;
			width: 1px;
			height: 0
		...
		.product_grid .item:hover>span:nth-child(1) {
			width: 100%;
			transform: translateX(100%)
		}

		.product_grid .item:hover>span:nth-child(2) {
			height: 100%;
			transform: translateY(100%)
		}

		.product_grid .item:hover>span:nth-child(3) {
			width: 100%;
			transform: translateX(-100%)
		}

		.product_grid .item:hover>span:nth-child(4) {
			height: 100%;
			transform: translateY(-100%)
		}
		...
		.prodetails_tab #characteristic-label {
			text-transform: uppercase;
			font-size: 34px;
			color: #ffb26f;
			text-align: center;
		...
		.field_title select {
			...
			background-image: linear-gradient(45deg, transparent 50%, #ffb26f 50%), linear-gradient(135deg, #ffb26f 50%, transparent 50%), linear-gradient(to right, #5b0000, #5b0000);
		...
		.call_hot a:first-child {
			background: #f26522
		}

		.call_hot a:last-child {
			background: #b11f8f
		}

		#products-cat .cat_item_store {
			padding: 20px 0px
		}
		...
		#products-cat .cat_item_store .banner_left {
			float: left;
			width: 25%
		}

		#products-cat .cat_item_store .banner_right {
			float: left;
			width: calc(75% - 20px);
			margin-left: 20px
		}
		...
		#products-cat .cat-title-main a span {
			position: inherit;
			z-index: 99
		}
		...
		.breadcrumbs .breadcrumb__item li:last-child a {
			color: var(--main-color)
		}

		.description_start h2 {
			font-size: 26px;
			margin-bottom: 20px;
			font-weight: 500
		}
		...
		@media all and (max-width: 768px) {
			...
			.description_start h2 span,
			.description_start h2 p,
			.description_start h2 strong {
		...
		.popup-login-resgister .social_login>a:before {
			background: #4267b2;
			content: "";
			height: 44px;
			width: 52px;
		...
		.popup-login-resgister .social_login>a:nth-child(2) {
			color: #fff;
			border: 0px solid #da0808;
			background: #d7482c;
			border-radius: 50px
		}

		.popup-login-resgister .social_login>a:nth-child(2):before {
			background: #d7482c;
			border-radius: 50px
		}

		.popup-login-resgister .social_login>a svg {
			width: 25px;
			height: 25px;
			fill: #fff;
			position: absolute;
		...
		.popup-login-resgister .social_login .other {
			position: absolute;
			bottom: -8px;
			left: 50%;
			background: #f6f6f6;
		...
		.popup-login-resgister .social_login .login_fb {
			border-radius: 50px;
			background: #415897
		}

		.popup-login-resgister .website_login,
		.popup-login-resgister .tab_reset_pass {
			padding: 30px 30px;
			width: 80%;
			margin: 0px auto;
			background: #230d03;
			border-top: 1px solid #5f2207;
			box-sizing: border-box
		}
		...
		.popup-login-resgister .row-register {
			display: flex;
			flex-wrap: wrap;
			align-items: center
		}

		.popup-login-resgister .row-register label {
			float: left;
			width: 25%;
			color: #fff
		}
		...
		.popup-login-resgister .row-register input {
			height: 40px;
			border-radius: 5px;
			background: #fff;
		...
		.popup-login-resgister .row-register .btn-submit {
			background: #ca0206;
			color: #fff;
			border: none;
			border-radius: 4px;
		...
		.popup-login-resgister .save_resetpass {
			margin-bottom: 20px;
			width: 75%;
			float: right
		}

		.popup-login-resgister .save_resetpass .save_login {
			width: 50%;
			float: left
		}

		.popup-login-resgister .save_resetpass .reset_pass {
			text-align: left;
			color: #fff;
			font-size: 14px
		}

		.popup-login-resgister .save_resetpass .reset_pass a {
			color: var(--main-color)
		}

		.popup-login-resgister .create {
			text-align: center
		}

		.popup-login-resgister .create a {
			color: #fff
		}

		.popup-login-resgister .code-view {
			display: flex;
			margin-bottom: 8px;
			width: 100%
		}

		.popup-login-resgister .box-register {
			position: relative
		}

		.popup-login-resgister .box-register .other {
			position: absolute;
			bottom: -8px;
			left: 50%;
			background: #f6f6f6;
		...
		.popup-login-resgister .row-register-sl .date_l {
			width: 75%;
			float: left
		}
		...
		.popup-login-resgister .row-register-sl .date_l select {
			width: calc(100% / 3 - 10px);
			float: left;
			margin-right: 10px
		}

		.popup-login-resgister .row-register-sl .date_r {
			width: 88px;
			float: right
		}

		.popup-login-resgister .row-register-sl .title-t {
			margin-bottom: 6px
		}

		.popup-login-resgister .row-register-sl select {
			height: 40px;
			background: #fff;
			border-radius: 5px;
			border: 1px solid #ddd;
		...
		.popup-login-resgister .input-check {
			margin-top: 14px;
			margin-bottom: 14px
		}

		.popup-login-resgister .login-bot {
			text-align: center
		}

		.popup-login-resgister .login-bot a {
			color: #fff
		}

		.row-register-capcha img {
			width: auto
		}
		...
		.value_gender .radio-fake:before {
			position: absolute;
			top: 50%;
			left: 50%;
			transform: translate(-50%, -50%);
		...
		.value_gender input:checked~.radio-fake:before {
			background-color: #000
		}

		.row-register2 #gender2 {
			float: left;
			width: 25%;
			color: #fff
		}
		...
		.popup-login-resgister .row-register-btn {
			display: block;
			margin-top: 50px;
			text-align: center;
			margin-bottom: -20px
		...
		.popup-login-resgister .row-register-btn .wrapper-bt-register {
			float: unset;
			width: 100%
		}

		.popup-login-resgister .row-register-btn .wrapper-bt-register .btn-submit {
			width: 240px;
			margin-bottom: 0px
		}

		.popup-login-resgister .regis_user {
			padding: 0px;
			width: calc(80% + 60px)
		}

		.popup-login-resgister .regis_user .box-register {
		...
		.popup-login-resgister .submit_check {
			margin-top: 20px
		}

		.popup-login-resgister .submit_check .btn-submit {
			width: 75%
		}
		...
		.user_area .logs {
			background: url(https://onplaza.vn/blocks/log/assets/images/sign-in.png) no-repeat scroll 0px 4px;
			padding-left: 37px;
			position: relative;
			line-height: 20px;
			text-align: left;
		...
		.popup_success .list_menu:after {
			content: '';
			width: 0;
			right: 0;
			border-bottom: 7px solid #f4e0af;
		...
		.popup_success .list_menu li:hover a,
		.popup_success .list_menu .active:hover a {
			background: #eccc7f
		}
		...
		.mobile_shopcart .shopcart_simple .count {
			position: relative
		}

		.mobile_shopcart .shopcart_simple a {
			font-size: 12px;
			display: flex;
			align-items: center
		}

		.mobile_shopcart .shopcart_simple a span {
			color: var(--main-color);
			font-size: 14px;
			position: absolute;
			right: -8px;
		...
		.mobile_shopcart .shopcart_simple svg {
			fill: var(--main-color);
			width: 35px;
			height: 35px
		}
		...
		.dcjq-mega-menu-product {
			float: left;
			display: flex;
			z-index: 999
		}

		.dcjq-mega-menu-product #megamenu {
			z-index: 99;
			display: flex
		}
		...
		.dcjq-mega-menu-product ul.menu li.menu_level_0 {
			position: relative
		}

		.dcjq-mega-menu-product ul.menu li.level_0 {
			float: left;
			text-align: center;
			box-sizing: border-box
		}

		.dcjq-mega-menu-product ul.menu li.level_0:hover svg {
			fill: var(--extra-color)
		}

		.dcjq-mega-menu-product ul.menu li.level_0:first-child a {
			padding: 50px 40px 50px 60px
		}

		@media screen and (max-width: 1170px) {
			.dcjq-mega-menu-product ul.menu li.level_0:first-child a {
				padding: 55px 33px 55px 45px
			}
		}

		.dcjq-mega-menu-product ul.menu li.level_0:first-child a .icon_svg {
			left: 32px
		}
		...
		.dcjq-mega-menu-product ul.menu li.level_0:last-child {
			border-right: none;
			padding-right: 0px
		}

		.dcjq-mega-menu-product ul.menu li.mega-hover a,
		.dcjq-mega-menu-product ul.menu>li.activated>a,
		.dcjq-mega-menu-product ul.menu>li:hover>a {
			color: var(--extra-color);
			background: -webkit-linear-gradient(bottom, #e1c275 0%, #f4e0ae 48%, #f4e0ae 52%, #e1c275 100%);
			background: -o-linear-gradient(bottom, #e1c275 0%, #f4e0ae 48%, #f4e0ae 52%, #e1c275 100%);
			background: linear-gradient(to top, #e1c275 0%, #f4e0ae 48%, #f4e0ae 52%, #e1c275 100%)
		}
		...
		.dcjq-mega-menu-product ul.menu li.home.mega-hover a,
		.dcjq-mega-menu-product ul.menu>li.home.activated>a,
		.dcjq-mega-menu-product ul.menu>li.home:hover>a {
			color: var(--extra-color)
		}
		...
		.dcjq-mega-menu-product ul.menu li.home.mega-hover svg,
		.dcjq-mega-menu-product ul.menu>li.home.activated>svg,
		.dcjq-mega-menu-product ul.menu>li.home:hover>svg {
			fill: #000000
		}

		.dcjq-mega-menu-product .menu_item_a {
			text-transform: uppercase;
			font-size: 16px;
			color: var(--main-color);
			padding: 50px 35px;
		...
		.dcjq-mega-menu-product .menu_item_a:hover {
			background: var(--main-color);
			color: var(--extra-color)
		}
		...
		.dcjq-mega-menu-product .drop_down {
			color: #FFFFFF;
			display: flex;
			float: left;
			padding: 4px 10px;
		...
		.dcjq-mega-menu-product .drop_down svg {
			fill: var(--main-color);
			width: 9px;
			height: 9px;
			position: unset
		...
		.dcjq-mega-menu-product .highlight {
			position: absolute;
			text-align: left;
			top: 100px;
			left: 0px;
		...
		.dcjq-mega-menu-product .active_nohover {
			width: 255px
		}

		.dcjq-mega-menu-product .active_nohover .highlight1 .has_child .wraper_item {
			display: none !important
		}

		.dcjq-mega-menu-product .highlight .highlight1 {
			font-size: 16px
		}

		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list {
			width: 255px;
			float: left;
			box-sizing: border-box
		}

		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .sub-menu-level1 {
			background: #3a150bbf;
			margin-bottom: 3px
		}

		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .sub-menu-level1 a {
			color: #fff;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .sub-menu-level1 a .icon {
			position: absolute;
			left: 13px;
			top: 50%;
			transform: translate(0px, -50%);
		...
		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .sub-menu-level1 a .icon svg {
			fill: var(--main-color);
			width: 20px;
			height: 20px
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .image_sub {
			width: 45%;
			float: left;
			box-sizing: border-box;
			transition: 0s
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .image_sub a {
			transition: 0s
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .image_sub img {
			max-width: 100%;
			max-height: 100%;
			object-fit: cover;
			display: block;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item {
			width: 90%;
			float: left;
			padding: 5px 0px;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .item_lv1 {
			color: var(--main-color);
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .item_lv1:hover {
			color: #9f0100
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item ul {
			float: left;
			width: 70%
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item ul li a {
			color: #fff;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item ul li:hover a {
			color: #9f0100
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .frame_img_cat {
			height: 155px;
			width: 40%;
			float: left;
			display: flex;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .frame_img_cat img {
			max-width: 100%;
			max-height: 100%;
			object-fit: cover;
			display: block;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .frame_view {
			width: 60%;
			height: 165px;
			display: flex;
			align-items: center
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .item-info {
			width: 100%;
			float: left;
			padding-left: 10px
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .name {
			font-weight: bold;
			font-size: 16px;
			margin-bottom: 10px;
			line-height: 20px;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item .price {
			font-weight: bold;
			color: #ff0000;
			font-size: 16px
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .item:hover .item_lv1 {
			color: #9f0100
		}

		.dcjq-mega-menu-product .highlight .highlight1 .wraper_item .product_item .cat_item2 {
			padding-bottom: 0px
		}

		.dcjq-mega-menu-product .highlight .highlight1 .has_child .level_0 {
			position: relative
		}

		.dcjq-mega-menu-product .highlight .highlight1 .has_child .level_0:after {
			content: "";
			position: absolute;
			right: 5px;
			top: 50%;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .has_child .wraper_item {
			position: absolute;
			left: 256px;
			z-index: 999;
			top: 0px;
		...
		.dcjq-mega-menu-product .highlight .highlight1 .has_child:hover .wraper_item {
			opacity: 1;
			visibility: visible
		}

		.dcjq-mega-menu-product ul.menu .level_0:hover .highlight {
			opacity: 1;
			visibility: initial;
			transition: 0.2s
		}

		.dcjq-mega-menu-product .highlight .sub-menu-level1 a {
			color: #555;
			font-size: 14px
		}

		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .sub-menu-level1:hover {
			cursor: pointer;
			-webkit-transition: 0.15s ease-in-out all;
			transition: 0.15s ease-in-out all
		}

		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .sub-menu-level1:hover .level_0 {
			background: #9f0100;
			color: var(--main-color)
		}

		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .sub-menu-level1 .active_n {
			background: #9f0100;
			color: var(--main-color)
		}

		.dcjq-mega-menu-product .highlight .highlight1 .menu-child_list .has_child:hover .level_0:after {
			background: url('data:image/svg+xml;utf8,<svg width="13px" height="13px" fill="rgb(244, 224, 175)" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  viewBox="0 0 284.935 284.936" style="enable-background:new 0 0 284.935 284.936;" xml:space="preserve"><g><path d="M222.701,135.9L89.652,2.857C87.748,0.955,85.557,0,83.084,0c-2.474,0-4.664,0.955-6.567,2.857L62.244,17.133 c-1.906,1.903-2.855,4.089-2.855,6.567c0,2.478,0.949,4.664,2.855,6.567l112.204,112.204L62.244,254.677 c-1.906,1.903-2.855,4.093-2.855,6.564c0,2.477,0.949,4.667,2.855,6.57l14.274,14.271c1.903,1.905,4.093,2.854,6.567,2.854 c2.473,0,4.663-0.951,6.567-2.854l133.042-133.044c1.902-1.902,2.854-4.093,2.854-6.567S224.603,137.807,222.701,135.9z"/></g></svg>');
			background-repeat: no-repeat
		}

		.dcjq-mega-menu-product .highlight .sub-menu-level1:hover a {
			text-decoration: none
		}

		.dcjq-mega-menu-product .sb-toggle-left {
			float: left;
			display: none;
			cursor: pointer;
			margin-top: 2px;
		...
		.slide-down .dcjq-mega-menu-product .menu_item_a {
			padding: 40px 35px
		}

		.slide-down .dcjq-mega-menu-product ul.menu li.cat_level_0:first-child>a {
		...
		.slide-down .dcjq-mega-menu-product .highlight {
			padding-top: 15px;
			top: 90px
		}
		...
		.slide-up .dcjq-mega-menu-product .menu_item_a {
			padding: 40px 35px
		}

		.slide-up .dcjq-mega-menu-product ul.menu li.cat_level_0:first-child>a {
			padding: 40px 40px 40px 60px
		}
		...
		.slide-up .dcjq-mega-menu-product .highlight {
			padding-top: 15px;
			top: 90px
		}
		...
		@media screen and (max-width: 990px) {
			.dcjq-mega-menu-product .sb-toggle-left svg {
				color: black;
				width: 25px;
				height: 25px;
				position: absolute;
			...
			.dcjq-mega-menu-product ul.menu li.level_0:before {
				display: none
			}

			.dcjq-mega-menu-product ul.menu li.level_0:after {
				display: none
			}
			...
			.dcjq-mega-menu-product .highlight .highlight1 a {
				color: #FFF
			}

			.dcjq-mega-menu-product .highlight .sub-menu-level1 {
				border-top: none;
			...
			.dcjq-mega-menu-product .highlight .sub-menu-level1:hover {
				background: #9c0278
			}
		}
		...
		.dcjq-mega-menu-product .level_0>a {
			display: flex;
			position: relative
		}

		.dcjq-mega-menu-product .level_0>a .icon_svg {
			box-sizing: border-box;
			border-radius: 50px;
			justify-content: center;
			margin-right: 7px;
		...
		.dcjq-mega-menu-product .level_0>a .icon_svg svg {
			width: 17px;
			fill: var(--main-color);
			height: 17px;
			box-sizing: border-box
		...
		.dcjq-mega-menu-product .product_home_active {
			opacity: 1;
			visibility: visible
		}
		...
		.dcjq-mega-menu ul.menu li.menu_level_0 {
			position: relative
		}
		...
		.dcjq-mega-menu ul.menu li.level_0:first-child a {
			padding: 50px 40px 50px 60px
		}
		...
		.dcjq-mega-menu ul.menu li.level_0:first-child a .icon_svg {
			left: 32px
		}
		...
		.dcjq-mega-menu .active_nohover {
			width: 255px
		}

		.dcjq-mega-menu .active_nohover .highlight1 .has_child .wraper_item {
			display: none !important
		}
		...
		.dcjq-mega-menu .highlight .highlight1 .menu-child_list .sub-menu-level1 a .icon {
			position: absolute;
			left: 13px;
			top: 50%;
			transform: translate(0px, -50%);
		...
		.dcjq-mega-menu .highlight .highlight1 .menu-child_list .sub-menu-level1 a .icon svg {
			fill: var(--main-color);
			width: 20px;
			height: 20px
		}
									...
									<div class="g-recaptcha" data-sitekey="6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci">
										<div style="width: 304px; height: 78px;">
											<div><iframe title="reCAPTCHA"
													src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfXf7EZAAAAABfEi0Temws_OYe1V04I8kR2ovci&amp;co=aHR0cHM6Ly9vbnBsYXphLnZuOjQ0Mw..&amp;hl=vi&amp;v=khH7Ei3klcvfRI74FvDcfuOo&amp;size=normal&amp;cb=y8tpbz7ncfkp"
													width="304" height="78" role="presentation" name="a-9cmqwkjcxn9i"
								...
								<div class="breadcrumbs_wrapper" itemscope="" itemtype="http://schema.org/WebPage">
									<ul class="breadcrumb" itemscope="itemscope"
										...
										<li class="breadcrumb__item" itemprop="itemListElement" itemscope="itemscope"
											...
											<a title="Yến sào Khánh Hoà" href="yensaokhanhhoa.php"
												itemprop="item">
										...
										<table class="has-background">
											...
											<tbody>
												<tr>
													...
													<td><a
															href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-50g-y013/">YẾN
												...
												<tr>
													...
													<td><a
															href="https://onplaza.vn/yen-sao-so-che-savinet-cao-cap-khanh-hoa-50-g-y146/">YẾN
												...
												<tr>
													...
													<td><a
															href="yenhuyetnguyento.php-tho-thuong-hang-loai-100gr-hop-y072/">YẾN
												...
												<tr>
													...
													<td><a
															href="yenhongnguyento.php-so-che-thuong-hang-100gr-hop-y073/">YẾN
															HỒNG NGUYÊN TỔ</a></td>
												...
												<tr>
													...
													<td><a
															href="nuocyensanest.php-duong-phen-1-lo-y026/">Nước
												...
												<tr>
													...
													<td><a
															href="https://onplaza.vn/yen-trang-tho-nha-trang-hop-100g-y065/">Yến
												...
												<tr>
													...
													<td><a
															href="https://onplaza.vn/yen-nguyen-to-khanh-hoa-hop-100g-tp3-y003/">Yến
												...
												<tr>
													...
													<td><a
															href="yenhuyetnguyento.php-nguyen-chiec-khanh-hoa-hop-100g-y007/">Yến
												...
												<tr>
													...
													<td><a
															href="https://onplaza.vn/yen-hong-nguyen-chiec-khanh-hoa-hop-100g-y006/">Yến
												...
												<tr>
													...
													<td><a
															href="https://onplaza.vn/nuoc-yen-sao-sanest-tre-em-1-lo-y071/">&nbsp;Nước
							...
							<div class="container">
								...
								<div class="wapper-content-page product_home_content">
									...
									<div class="cat_item_store menu_sticky sticky_1 cls">
										<h2 class="cat-title-main"><a href="yentinhchenguyento.php"
												title="Yến sào Khánh Hoà"><span>Yến tinh chế nguyên tổ</span></a></h2>
										<div class="clear"></div>
										<div class="banner_left">
											<img class="lazy after-lazy" alt="Yến tinh chế nguyên tổ"
												src="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-tinh-che_1605497337.jpg"
												srcset="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-tinh-che_1605497337.jpg.webp"
												style="display: inline;">
										</div>
														...
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-100g-y014/"
																	title="Yến trắng tinh chế Khánh Hòa hộp 100g Y014 | Onplaza">
																	<img class="lazy after-lazy"
																		alt="Yến trắng tinh chế Khánh Hòa hộp 100g Y014 | Onplaza"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y014--avatar_1680065112.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y014--avatar_1680065112.jpg.webp"
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">6.600.000₫</span>
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-100g-y014/"
																	title="Mua sản phẩm Yến trắng tinh chế Khánh Hòa hộp 100g Y014 | Onplaza">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-trang-tinh-che-hop-qua-tang-100g-y017/"
																	title="Tổ yến tinh chế Khánh Hòa hộp quà tặng 100g Y017">
																	<img class="lazy after-lazy"
																		alt="Tổ yến tinh chế Khánh Hòa hộp quà tặng 100g Y017"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y017--avatar_1680065183.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y017--avatar_1680065183.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-trang-tinh-che-hop-qua-tang-100g-y017/"
																		title="Tổ yến tinh chế Khánh Hòa hộp quà tặng 100g Y017"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">6.920.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-trang-tinh-che-hop-qua-tang-100g-y017/"
																	title="Mua sản phẩm Tổ yến tinh chế Khánh Hòa hộp quà tặng 100g Y017">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-trang-tinh-che-loai-2-100g-hop-y063/"
																	title="Yến tinh chế thượng hạng Nhà yến Nha Trang hộp 100g Y063 (loại 2)">
																	<img class="lazy after-lazy"
																		alt="Yến tinh chế thượng hạng Nhà yến Nha Trang hộp 100g Y063 (loại 2)"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y063-avatar_1680073075.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y063-avatar_1680073075.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-trang-tinh-che-loai-2-100g-hop-y063/"
																		title="Yến tinh chế thượng hạng Nhà yến Nha Trang hộp 100g Y063 (loại 2)"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">4.400.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-trang-tinh-che-loai-2-100g-hop-y063/"
																	title="Mua sản phẩm Yến tinh chế thượng hạng Nhà yến Nha Trang hộp 100g Y063 (loại 2)">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-50g-y013/"
																	title="Yến sào tinh chế Khánh Hòa hộp 50g Y013">
																	<img class="lazy after-lazy"
																		alt="Yến sào tinh chế Khánh Hòa hộp 50g Y013"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y013--avatar_1680065093.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y013--avatar_1680065093.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-50g-y013/"
																		title="Yến sào tinh chế Khánh Hòa hộp 50g Y013"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">3.300.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-trang-tinh-che-khanh-hoa-hop-50g-y013/"
																	title="Mua sản phẩm Yến sào tinh chế Khánh Hòa hộp 50g Y013">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-trang-tinh-che-loai-1-100g-hop-y062/"
																	title="Yến trắng tinh chế cao cấp loại 1 Nhà Yến (100g/hộp) - Y062">
																	<img class="lazy after-lazy"
																		alt="Yến trắng tinh chế cao cấp loại 1 Nhà Yến (100g/hộp) - Y062"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y062-avatar_1680073099.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y062-avatar_1680073099.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-trang-tinh-che-loai-1-100g-hop-y062/"
																		title="Yến trắng tinh chế cao cấp loại 1 Nhà Yến (100g/hộp) - Y062"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">5.000.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-trang-tinh-che-loai-1-100g-hop-y062/"
																	title="Mua sản phẩm Yến trắng tinh chế cao cấp loại 1 Nhà Yến (100g/hộp) - Y062">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-trang-tinh-che-hop-qua-tang-50g-h015g-y018/"
																	title="Yến tinh chế Khánh Hòa hộp quà tặng 50g Y018 (H015G)">
																	<img class="lazy after-lazy"
																		alt="Yến tinh chế Khánh Hòa hộp quà tặng 50g Y018 (H015G)"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y018--avatar_1680065174.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y018--avatar_1680065174.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-trang-tinh-che-hop-qua-tang-50g-h015g-y018/"
																		title="Yến tinh chế Khánh Hòa hộp quà tặng 50g Y018 (H015G)"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">3.620.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-trang-tinh-che-hop-qua-tang-50g-h015g-y018/"
																	title="Mua sản phẩm Yến tinh chế Khánh Hòa hộp quà tặng 50g Y018 (H015G)">
																	Mua sản phẩm
																</a>
															</div>
									...
									<div class="cat_item_store menu_sticky sticky_2 cls">
										<h2 class="cat-title-main"><a href="yensochenguyento.php"
												title="Yến sào Khánh Hoà"><span>Yến sơ chế nguyên tổ</span></a></h2>
										<div class="clear"></div>
										<div class="banner_left">
											<img class="lazy after-lazy" alt="Yến sơ chế nguyên tổ"
												src="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-sao-so-che_1605497662.jpg"
												srcset="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-sao-so-che_1605497662.jpg.webp"
												style="display: inline;">
										</div>
										<div class="banner_right">
											...
											<div class="product_ajj">
												<div class="products_home_slideshow product_grid"
													id="products_home_slideshow_84">
													<!--	EACH Product				-->
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">

																<a href="https://onplaza.vn/to-yen-trang-so-che-thuong-hang-nha-yen-100g-hop-y066/"
																	title="Tổ yến trắng sơ chế Nhà Yến Nha Trang hộp 100gr Y066 | Onplaza">
																	<img class="lazy after-lazy"
																		alt="Tổ yến trắng sơ chế Nhà Yến Nha Trang hộp 100gr Y066 | Onplaza"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y066-avatar_1680073060.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y066-avatar_1680073060.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/to-yen-trang-so-che-thuong-hang-nha-yen-100g-hop-y066/"
																		title="Tổ yến trắng sơ chế Nhà Yến Nha Trang hộp 100gr Y066 | Onplaza"
																		class="name">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/to-yen-trang-so-che-thuong-hang-nha-yen-100g-hop-y066/"
																	title="Mua sản phẩm Tổ yến trắng sơ chế Nhà Yến Nha Trang hộp 100gr Y066 | Onplaza">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-nguyen-to-khanh-hoa-hop-100g-tp3-y003/"
																	title="Yến sào Khánh Hòa sơ chế nguyên tổ hộp 100g TP3 Y003">
																	<img class="lazy after-lazy"
																		alt="Yến sào Khánh Hòa sơ chế nguyên tổ hộp 100g TP3 Y003"
																		src="https://onplaza.vn/images/products/2020/12/31/resized/yen-nguyen-to-khanh-hoa-hop-100g-tp3-y003_1609397667.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/31/resized/yen-nguyen-to-khanh-hoa-hop-100g-tp3-y003_1609397667.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-nguyen-to-khanh-hoa-hop-100g-tp3-y003/"
																		title="Yến sào Khánh Hòa sơ chế nguyên tổ hộp 100g TP3 Y003"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">8.100.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-nguyen-to-khanh-hoa-hop-100g-tp3-y003/"
																	title="Mua sản phẩm Yến sào Khánh Hòa sơ chế nguyên tổ hộp 100g TP3 Y003">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-nguyen-to-khanh-hoa-hop-100g-tp1-y001/"
																	title="Yến sào nguyên tổ Khánh Hòa hộp 100g TP1 Y001">
																	<img class="lazy after-lazy"
																		alt="Yến sào nguyên tổ Khánh Hòa hộp 100g TP1 Y001"
																		src="https://onplaza.vn/images/products/2020/12/31/resized/yen-nguyen-to-khanh-hoa-hop-100g-tp1-y001_1609397741.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/31/resized/yen-nguyen-to-khanh-hoa-hop-100g-tp1-y001_1609397741.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-nguyen-to-khanh-hoa-hop-100g-tp1-y001/"
																		title="Yến sào nguyên tổ Khánh Hòa hộp 100g TP1 Y001"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">10.060.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-nguyen-to-khanh-hoa-hop-100g-tp1-y001/"
																	title="Mua sản phẩm Yến sào nguyên tổ Khánh Hòa hộp 100g TP1 Y001">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/to-yen-trang-so-che-nha-yen-thuong-hang-2-100g-hop-y067/"
																	title="Tổ yến trắng sơ chế Nhà yến Nha Trang loại 2 hộp 100gr - Y067">
																	<img class="lazy after-lazy"
																		alt="Tổ yến trắng sơ chế Nhà yến Nha Trang loại 2 hộp 100gr - Y067"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y067-avatar_1680073042.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y067-avatar_1680073042.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/to-yen-trang-so-che-nha-yen-thuong-hang-2-100g-hop-y067/"
																		title="Tổ yến trắng sơ chế Nhà yến Nha Trang loại 2 hộp 100gr - Y067"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">4.500.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/to-yen-trang-so-che-nha-yen-thuong-hang-2-100g-hop-y067/"
																	title="Mua sản phẩm Tổ yến trắng sơ chế Nhà yến Nha Trang loại 2 hộp 100gr - Y067">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-sao-so-che-savinet-cao-cap-khanh-hoa-50-g-y146/"
																	title="Yến sào sơ chế Savinet Khánh Hòa cao cấp hộp 50gr Y146">
																	<img class="lazy after-lazy"
																		alt="Yến sào sơ chế Savinet Khánh Hòa cao cấp hộp 50gr Y146"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/yen-sao-so-che-savinet-cao-cap-khanh-hoa-50-g-y146_1609314305.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/yen-sao-so-che-savinet-cao-cap-khanh-hoa-50-g-y146_1609314305.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-sao-so-che-savinet-cao-cap-khanh-hoa-50-g-y146/"
																		title="Yến sào sơ chế Savinet Khánh Hòa cao cấp hộp 50gr Y146"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">2.420.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-sao-so-che-savinet-cao-cap-khanh-hoa-50-g-y146/"
																	title="Mua sản phẩm Yến sào sơ chế Savinet Khánh Hòa cao cấp hộp 50gr Y146">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/yen-sao-so-che-savinet-cao-cap-khanh-hoa-100g-y141/"
																	title="Yến sào sơ chế Savinet Khánh Hòa Hộp 100g Y141 | Onplaza">
																	<img class="lazy after-lazy"
																		alt="Yến sào sơ chế Savinet Khánh Hòa Hộp 100g Y141 | Onplaza"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/yen-sao-so-che-savinet-cao-cap-khanh-hoa-100g-y141_1609314341.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/yen-sao-so-che-savinet-cao-cap-khanh-hoa-100g-y141_1609314341.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-sao-so-che-savinet-cao-cap-khanh-hoa-100g-y141/"
																		title="Yến sào sơ chế Savinet Khánh Hòa Hộp 100g Y141 | Onplaza"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">4.620.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-sao-so-che-savinet-cao-cap-khanh-hoa-100g-y141/"
																	title="Mua sản phẩm Yến sào sơ chế Savinet Khánh Hòa Hộp 100g Y141 | Onplaza">
																	Mua sản phẩm
																</a>
															</div>
									...
									<div class="cat_item_store menu_sticky sticky_3 cls">
										<h2 class="cat-title-main"><a href="yenhuyetnguyento.php"
												title="Yến sào Khánh Hoà"><span>Yến huyết nguyên tổ</span></a></h2>
										<div class="clear"></div>
										<div class="banner_left">
											<img class="lazy after-lazy" alt="Yến huyết nguyên tổ"
												src="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-huyet_1605498615.jpg"
												srcset="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-huyet_1605498615.jpg.webp"
												style="display: inline;">
										</div>
										<div class="banner_right">
											...
											<div class="product_ajj">
												<div class="products_home_slideshow product_grid"
													id="products_home_slideshow_85">
													<!--	EACH Product				-->
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">

																<a href="yenhuyetnguyento.php-nguyen-chiec-khanh-hoa-hop-100g-y007/"
																	title="Yến huyết nguyên chiếc Khánh Hòa hộp 100g-Y007">
																	<img class="lazy after-lazy"
																		alt="Yến huyết nguyên chiếc Khánh Hòa hộp 100g-Y007"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/yen-huyet-nguyen-chiec-khanh-hoa-hop-100g-y007_1609314567.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/yen-huyet-nguyen-chiec-khanh-hoa-hop-100g-y007_1609314567.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="yenhuyetnguyento.php-nguyen-chiec-khanh-hoa-hop-100g-y007/"
																		title="Yến huyết nguyên chiếc Khánh Hòa hộp 100g-Y007"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">24.999.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="yenhuyetnguyento.php-nguyen-chiec-khanh-hoa-hop-100g-y007/"
																	title="Mua sản phẩm Yến huyết nguyên chiếc Khánh Hòa hộp 100g-Y007">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="yenhuyetnguyento.php-tho-thuong-hang-loai-100gr-hop-y072/"
																	title="Yến huyết thô thượng hạng loại 100gr/hộp - Y072">
																	<img class="lazy after-lazy"
																		alt="Yến huyết thô thượng hạng loại 100gr/hộp - Y072"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/yen-huyet-tho-thuong-hang-loai-100gr-hop-y072_1609314606.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/yen-huyet-tho-thuong-hang-loai-100gr-hop-y072_1609314606.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="yenhuyetnguyento.php-tho-thuong-hang-loai-100gr-hop-y072/"
																		title="Yến huyết thô thượng hạng loại 100gr/hộp - Y072"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">15.000.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="yenhuyetnguyento.php-tho-thuong-hang-loai-100gr-hop-y072/"
																	title="Mua sản phẩm Yến huyết thô thượng hạng loại 100gr/hộp - Y072">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="yenhuyetnguyento.php-tinh-che-100g-hop-y061/"
																	title="Yến huyết tinh chế thượng hạng cao cấp (100g/hộp) Y061">
																	<img class="lazy after-lazy"
																		alt="Yến huyết tinh chế thượng hạng cao cấp (100g/hộp) Y061"
																		src="https://onplaza.vn/images/products/2023/03/29/resized/y061-avatar_1680073118.jpg"
																		srcset="https://onplaza.vn/images/products/2023/03/29/resized/y061-avatar_1680073118.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="yenhuyetnguyento.php-tinh-che-100g-hop-y061/"
																		title="Yến huyết tinh chế thượng hạng cao cấp (100g/hộp) Y061"
																		class="name">
															...
															<div class="buy_nows">
																<a href="yenhuyetnguyento.php-tinh-che-100g-hop-y061/"
																	title="Mua sản phẩm Yến huyết tinh chế thượng hạng cao cấp (100g/hộp) Y061">
																	Mua sản phẩm
																</a>
															</div>
									...
									<div class="cat_item_store menu_sticky sticky_4 cls">
										<h2 class="cat-title-main"><a href="yenhongnguyento.php"
												title="Yến sào Khánh Hoà"><span>Yến hồng nguyên tổ</span></a></h2>
										<div class="clear"></div>
										<div class="banner_left">
											<img class="lazy after-lazy" alt="Yến hồng nguyên tổ"
												src="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-hong_1605498811.jpg"
												srcset="https://onplaza.vn/images/products/cat/large/banner-doc-to-yen-hong_1605498811.jpg.webp"
												style="display: inline;">
										</div>
										<div class="banner_right">
											...
											<div class="product_ajj">
												<div class="products_home_slideshow product_grid"
													id="products_home_slideshow_86">
													<!--	EACH Product				-->
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">

																<a href="https://onplaza.vn/yen-hong-nguyen-chiec-khanh-hoa-hop-100g-y006/"
																	title="Yến hồng nguyên chiếc Khánh Hòa hộp 100g-Y006">
																	<img class="lazy after-lazy"
																		alt="Yến hồng nguyên chiếc Khánh Hòa hộp 100g-Y006"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/yen-hong-nguyen-chiec-khanh-hoa-hop-100g-y006_1609314688.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/yen-hong-nguyen-chiec-khanh-hoa-hop-100g-y006_1609314688.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/yen-hong-nguyen-chiec-khanh-hoa-hop-100g-y006/"
																		title="Yến hồng nguyên chiếc Khánh Hòa hộp 100g-Y006"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">19.250.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/yen-hong-nguyen-chiec-khanh-hoa-hop-100g-y006/"
																	title="Mua sản phẩm Yến hồng nguyên chiếc Khánh Hòa hộp 100g-Y006">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="yenhongnguyento.php-so-che-thuong-hang-100gr-hop-y073/"
																	title="Tổ yến hồng sơ chế thượng hạng (100gr/hộp) Y073">
																	<img class="lazy after-lazy"
																		alt="Tổ yến hồng sơ chế thượng hạng (100gr/hộp) Y073"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/to-yen-hong-so-che-thuong-hang-100gr-hop-y073_1609315231.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/to-yen-hong-so-che-thuong-hang-100gr-hop-y073_1609315231.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="yenhongnguyento.php-so-che-thuong-hang-100gr-hop-y073/"
																		title="Tổ yến hồng sơ chế thượng hạng (100gr/hộp) Y073"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">7.000.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="yenhongnguyento.php-so-che-thuong-hang-100gr-hop-y073/"
																	title="Mua sản phẩm Tổ yến hồng sơ chế thượng hạng (100gr/hộp) Y073">
																	Mua sản phẩm
																</a>
															</div>
									...
									<div class="cat_item_store menu_sticky sticky_5 cls">
										<h2 class="cat-title-main"><a href="nuocyensanest.php"
												title="Yến sào Khánh Hoà"><span>Nước yến sanest</span></a></h2>
										<div class="clear"></div>
										<div class="banner_left">
											<img class="lazy after-lazy" alt="Nước yến sanest"
												src="https://onplaza.vn/images/products/cat/large/banner-doc-nuoc-yen_1605496447.jpg"
												srcset="https://onplaza.vn/images/products/cat/large/banner-doc-nuoc-yen_1605496447.jpg.webp"
												style="display: inline;">
										</div>
										<div class="banner_right">
											...
											<div class="product_ajj">
												<div class="products_home_slideshow product_grid"
													id="products_home_slideshow_87">
													<!--	EACH Product				-->
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">

																<a href="https://onplaza.vn/lo-nuoc-yen-sanest-khong-duong-y029/"
																	title="Lọ Nước yến Sanest không đường Y029">
																	<img class="lazy after-lazy"
																		alt="Lọ Nước yến Sanest không đường Y029"
																		src="https://onplaza.vn/images/products/2021/10/11/resized/lo-nuoc-yen-sanest-khong-duong-y029_1633938413.jpg"
																		srcset="https://onplaza.vn/images/products/2021/10/11/resized/lo-nuoc-yen-sanest-khong-duong-y029_1633938413.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/lo-nuoc-yen-sanest-khong-duong-y029/"
																		title="Lọ Nước yến Sanest không đường Y029"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">33.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/lo-nuoc-yen-sanest-khong-duong-y029/"
																	title="Mua sản phẩm Lọ Nước yến Sanest không đường Y029">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/nuoc-yen-sao-sanest-tre-em-1-lo-y071/"
																	title="Nước yến sào sanest trẻ em 1 lọ-Y071">
																	<img class="lazy after-lazy"
																		alt="Nước yến sào sanest trẻ em 1 lọ-Y071"
																		src="https://onplaza.vn/images/products/2022/03/28/resized/nuoc-yen-sao-sanest-tre-em-1-lo-y071_1648448598.jpg"
																		srcset="https://onplaza.vn/images/products/2022/03/28/resized/nuoc-yen-sao-sanest-tre-em-1-lo-y071_1648448598.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/nuoc-yen-sao-sanest-tre-em-1-lo-y071/"
																		title="Nước yến sào sanest trẻ em 1 lọ-Y071"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">34.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/nuoc-yen-sao-sanest-tre-em-1-lo-y071/"
																	title="Mua sản phẩm Nước yến sào sanest trẻ em 1 lọ-Y071">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/hop-nuoc-yen-sanest-duong-phen-6-lo-y028/"
																	title="Hộp nước yến sanest đường phèn 6 lọ Y028">
																	<img class="lazy after-lazy"
																		alt="Hộp nước yến sanest đường phèn 6 lọ Y028"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/hop-nuoc-yen-sanest-duong-phen-6-lo-y028_1609314800.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/hop-nuoc-yen-sanest-duong-phen-6-lo-y028_1609314800.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="https://onplaza.vn/hop-nuoc-yen-sanest-duong-phen-6-lo-y028/"
																		title="Hộp nước yến sanest đường phèn 6 lọ Y028"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">220.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/hop-nuoc-yen-sanest-duong-phen-6-lo-y028/"
																	title="Mua sản phẩm Hộp nước yến sanest đường phèn 6 lọ Y028">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="nuocyensanest.php-duong-phen-hop-8-lo-y027/"
																	title="Nước yến sanest đường phèn hộp 8 lọ Y027">
																	<img class="lazy after-lazy"
																		alt="Nước yến sanest đường phèn hộp 8 lọ Y027"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/nuoc-yen-sanest-duong-phen-hop-8-lo-y027_1609314831.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/nuoc-yen-sanest-duong-phen-hop-8-lo-y027_1609314831.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="nuocyensanest.php-duong-phen-hop-8-lo-y027/"
																		title="Nước yến sanest đường phèn hộp 8 lọ Y027"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">290.000₫</span>
																<span class="price_old" style="color:#FFE2B8">
															...
															<div class="buy_nows">
																<a href="nuocyensanest.php-duong-phen-hop-8-lo-y027/"
																	title="Mua sản phẩm Nước yến sanest đường phèn hộp 8 lọ Y027">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="nuocyensanest.php-duong-phen-1-lo-y026/"
																	title="Nước yến sanest đường phèn 1 lọ Y026">
																	<img class="lazy after-lazy"
																		alt="Nước yến sanest đường phèn 1 lọ Y026"
																		src="https://onplaza.vn/images/products/2021/10/11/resized/nuoc-yen-sanest-duong-phen-1-lo-y026_1633938559.jpg"
																		srcset="https://onplaza.vn/images/products/2021/10/11/resized/nuoc-yen-sanest-duong-phen-1-lo-y026_1633938559.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="nuocyensanest.php-duong-phen-1-lo-y026/"
																		title="Nước yến sanest đường phèn 1 lọ Y026"
																		class="name">
															...
															<div class="buy_nows">
																<a href="nuocyensanest.php-duong-phen-1-lo-y026/"
																	title="Mua sản phẩm Nước yến sanest đường phèn 1 lọ Y026">
																	Mua sản phẩm
																</a>
															</div>
													...
													<div class="item ">
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="nuocyensanest.php-nhan-sam-6-lo-h-y068/"
																	title="Nước yến sanest nhân sâm (6 lọ/h)-Y068">
																	<img class="lazy after-lazy"
																		alt="Nước yến sanest nhân sâm (6 lọ/h)-Y068"
																		src="https://onplaza.vn/images/products/2020/12/30/resized/nuoc-yen-sanest-nhan-sam-6-lo-y068_1609317240.jpg"
																		srcset="https://onplaza.vn/images/products/2020/12/30/resized/nuoc-yen-sanest-nhan-sam-6-lo-y068_1609317240.jpg.webp"
																		style="display: inline;"> </a>
															...
															<div class="name">
																<h3><a style="color:#fff"
																		href="nuocyensanest.php-nhan-sam-6-lo-h-y068/"
																		title="Nước yến sanest nhân sâm (6 lọ/h)-Y068"
																		class="name">
															...
															<div class="price_arae">
																<span class="price_current"
																	style="color:#FFE2B8">374.000₫</span>
															</div>
															...
															<div class="buy_nows">
																<a href="nuocyensanest.php-nhan-sam-6-lo-h-y068/"
																	title="Mua sản phẩm Nước yến sanest nhân sâm (6 lọ/h)-Y068">
																	Mua sản phẩm
																</a>
															</div>
									...
									<div class="cat_item_store menu_sticky sticky_6 cls">
										<h2 class="cat-title-main"><a href="toyentho.php"
												title="Yến sào Khánh Hoà"><span>Tổ Yến Thô</span></a></h2>
										<div class="clear"></div>

										<div class="product_ajj">
											<div class="products_home_slideshow product_grid"
												id="products_home_slideshow_111">
												<!--	EACH Product				-->
												<div class="item ">
													<div class="frame_inner">
														<figure class="product_image ">

															<a href="https://onplaza.vn/yen-trang-tho-nha-trang-hop-100g-y065/"
																title="Yến trắng thô thượng hạng Nhà yến Nha Trang (100g/hộp) - Y065">
																<img class="lazy after-lazy"
																	alt="Yến trắng thô thượng hạng Nhà yến Nha Trang (100g/hộp) - Y065"
																	src="https://onplaza.vn/images/products/2023/03/29/resized/y065-avatar_1680072966.jpg"
																	srcset="https://onplaza.vn/images/products/2023/03/29/resized/y065-avatar_1680072966.jpg.webp"
																	style="display: inline;"> </a>
														...
														<div class="name">
															<h3><a style="color:#fff"
																	href="https://onplaza.vn/yen-trang-tho-nha-trang-hop-100g-y065/"
																	title="Yến trắng thô thượng hạng Nhà yến Nha Trang (100g/hộp) - Y065"
																	class="name">
														...
														<div class="buy_nows">
															<a href="https://onplaza.vn/yen-trang-tho-nha-trang-hop-100g-y065/"
																title="Mua sản phẩm Yến trắng thô thượng hạng Nhà yến Nha Trang (100g/hộp) - Y065">
																Mua sản phẩm
															</a>
														</div>
								...
								<div class=" ">
									<div class="container">
										...
										<div class="cat_description description cls" id="box_conten_linfo">
											<h2 style="text-align:justify"><span style="font-size:14px"><span
														style="color:#d35400"><strong><a
																href="yensaokhanhhoa.php">YẾN SÀO
											...
											<ul>
												<li style="text-align:justify">Giới thiệu về công ty: Công ty Yến sào
													Khánh Hòa (tên tiếng Anh: <a
														href="https://www.yensaokhanhhoa.com.vn/eng/homes/thongtindinhduong"
														rel="nofollow">Khanh Hoa Salangnest Net Company</a>) được thành
											...
											<h2 style="text-align:justify"><strong><span style="color:#d35400"><span
															style="font-size:14px">TRUNG BÌNH GIÁ CÁC LOẠI TỔ YẾN SÀO –
											...
											<ul>
												<li>Các sản phẩm từ yến đảo Khánh Hòa: Có thể nói các dòng sản phẩm từ
													...
													doanh yến tại&nbsp;<a href="https://onplaza.vn/" rel="noopener"
														target="_blank">On Plaza</a>. Những sản phẩm này bao gồm yến
											...
											<p style="text-align:center"><img class="lazy2"
													alt="&nbsp;Bảng giá sản phẩm yến sào Khánh Hòa cao cấp"
													height="2000" width="700"
													src="/upload_images/images/Tin-tuc/Danh-muc-yen/bang-gia-san-pham-yen-sao-khanh-hoa-cao-cap.jpg">
											</p>

											<p style="text-align:center"><strong><em>&nbsp;Bảng giá sản phẩm yến sào
														Khánh Hòa cao cấp</em></strong></p>

											<p style="text-align:justify">Thực phẩm <strong><a
														href="https://onplaza.vn/tin-tuc-yen/to-yen-sao-n53.html"><span
															style="color:#e74c3c">yến sào</span></a></strong> nằm trong
											...
											<p style="text-align:center"><img class="lazy2"
													alt="Yến đảo thiên nhiên Khánh Hòa với hàm lượng dinh dưỡng cao"
													height="400" width="700"
													src="/upload_images/images/Tin-tuc/Danh-muc-yen/yen-dao-thien-nhien-khanh-hoa-voi-ham-luong-dinh-duong-cao.jpg">
											</p>
											...
											<h2 style="text-align:justify"><span style="color:#d35400"><strong><span
															style="font-size:14px">PHÂN LOẠI TỔ YẾN SÀO KHÁNH
											...
											<p style="text-align:justify"><a href="yenhuyetnguyento.php"
													title="Yến huyết">Yến huyết</a>/ yến hồng được đánh giá là loại yến
											...
											<p style="text-align:center"><img class="lazy2" alt=""
													src="https://onplaza.vn/upload_images/images/Tin-tuc/Danh-muc-yen/to-yen-huyet-dao.jpg">
											</p>
											...
											<ul>
												...
												<li style="text-align:justify">Tổ yến sơ chế: Tổ yến được làm sạch 95 -
													97% lông và tạp chất (Xem các sản phẩm yến sơ chế tại: <a
														href="yensochenguyento.php"
														title="Các sản phẩm yến sơ chế">yensochenguyento.php</a>)
												</li>
												<li style="text-align:justify">Tổ yến tinh chế: Tổ yến được làm sạch
													...
													được.&nbsp;(Xem các sản phẩm yến tinh chế tại: <a
														href="yentinhchenguyento.php">yentinhchenguyento.php</a>)
												</li>
											</ul>
											...
											<ul>
												<li>–&nbsp;<em>Thứ nhất</em>, bạn nên chú ý đến màu sắc của yến sào. Yến
													...
													cam. Trong khi đó,&nbsp;<a
														href="https://yenkhanhhoa.info/tin-tuc/cach-phan-biet-yen-sao-that-va-yen-sao-gia/">yến
											...
											<h2 style="text-align:justify"><span style="color:#d35400"><span
														style="font-size:14px"><strong>THÀNH PHẦN DƯỠNG CHẤT CHÍNH CÓ
											...
											<p style="text-align:center"><img class="lazy2"
													alt="&nbsp;3 thành phần chính trong yến sào Khánh Hòa" height="528"
													width="700"
													src="/upload_images/images/Tin-tuc/Danh-muc-yen/3-thanh-phan-chinh-trong-yen-sao-Khanh-Hoa.jpg">
											</p>
											...
											<h2 style="text-align:justify"><span style="color:#d35400"><span
														style="font-size:14px"><strong>CÁC CÁCH SỬ DỤNG YẾN SÀO KHÁNH
											...
											<h2 style="text-align:justify"><span style="color:#d35400"><strong><span
															style="font-size:14px">YẾN SÀO DÙNG CHO NHỮNG ĐỐI TƯỢNG
															NÀO?</span></strong></span></h2>

											<p style="text-align:center"><img class="lazy2"
													alt="Yến sào phù hợp với nhiều đối tượng" height="389" width="700"
													src="/upload_images/images/Tin-tuc/Danh-muc-yen/yen-sao-phu-hop-voi-nhieu-doi-tuong.jpg">
											</p>
											...
											<h2 style="text-align:justify"><strong><span style="color:#d35400"><span
															style="font-size:14px">NHỮNG CÂU HỎI THƯỜNG GẶP KHI SỬ DỤNG
									...
									<li class="item">
										<a href="javascript:void(0)" id="sticky_1" title="Yến tinh chế nguyên tổ">
											<span class="icon"><svg version="1.0" xmlns="http://www.w3.org/2000/svg"
													width="50px" height="50px" viewBox="0 0 327.000000 248.000000"
	...
	L90.547,145.583z"></path>
						...
						<div class="footer_im cls">
							...
							<div class="image_wrapper">
								<a href="https://www.dmca.com/Protection/Status.aspx?ID=18892078-af65-4c9d-8b82-addf29b3e619&amp;refurl=yensaokhanhhoa.php"
								...
								<a href="http://online.gov.vn/Home/WebDetails/18258?refurl=yensaokhanhhoa.php"
			...
			<div id="arcontactus" class="arcontactus-widget arcontactus-message right lg active">
				...
				<div class="arcontactus-message-button" style="background-color: #c60100">
					...
					<div class="icons">
						<div class="icons-line" style="transform: translate(-258px, 0px);"><span
...
//]]></script>
			...
			<script async="async" language="javascript" type="text/javascript"
				src="https://onplaza.vn/cache/js/4b846753f08f87047cf3d32752308f45.js?20230704183724"></script>
		</div>
	</div>
	<script type="text/javascript"
	...
	<div
		...
		<div style="z-index: 2000000000; position: relative;"><iframe
				...
				name="c-9cmqwkjcxn9i" frameborder="0" scrolling="no"
