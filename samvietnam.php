    ...
    C469.27,15.147,470.166,10.581,468.523,6.592z"></path>
			...
			C360.128,120.716,317.92,143.692,295.776,143.692z"></path>
											...
											<div class="sub-menu sub-menu-level1 has_child  ">
												...
												<a href="samvietnam.php" class="level_0 sort activated  sub-menu-item"
									...
									<div class="cat_item_store menu_sticky sticky_1 cls">
										...
										<div class="banner_left">
											<img class="lazy after-lazy" alt="Giá sâm ngọc linh"
												src="uploads/categories/samngoclinh.png"
												srcset="uploads/categories/samngoclinh.png" style="display: inline;">
										</div>
														...
														<div class="frame_inner">
															<figure class="product_image ">
																...
																<a href="https://onplaza.vn/binh-co-sam-truong-tho-ginseng-1999-viet-nam-loai-dac-biet/"
																	title="<?= $item_samngoclinh['name_product'] ?>">
																	<img class="lazy after-lazy"
																		alt="<?= $item_samngoclinh['name_product'] ?>"
																		src="uploads/products/<?= $item_samngoclinh['image_product'] ?>"
																		srcset="uploads/products/<?= $item_samngoclinh['image_product'] ?>"
															...
															<div class="name">
																<h3><a style="color:#FFFFFF"
																		...
																		title="<?= $item_samngoclinh['name_product'] ?>"
																		class="name">
																		<?= $item_samngoclinh['name_product'] ?> </a>
																</h3>
															...
															<div class="buy_nows">
																<a href="https://onplaza.vn/binh-co-sam-truong-tho-ginseng-1999-viet-nam-loai-dac-biet/"
																	title="Mua sản phẩm <?= $item_samngoclinh['name_product'] ?>">
																	Mua sản phẩm
																</a>
															</div>
									...
									<div class="container">
										...
										<div class="cat_description description cls" id="box_conten_linfo">
											...
											<p style="text-align:center"><img class="lazy2"
													...
													src="uploads/samvn/gia-tri-sam-viet-nam.png">
											</p>
											...
											<p dir="ltr" style="text-align:center"><img class="lazy2"
													...
													src="uploads/samvn/Cac-loai-sam-viet-nam-duoc-ua-thuoc-nhat-hien-nay.png">
											</p>
											...
											<p style="text-align:center"><img class="lazy2"
													...
													src="uploads/samvn/bang-gia-so-sanh-sam-trong.png">
											</p>
											...
											<p style="text-align:center"><img class="lazy2" alt="" height="307"
													width="800"
													src="uploads/samvn/dia-chi-cong-cty-tnhh-onplaza-viet-phap_1601028234.png">
											</p>
